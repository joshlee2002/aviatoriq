...
- **Fix:** Rewritten to clarify that initial training (PPL/IR/CPL) qualifying you for a *new* profession is generally not deductible, while maintaining existing CFI certificates *may* be. Added explicit "consult a tax professional" caveats.
