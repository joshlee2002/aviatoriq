...
export const CADET_PROGRAMMES_2026: CadetProgramme[] = [
  // ── United Kingdom ──────────────────────────────────────────────────────────
  {
    ...
    trainingPartner:
      "Multiple approved BA training partners (including Skyborne)",
    fundedOrSelfFunded: "Fully funded by airline",
    estimatedCost: "£0 to trainee — BA funds £100,000+ training cost",
    eligibilitySummary:
      "Age 17–58 (18 at start of training). 6 GCSEs grade A–C/4–9 including Maths, English Language, and a Science. Valid passport permitting unrestricted worldwide travel.",
    applicationStatus:
      "2026 application window was 14–23 April 2026. Now closed. Check careers.ba.com for 2027 opening.",
    sourceUrl:
      "https://mediacentre.britishairways.com/news/14042026/british-airwaysfully-fundedpilot-training-programme-opens-for-applications-for-fourth-year-running",
    lastChecked: "June 2026",
    caveat:
      "BA invested £18m for up to 160 places in 2026. Previous years received 25,000+ applications. Acceptance rate is approximately 0.6%. Successful candidates receive a conditional offer — employment is subject to completing training, obtaining licences, passing medicals, and meeting BA's standards throughout. This is not a guaranteed job.",
  },
  {
    airline: "Jet2",
    ...
    status: "Closed for 2026 — check for 2027",
    trainingPartner:
      "Skyborne Airline Academy, Leading Edge Aviation, FTE Jerez",
    fundedOrSelfFunded: "Fully funded by airline",
    estimatedCost: "£0 to trainee — Jet2 funds £100,000+ training cost",
    eligibilitySummary:
      "Minimum 5 GCSEs at grade 4 or above including Maths and a Science, or equivalent qualifications. Open to all backgrounds. Must be at least 17 at application and turn 18 by 1 August 2026.",
    applicationStatus:
      "2026 intake applications closed 6 March 2026. 18,000 applications received for 60 places. Monitor jet2careers.com for 2027 opening.",
    sourceUrl:
      "https://www.jet2.com/news/2026/02/Jet2_com_opens_Jet2FlightPath_programme_to_put_more_aspiring_pilots_through_fully_funded_training_",
    lastChecked: "June 2026",
    caveat:
      "18,000 applications were received for 60 places in the 2026 intake — an acceptance rate of approximately 0.3%. 18-month ATPL training at Skyborne, Leading Edge, or FTE Jerez. Upon completion, trainees are offered type rating training before becoming a Jet2 pilot. Employment is conditional on completing training and meeting Jet2's standards. This is not a guaranteed job.",
  },
  {
    airline: "easyJet",
    ...
    eligibilitySummary:
      "Minimum age 18. Minimum 5 GCSEs/equivalent including Maths and English. Valid Class 1 Medical. Right to live and work in the UK, EU, or Switzerland.",
    applicationStatus:
      "Applications open for UK applicants as of April 2026. Apply via careers.easyjet.com or cae.com/generation-easyjet.",
    sourceUrl:
  ...
  },
  {
    ...
    fundedOrSelfFunded: "Self-funded (trainee pays)",
    estimatedCost:
      "Not publicly confirmed — request direct quote from Skyborne",
    eligibilitySummary:
      "Minimum age 18. Minimum 5 GCSEs/equivalent including Maths and English. Valid Class 1 Medical. Right to live and work in the UK, EU, or Switzerland.",
    applicationStatus:
      "Apply via skyborne.com/uk/easyjet/ or careers.easyjet.com.",
    sourceUrl: "https://skyborne.com/uk/easyjet/",
    lastChecked: "June 2026",
    caveat:
      "FlightCrew Futures is a self-funded Integrated ATPL + A320 Type Rating programme delivered by Skyborne. Trainees pay their own training costs and receive a conditional offer of employment with easyJet on successful completion. Training cost is not publicly listed — request a prospectus from Skyborne. Employment is not guaranteed.",
  },
  {
    airline: "Ryanair",
    ...
    trainingPartner:
      "EPST (European Pilot Selection and Training) and approved partners",
    fundedOrSelfFunded: "Self-funded (trainee pays)",
    estimatedCost: "Not publicly confirmed — request direct quote",
    eligibilitySummary:
      "Minimum age 18. Valid Class 1 Medical. Right to work in the EU/EEA. Minimum education requirements apply.",
    applicationStatus:
      "Rolling intake. Apply via ryanair.com/en/careers/pilots/cadet.",
    sourceUrl: "https://www.ryanair.com/en/careers/pilots/cadet",
    lastChecked: "June 2026",
    caveat:
      "Ryanair's cadet programme is self-funded. Trainees pay training costs and receive a conditional offer of employment with Ryanair on successful completion. Ryanair also recruits type-rated pilots directly. Training costs vary by partner school and are not publicly listed.",
  },
  {
    airline: "Wizz Air",
    ...
    estimatedCost:
      "Approximately €14,000 upfront; remainder pre-financed by Wizz Air and repaid from salary over approximately 5 years",
    eligibilitySummary:
      "Minimum age 18. Valid Class 1 Medical. Right to work in the EU. Minimum education requirements apply.",
    applicationStatus:
      "Rolling intake. Apply via wizzair.com/en-gb/information/about-wizz-air/careers.",
  ...
  },
  {
    ...
    applicationStatus:
      "Paused for 2026. TUI has not confirmed a restart date. Monitor tui.co.uk/careers for updates.",
    sourceUrl: "https://www.tui.co.uk/careers",
    lastChecked: "June 2026",
    caveat:
      "TUI's MPL programme has been paused. Previous iterations involved trainees taking loans underwritten by TUI, not direct airline funding. Do not treat this as a fully funded programme. Verify current status directly with TUI before making any training decisions.",
  },
  ...
  // ── Canada ───────────────────────────────────────────────────────────────────
  {
    ...
    lastChecked: "June 2026",
    caveat:
      "Air Canada's pilot apprentice/cadet programme details are not publicly confirmed as of June 2026. Verify directly with Air Canada.",
  },
  {
  ...
  // ── Australia ────────────────────────────────────────────────────────────────
  {
    ...
    fundedOrSelfFunded: "Self-funded (trainee pays)",
    estimatedCost:
      "Approximately AUD $120,000–$140,000 — verify with FTA directly",
    eligibilitySummary:
      "Australian citizen or permanent resident. Valid CASA Class 1 Medical. Minimum education requirements apply.",
