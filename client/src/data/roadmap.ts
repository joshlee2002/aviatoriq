...
export const roadmapQuestions: Question[] = [
  {
    ...
    options: [
      { label: "Under 18", value: "under18", points: { future: 10 } },
      {
        label: "18 – 35",
        value: "18to35",
        points: { sponsored: 2, integrated: 2, hybrid: 2, modular: 1 },
      },
      {
        label: "36 – 50",
        value: "36to50",
        points: { modular: 5, integrated: 1 },
      },
    ...
    options: [
      {
        ...
        value: "low",
        points: { sponsored: 10, hybrid: 1 },
      },
      {
        label: "£10,000 – £50,000",
        value: "medium",
        points: { hybrid: 5, modular: 3 },
      },
      {
        label: "£50,000 – £70,000",
        value: "high",
        points: { modular: 6, hybrid: 2 },
      },
      {
        label: "£70,000 – £90,000",
        value: "veryhigh_eu",
        points: { integrated: 6, modular: 3, hybrid: 1 },
      },
      {
        label: "£90,000+",
        value: "veryhigh",
        points: { integrated: 10, modular: 2 },
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        value: "fulltime",
        points: { integrated: 3, sponsored: 3, hybrid: 3, modular: 1 },
      },
      {
  ...
  },
  {
    ...
    options: [
      {
        label: "No GCSEs / High School equivalent yet",
        value: "none",
        points: { future: 5, modular: 1 },
      },
      {
        label: "GCSEs / High School equivalent",
        value: "gcses",
        points: { modular: 2, integrated: 2, hybrid: 2 },
      },
      {
        label: "A-Levels / Degree",
        value: "degree",
        points: { sponsored: 3, integrated: 2, hybrid: 2, modular: 1 },
      },
    ],
  },
  {
    ...
    options: [
      {
        label: "Yes — I will go wherever is cheapest/best",
        value: "yes",
        points: { integrated: 2, modular: 2, hybrid: 3 },
      },
      {
        label: "No — I need to stay in the UK",
        value: "no",
        points: { integrated: 2, modular: 1 },
      },
    ],
  },
];
    ...
    schools: [
      {
        ...
        description:
          "Fully funded by British Airways. Trains at CAE Oxford and Jerez. Extremely competitive — roughly 1,500 applicants per 30 places.",
      },
      {
        name: "Jet2 FlightPath Academy",
        description:
          "Fully funded ATPL with a guaranteed Jet2 first officer position on the Boeing 737/757 fleet.",
      },
      {
        name: "Royal Air Force (RAF)",
        description:
          "Paid to train with a world-class military flying programme, but requires a 12-year service commitment.",
      },
    ],
    watchOut:
      "Do not pay for a PPL just to boost your cadet application. Airlines test aptitude and personality, not existing flying hours. Spend that money on psychometric test prep instead.",
  },
  integrated: {
    id: "integrated",
    ...
    description:
      "You have the capital and the time to commit fully to training. The Integrated ATPL takes you from zero to a frozen ATPL in one continuous, structured programme — typically 18 months. It is the most expensive route, but it is fast, focused, and the major schools offer strong airline placement support. If you are willing to train in Europe, you can save £15,000–£25,000 versus a UK school for an identical qualification.",
    ...
    schools: [
      {
        ...
        description:
          "Premium global academy with campuses in Oxford and Phoenix. Strong airline partnerships with easyJet and Wizz Air.",
      },
      {
        name: "Skyborne Airline Academy",
        description:
          "Modern UK academy (Gloucestershire) partnered with BA and Jet2. Transparent pricing and strong placement record.",
      },
      {
        name: "FTEJerez (Spain)",
        description:
          "All-inclusive EASA campus in southern Spain. Popular with UK cadets — typically £20k cheaper than equivalent UK schools.",
      },
      {
        name: "L3Harris Airline Academy",
        description:
          "Campuses in Bournemouth and Palma. One of the largest integrated providers in Europe with direct airline pathways.",
      },
    ],
    watchOut:
      "The quoted headline price almost never includes the Type Rating (£25k–£35k) or living costs during training. Always ask for a full all-in cost breakdown before signing anything.",
  },
  modular: {
    id: "modular",
    ...
    schools: [
      {
        ...
        description:
          "The UK industry standard for distance-learning ATPL theory. Excellent pass rates and comprehensive study materials.",
      },
      {
        name: "Bartolini Air (Kraków, Poland)",
        description:
          "Highly respected for modular CPL/IR training. Official Ryanair partner school with strong placement support.",
      },
      {
        name: "Aeros Flying Club (Wellesbourne)",
        description:
          "One of the best-value PPL training clubs in the UK Midlands — modern fleet, structured syllabus, good instructor continuity.",
      },
      {
        name: "Tayside Aviation (Dundee)",
        description:
          "Established Scottish ATO offering modular CPL/IR and multi-engine training with competitive pricing.",
      },
    ],
    watchOut:
      "Skill decay is the silent killer of the modular route. If you leave too long between modules, you will need expensive refresher flights to get back to standard. Keep momentum — treat it like a second job.",
  },
  hybrid: {
    id: "hybrid",
    ...
    schools: [
      {
        ...
        description:
          "Requires approximately €14,000 upfront. The remainder is deducted from your salary over 5 years. Based in Budapest.",
      },
      {
        name: "Ryanair Future Flyer",
        description:
          "You fund the ATPL training yourself, but the Type Rating is provided and bonded. Strong placement guarantee.",
      },
      {
        name: "TUI MPL Programme",
        description:
          "Multi-Crew Pilot Licence route — trains you specifically for TUI operations. Lower upfront cost than a full integrated ATPL.",
      },
    ],
    watchOut:
      "If you fail the course or resign before your bond expires, you will be liable for the full remaining training cost. Read the contract with a lawyer before signing.",
  },
  future: {
    id: "future",
    ...
    description:
      "You are too young to start commercial training — which is actually a significant advantage. You have time to build exactly the profile airlines are looking for, without spending a fortune. Focus on your education, get free flying experience through the Air Cadets, and start saving. Pilots who plan early almost always have a smoother path.",
    cost: "Minimal now",
    ...
    schools: [
      {
        name: "Air Training Corps (RAFAC)",
        description:
          "The best possible start for a UK teenager. Free gliding, powered flying scholarships, and a structured aviation education.",
      },
      {
        name: "University Air Squadrons",
        description:
          "Free military flying training on the Grob Tutor while completing your degree. Available at 18 UK universities.",
      },
      {
        name: "The Air League",
        description:
          "Apply for their annual flying and gliding scholarships — open to young people aged 14–24 with financial need.",
      },
    ],
    watchOut:
      "You do not need a degree to become a commercial pilot. But strong GCSEs (especially Maths and English) are essential for ATPL theory. Do not let anyone tell you otherwise.",
  },
};
