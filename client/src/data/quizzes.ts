  ...
  questions: [
      ...
      options: [
        {
          value: "a",
          label:
            "Plan something meticulously — a route, an itinerary, a schedule",
          emoji: "📋",
    ...
    },
    {
      ...
      options: [
        ...
        {
          value: "b",
          label: "Trust your gut and act fast",
          emoji: "⚡",
          archetypes: ["fighter", "aerobatic"],
        },
        {
          value: "c",
          label: "Talk it through with someone else first",
          emoji: "💬",
          archetypes: ["corporate", "captain"],
        },
        {
          value: "d",
          label: "Retreat, analyse, then return with a plan",
          emoji: "🔍",
          archetypes: ["bush", "instructor"],
        },
      ],
    },
    {
      ...
      options: [
        {
          value: "a",
          label: "A busy international airport — gates, schedules, scale",
          emoji: "🌍",
          archetypes: ["captain", "corporate"],
        },
        {
          value: "b",
          label: "A remote airstrip — grass, mountains, no radar coverage",
          emoji: "🌿",
          archetypes: ["bush", "aerobatic"],
        },
        {
          value: "c",
          label: "An airshow — crowds, precision, performance",
          emoji: "🎪",
          archetypes: ["aerobatic", "fighter"],
        },
        {
          value: "d",
          label: "A small flying school — teaching, mentoring, building skills",
          emoji: "🎓",
    ...
    },
    {
      ...
      options: [
        {
          value: "a",
          label: "Stability, progression, and a clear career ladder",
          emoji: "📈",
          archetypes: ["captain", "instructor"],
        },
        {
          value: "b",
          label: "Freedom, variety, and no two days the same",
          emoji: "🗺️",
          archetypes: ["bush", "aerobatic"],
        },
        {
          value: "c",
          label: "Status, earnings, and working with high-achieving people",
          emoji: "💼",
          archetypes: ["corporate", "captain"],
        },
        {
          value: "d",
          label: "Mastery — being genuinely excellent at something difficult",
          emoji: "🏆",
          archetypes: ["fighter", "aerobatic"],
        },
      ],
    },
    {
      ...
      options: [
        {
          value: "a",
          label: "A wide-body airliner — complex, powerful, commanding",
          emoji: "✈️",
          archetypes: ["captain"],
        },
        {
          value: "b",
          label: "A bush plane — rugged, capable, built for the wild",
          emoji: "🛩️",
          archetypes: ["bush"],
        },
        {
          value: "c",
          label: "A business jet — sleek, fast, exclusive",
          emoji: "🛫",
          archetypes: ["corporate"],
        },
        {
          value: "d",
          label: "An aerobatic aircraft — nimble, precise, thrilling",
          emoji: "🌀",
          archetypes: ["aerobatic", "fighter"],
        },
      ],
    },
    {
      ...
      options: [
        {
          value: "a",
          label: "They exist for good reason — I follow them rigorously",
          emoji: "📏",
          archetypes: ["captain", "instructor"],
        },
        {
          value: "b",
          label: "I respect them but adapt when the situation demands",
          emoji: "🔄",
          archetypes: ["bush", "fighter"],
        },
        {
          value: "c",
          label: "I follow them, but I'm always looking for a smarter way",
          emoji: "💡",
          archetypes: ["corporate", "aerobatic"],
        },
        {
          value: "d",
          label: "I enjoy teaching others why they matter",
          emoji: "🎯",
          archetypes: ["instructor"],
        },
      ],
    },
    {
      id: "q7",
      question:
        "How do you feel about long-haul travel and time away from home?",
      options: [
        {
          value: "a",
          label:
            "Love it — new cities, hotels, layovers are part of the appeal",
          emoji: "🌆",
          archetypes: ["captain", "corporate"],
        },
        {
          value: "b",
          label: "Fine with it, but I prefer shorter trips with more control",
          emoji: "🏠",
          archetypes: ["bush", "instructor"],
        },
        {
          value: "c",
          label: "I'd rather be home most nights — lifestyle matters",
          emoji: "🛋️",
          archetypes: ["instructor", "aerobatic"],
        },
        {
          value: "d",
          label: "I'd go anywhere if the mission was exciting enough",
          emoji: "🚀",
          archetypes: ["fighter", "aerobatic"],
        },
      ],
    },
    {
      ...
      options: [
        {
          value: "a",
          label: '"It\'s the most professional, respected career in transport"',
          emoji: "🎖️",
          archetypes: ["captain"],
        },
        {
          value: "b",
          label: '"I want to go places most people never see"',
          emoji: "🗻",
          archetypes: ["bush"],
        },
        {
          value: "c",
          label: '"I want to push the limits of what\'s physically possible"',
          emoji: "💥",
          archetypes: ["fighter", "aerobatic"],
        },
        {
          value: "d",
          label: '"I want to help others find their way to the sky"',
          emoji: "🌟",
          archetypes: ["instructor"],
        },
      ],
  ...
  results: [
    {
      ...
      description:
        "You're methodical, calm under pressure, and you thrive in structured, high-stakes environments. You respect procedure, value progression, and you're drawn to the scale and professionalism of commercial aviation. The flight deck of a Boeing 787 or Airbus A350 is your natural habitat. You'll put in the years, earn the stripes, and do it properly.",
      emoji: "✈️",
      color: "#1a6cf7",
...
const medicalQuiz: Quiz = {
  ...
  tagline:
    "Find out if your health profile is likely to clear Class 1 or Class 2",
  description:
    "One of the biggest fears aspiring pilots have is a hidden medical condition ruling them out. This quiz walks you through the key criteria in plain English.",
  emoji: "🩺",
  type: "scored",
  ...
  questions: [
    {
      ...
      options: [
        {
          value: "a",
          label: "6/6 or correctable to 6/6 in both eyes",
          emoji: "👁️",
          score: 3,
        },
        {
          value: "b",
          label: "Slightly below 6/6 but correctable with glasses",
          emoji: "👓",
          score: 2,
        },
        {
          value: "c",
          label: "Significantly impaired even with correction",
          emoji: "⚠️",
          score: 0,
        },
      ],
    },
    {
      ...
      options: [
        {
          value: "a",
          label: "No history of any heart conditions",
          emoji: "❤️",
          score: 3,
        },
        {
          value: "b",
          label: "Minor issue, fully resolved and medically cleared",
          emoji: "✅",
          score: 2,
        },
        {
          value: "c",
          label: "Ongoing or significant cardiac history",
          emoji: "🏥",
          score: 0,
        },
      ],
    },
    {
      ...
      options: [
        { value: "a", label: "No, never", emoji: "✅", score: 3 },
        {
          value: "b",
          label:
            "Single episode, fully investigated, no recurrence in 10+ years",
          emoji: "📋",
          score: 1,
        },
        {
          value: "c",
          label: "Yes, ongoing or recent history",
          emoji: "⚠️",
          score: 0,
        },
      ],
    },
    {
      ...
      options: [
        {
          value: "a",
          label: "No history of mental health treatment",
          emoji: "🧠",
          score: 3,
        },
        {
          value: "b",
          label: "Past treatment, fully resolved, no current medication",
          emoji: "✅",
          score: 2,
        },
        {
          value: "c",
          label: "Currently receiving treatment or on psychiatric medication",
          emoji: "💊",
          score: 1,
        },
      ],
    },
    {
      ...
      options: [
        {
          value: "a",
          label: "18.5–29.9 (healthy or slightly overweight)",
          emoji: "💪",
          score: 3,
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          value: "b",
          label: "Type 2, diet-controlled only",
          emoji: "🥗",
          score: 2,
        },
        {
          value: "c",
          label: "Insulin-dependent or Type 1",
          emoji: "💉",
          score: 0,
        },
      ],
    },
    {
      ...
      options: [
        {
          value: "a",
          label: "Normal hearing in both ears",
          emoji: "👂",
          score: 3,
        },
        {
          value: "b",
          label: "Mild hearing loss, manageable without aids",
          emoji: "🔊",
          score: 2,
        },
        {
          value: "c",
          label: "Significant hearing loss or require hearing aids",
          emoji: "⚠️",
          score: 1,
        },
      ],
    },
    {
      id: "m8",
      question:
        "Do you have any history of substance misuse or alcohol dependency?",
      options: [
        { value: "a", label: "No history", emoji: "✅", score: 3 },
        {
          value: "b",
          label: "Past history, fully resolved, several years clean",
          emoji: "🌱",
          score: 2,
        },
        {
          value: "c",
          label: "Recent or ongoing issues",
          emoji: "⚠️",
          score: 0,
        },
      ],
    },
    {
      ...
      options: [
        { value: "a", label: "No regular medication", emoji: "✅", score: 3 },
        {
          value: "b",
          label:
            "Yes, but for a minor condition (e.g. antihistamines, mild blood pressure)",
          emoji: "💊",
          score: 2,
        },
        {
          value: "c",
          label: "Yes, for a significant condition",
          emoji: "⚠️",
          score: 1,
        },
      ],
    },
    {
      id: "m10",
      question:
        "Have you ever had a significant head injury or neurological condition?",
      options: [
        { value: "a", label: "No", emoji: "✅", score: 3 },
        {
          value: "b",
          label: "Minor concussion, fully recovered",
          emoji: "🪖",
          score: 2,
        },
        {
          value: "c",
          label: "Significant head injury or neurological diagnosis",
          emoji: "⚠️",
          score: 0,
        },
      ],
  ...
  results: [
    ...
    },
    {
      ...
      description:
        "Your profile has one or two areas that are worth discussing with an AME before you commit to training. This doesn't mean you'll fail — many conditions are manageable or have been misunderstood. Book an informal chat with a CAA-approved AME first. They can give you a realistic picture before you spend money on training.",
      emoji: "🔍",
      color: "#d97706",
      minScore: 15,
      maxScore: 24,
      cta: {
        label: "Check the Class 1 Medical guide",
...
const mythBusterQuiz: Quiz = {
  ...
  description:
    "Most people believe things about flying that simply aren't true — and some things that sound crazy are completely real. How sharp is your aviation radar?",
  emoji: "💡",
  type: "trivia",
  badge: "Most Fun",
  duration: "3 min",
  ...
  questions: [
    {
      id: "myth1",
      question:
        "You can open an aircraft door mid-flight if you really tried hard enough.",
      options: [
        {
          value: "false",
          label: "FALSE — it's physically impossible",
          correct: true,
        },
        {
          value: "true",
          label: "TRUE — it's possible with enough force",
          correct: false,
        },
      ],
      explanation:
        "FALSE. At cruising altitude, the cabin pressure differential creates a force of several tonnes against the door. It is physically impossible to open from the inside. The door acts like a plug — the higher the altitude, the more firmly it's sealed.",
    },
    {
      id: "myth2",
      ...
      explanation:
        "FALSE. Flight data recorders are bright orange so they can be found easily in wreckage. The name 'black box' likely comes from WWII when the British hid secret electronics in non-reflective black boxes — the name stuck long after the colour changed.",
    },
    {
      id: "myth3",
      ...
      options: [
        {
          value: "false",
          label: "FALSE — turbulence is almost never dangerous to the aircraft",
          correct: true,
        },
        {
          value: "true",
          label: "TRUE — severe turbulence can cause structural failure",
          correct: false,
        },
      ],
      explanation:
        "FALSE. Modern aircraft are tested to withstand forces far beyond anything encountered in normal or even severe turbulence. Pilots liken it to driving on a bumpy road. The danger from turbulence is almost always to unsecured passengers or crew — not the aircraft itself.",
    },
    {
      id: "myth4",
      question:
        "Airlines use actual chickens to test aircraft windshields and engines.",
      options: [
        {
          value: "true",
          label: "TRUE — they fire dead chickens from cannons",
          correct: true,
        },
        {
          value: "false",
          label: "FALSE — they use synthetic materials only",
          correct: false,
        },
      ],
      explanation:
        "TRUE. The 'chicken cannon' or 'bird gun' fires dead chickens at aircraft windshields, engines, and tails to simulate bird strikes. Chickens from poultry farms are used for certification tests. The U.S. Air Force now uses clay and plastic birds, but the real thing is still standard in commercial aviation testing.",
    },
    {
      id: "myth5",
      question:
        "Food genuinely tastes different on a plane — it's not just your imagination.",
      options: [
        {
          value: "true",
          label: "TRUE — cabin conditions change your taste perception",
          correct: true,
        },
        {
          value: "false",
          label: "FALSE — it's all in your head",
          correct: false,
        },
      ],
      explanation:
        "TRUE. Low cabin humidity (sometimes below 12% — drier than most deserts) reduces your sense of smell, which accounts for 80% of taste. Lower air pressure also reduces oxygen to olfactory receptors. Engine noise further reduces sensitivity to sweet and sour flavours by up to 30%. Airlines compensate by adding more salt, umami-rich ingredients, and stronger seasoning.",
    },
    {
      id: "myth6",
      question:
        "If both engines fail, a commercial airliner will fall out of the sky immediately.",
      options: [
        {
          value: "false",
          label: "FALSE — planes can glide for a very long distance",
          correct: true,
        },
        {
          value: "true",
          label:
            "TRUE — without engines, the aircraft cannot maintain altitude",
          correct: false,
        },
      ],
      explanation:
        "FALSE. A Boeing 747 can glide approximately 100 miles from 30,000 feet with no engine power. Aircraft are essentially very efficient gliders. Pilots train for this scenario regularly. The most famous example is Air Transat Flight 236, which glided 120km to a safe landing in the Azores after running out of fuel.",
    },
    {
      id: "myth7",
    ...
    },
    {
      id: "myth8",
      question:
        "Pilots on long-haul flights are allowed to sleep during the flight.",
      options: [
        {
          value: "true",
    ...
    },
    {
      ...
      options: [
        {
          value: "false",
          label: "FALSE — aircraft are designed to withstand lightning",
          correct: true,
        },
        {
          value: "true",
          label: "TRUE — lightning is a serious risk to aircraft",
          correct: false,
        },
      ],
      explanation:
        "FALSE. Commercial aircraft are struck by lightning on average once per year per aircraft. They are designed with conductive paths that allow lightning to travel through the airframe and exit safely. The last confirmed lightning-caused crash was in 1967. Modern aircraft are comprehensively protected.",
    },
    {
      id: "myth10",
  ...
  results: [
    ...
    },
    {
      ...
      description:
        "You scored 0–2 correct. Some of the most common aviation myths are the most persistent — and the most anxiety-inducing. The truth is that flying is extraordinarily safe, and most of what people fear about it is based on misunderstanding. Now you know the reality. That's a good start.",
      emoji: "😅",
      color: "#6b7280",
      minScore: 0,
      maxScore: 2,
...
const readinessQuiz: Quiz = {
  ...
  description:
    "This isn't a pass/fail test. It's a gap analysis — five dimensions, one honest score, and a clear picture of what you need to do next.",
  emoji: "📊",
  type: "diagnostic",
  badge: "Most Useful",
  duration: "5 min",
  ...
  questions: [
    {
      id: "r1",
      question:
        "How much have you saved or budgeted specifically for flight training?",
      subtext: "Integrated ATPL costs £80k–£120k. Modular costs £40k–£80k.",
      options: [
        {
          value: "a",
          label:
            "I have a full funding plan in place (savings, loan, or sponsor)",
          emoji: "💰",
          score: 3,
        },
        {
          value: "b",
          label:
            "I have some savings and a rough plan but haven't finalised it",
          emoji: "💳",
          score: 2,
        },
        {
          value: "c",
          label: "I'm still figuring out how to fund it",
          emoji: "🤔",
          score: 1,
        },
        {
          value: "d",
          label: "I haven't thought seriously about funding yet",
          emoji: "❓",
          score: 0,
        },
      ],
    },
    {
      ...
      options: [
        {
          value: "a",
          label: "Full-time — I can dedicate 40+ hours per week",
          emoji: "⏰",
          score: 3,
        },
        {
          value: "b",
          label: "Part-time — 15–25 hours per week consistently",
          emoji: "📅",
          score: 2,
        },
        {
          value: "c",
          label: "Limited — under 15 hours per week",
          emoji: "⌛",
          score: 1,
        },
        {
          value: "d",
          label: "I'm not sure — my schedule is unpredictable",
          emoji: "❓",
          score: 0,
        },
      ],
    },
    {
      ...
      options: [
        ...
        {
          value: "b",
          label: "Yes — Class 2, and I'm confident I'd pass Class 1",
          emoji: "🩺",
          score: 2,
        },
        {
      ...
      options: [
        {
          value: "a",
          label:
            "Very clear — I've researched integrated vs modular and made a decision",
          emoji: "🎯",
          score: 3,
        },
        {
      ...
      options: [
        {
          value: "a",
          label:
            "Completely committed — this is happening, I just need the plan",
          emoji: "🔥",
          score: 3,
        },
        {
    ...
    },
    {
      id: "r8",
      question:
        "Do you understand the minimum requirements to apply to airlines?",
      subtext: "e.g. ATPL, minimum hours, type ratings",
      options: [
        {
          value: "a",
          label:
            "Yes — I understand the full pathway from ab initio to airline",
          emoji: "🎓",
          score: 3,
        },
        {
    ...
    },
    {
      id: "r9",
      question:
        "Have you considered the lifestyle implications of a pilot career?",
      ...
      options: [
        ...
        {
          value: "d",
          label: "No — I haven't considered the lifestyle at all",
          emoji: "❓",
          score: 0,
        },
      ],
    },
    {
      id: "r10",
      question:
        "If you started training tomorrow, what's your biggest concern?",
      options: [
        {
          value: "a",
          label: "Nothing major — I feel ready to go",
          emoji: "🚀",
          score: 3,
        },
        {
          value: "b",
          label: "The cost — I need to sort the finances first",
          emoji: "💸",
          score: 2,
        },
        {
          value: "c",
          label: "Whether I'll actually make it — self-doubt",
          emoji: "😟",
          score: 1,
        },
        {
          value: "d",
          label: "I don't know enough to know what I don't know",
          emoji: "🌀",
          score: 0,
        },
      ],
  ...
  results: [
    {
      ...
      description:
        "You've done the groundwork. Your finances are in order, your health is sorted, you understand the pathway, and your motivation is solid. The next step is choosing your school and committing. Don't overthink it — you're ready.",
      emoji: "🚀",
      color: "#16a34a",
      minScore: 22,
      maxScore: 30,
    ...
    },
    {
      ...
      description:
        "You're serious and you've made real progress, but there are one or two areas that need attention before you start spending money on training. Use the results above to identify your weakest dimension and focus there first.",
      emoji: "📋",
      color: "#2563eb",
      minScore: 14,
      maxScore: 21,
    ...
    },
    {
      ...
      description:
        "You're interested, but there are significant gaps in your preparation — most likely around funding, the medical, or understanding the pathway. That's completely normal at this stage. The important thing is to close those gaps systematically before committing to training.",
      emoji: "🗺️",
      color: "#d97706",
      minScore: 7,
      maxScore: 13,
      cta: {
        label: "Read our how to become a pilot guide",
    ...
    },
    {
      ...
      description:
        "You're at the very start of your journey. You don't yet have the information, the plan, or the preparation in place — but you have the interest, and that's what matters. Start with the guides, take the full assessment, and build your knowledge base before you make any financial commitments.",
      emoji: "🌱",
      color: "#7c3aed",
      minScore: 0,
      maxScore: 6,
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        {
          value: "a",
          label: "Piper PA-28 Cherokee",
          emoji: "❌",
          correct: false,
        },
        {
          value: "b",
          label: "Beechcraft Bonanza",
          emoji: "❌",
          correct: false,
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          value: "d",
          label: "Bombardier C Series",
          emoji: "❌",
          correct: false,
        },
      ],
      explanation:
        "The Airbus A320 family (including A318, A319, A320, A321) has received over 10,000 orders, making it the best-selling commercial aircraft family in history. It introduced fly-by-wire controls to commercial aviation.",
    },
    {
      id: "ac7",
      question:
        "This iconic WWII fighter was the only Allied fighter in continuous production throughout the war. What is it?",
      options: [
        { value: "a", label: "Hawker Hurricane", emoji: "❌", correct: false },
        { value: "b", label: "P-51 Mustang", emoji: "❌", correct: false },
        {
          value: "c",
          label: "Supermarine Spitfire",
          emoji: "✅",
          correct: true,
        },
      ...
      explanation:
        "The Supermarine Spitfire was the only Allied fighter produced continuously throughout WWII. Over 20,000 were built in 24 variants. Its elliptical wing design gave it exceptional manoeuvrability and is considered one of the most beautiful aircraft ever built.",
    },
    {
      id: "ac8",
      question:
        "This aircraft was the first to fly without refuelling around the world non-stop. What is it?",
      options: [
        ...
        {
          value: "d",
          label: "Spirit of St. Louis",
          emoji: "❌",
          correct: false,
        },
      ],
      explanation:
        "Voyager, designed by Burt Rutan and piloted by Dick Rutan and Jeana Yeager, completed the first non-stop, unrefuelled circumnavigation of the Earth in December 1986. The flight took 9 days, 3 minutes, and 44 seconds.",
    },
    {
      id: "ac9",
      question:
        "This tilt-rotor aircraft can take off like a helicopter and fly like a fixed-wing plane. What is it?",
      options: [
        { value: "a", label: "Sikorsky CH-53", emoji: "❌", correct: false },
        {
          value: "b",
          label: "Bell-Boeing V-22 Osprey",
          emoji: "✅",
          correct: true,
        },
        {
          value: "c",
          label: "AgustaWestland AW609",
          emoji: "❌",
          correct: false,
        },
      ...
      explanation:
        "The Bell-Boeing V-22 Osprey uses tiltrotor technology — its engines rotate 90 degrees to convert from helicopter to fixed-wing flight. It can take off and land vertically but cruise at 509 km/h, combining the best of both aircraft types.",
    },
    {
      id: "ac10",
      question:
        "This aircraft made the first powered, controlled, heavier-than-air flight in 1903. What is it?",
      options: [
        { value: "a", label: "Curtiss June Bug", emoji: "❌", correct: false },
        {
          value: "b",
          label: "Santos-Dumont 14-bis",
          emoji: "❌",
          correct: false,
        },
      ...
      explanation:
        "The Wright Flyer made the first successful powered, controlled, heavier-than-air flight on 17 December 1903 at Kitty Hawk, North Carolina. The first flight lasted 12 seconds and covered 37 metres. Orville Wright was at the controls.",
    },
  ],
  results: [
    {
      ...
      description:
        "9–10 correct. You know your aircraft like a professional. Your depth of knowledge spans commercial aviation, military history, and general aviation. You'd be a formidable opponent in any aviation pub quiz — and you'd probably ace the academic side of flight training.",
      emoji: "🏆",
      color: "#f59e0b",
      minScore: 9,
      maxScore: 10,
    ...
    },
    {
      ...
      description:
        "7–8 correct. You clearly know your aviation. You got the famous ones right and even a few of the trickier ones. A couple of the more obscure aircraft caught you out, but your overall knowledge is impressive.",
      emoji: "✈️",
      color: "#3b82f6",
      minScore: 7,
      maxScore: 8,
    ...
    },
    {
      ...
      description:
        "4–6 correct. You know the famous aircraft — Concorde, the 747, the Spitfire — but some of the more technical or historical questions caught you out. You're in good company: most people score in this range.",
      emoji: "🛫",
      color: "#8b5cf6",
      minScore: 4,
      maxScore: 6,
    ...
    },
    {
      ...
      description:
        "0–3 correct. Aviation is a world of its own, and you're just getting started. The good news: every expert pilot started exactly where you are. Curiosity is the only prerequisite.",
      emoji: "🌱",
      color: "#6b7280",
      minScore: 0,
      maxScore: 3,
...
const obstacleQuiz: Quiz = {
  ...
  description:
    "Most aspiring pilots are held back by one primary barrier. This quiz identifies yours — and tells you exactly what to do about it.",
  emoji: "🚧",
  type: "diagnostic",
  badge: "Top Funnel",
  duration: "2 min",
  ...
  questions: [
    {
      id: "o1",
      question:
        "When you think about becoming a pilot, what's the first thing that makes you hesitate?",
      options: [
        {
          value: "finance",
          label: "The cost — I can't see how I'd fund £80k+ of training",
          emoji: "💸",
        },
        {
          value: "time",
          label: "The time — I have work, family, or other commitments",
          emoji: "⏰",
        },
        {
          value: "medical",
          label: "My health — I'm worried about passing the medical",
          emoji: "🩺",
        },
        {
          value: "confidence",
          label: "Myself — I'm not sure I'm smart or capable enough",
          emoji: "😟",
        },
        {
          value: "info",
          label: "The complexity — I don't know where to start",
          emoji: "🌀",
        },
      ],
    },
    {
      ...
      options: [
        {
          value: "finance",
          label: "Often, but I always hit a wall when I see the costs",
          emoji: "💰",
        },
        {
          value: "time",
          label:
            "Occasionally, but I can't figure out how to fit it around my life",
          emoji: "📅",
        },
        {
          value: "medical",
          label:
            "I avoid it because I'm worried about the medical requirements",
          emoji: "⚠️",
        },
        {
          value: "confidence",
          label: "Rarely — I don't feel like it's really for someone like me",
          emoji: "💭",
        },
        {
          value: "info",
          label: "Constantly, but I end up more confused than when I started",
          emoji: "🔍",
        },
      ],
    },
    {
      id: "o3",
      question:
        "If someone gave you £100,000 tomorrow specifically for flight training, what would you do?",
      options: [
        {
          value: "finance",
          label: "Start immediately — money was the only thing stopping me",
          emoji: "🚀",
        },
        {
          value: "time",
          label: "Still struggle — I'd need to sort my life situation first",
          emoji: "⏳",
        },
        {
          value: "medical",
          label: "Get a medical assessment first before committing",
          emoji: "🏥",
        },
        {
          value: "confidence",
          label: "Still hesitate — I'm not sure I'd make it through training",
          emoji: "😰",
        },
        {
          value: "info",
          label:
            "Start researching properly — I still wouldn't know where to start",
          emoji: "📚",
        },
      ],
    },
    {
      id: "o4",
      question:
        "What best describes your current financial situation relative to pilot training?",
      options: [
        {
          value: "finance",
          label: "I have no realistic path to funding it right now",
          emoji: "❌",
        },
        {
          value: "finance2",
          label: "I could fund it but it would require major life changes",
          emoji: "⚖️",
        },
        {
          value: "time",
          label: "Finance isn't the issue — time and lifestyle are",
          emoji: "🕐",
        },
        {
          value: "confidence",
          label: "I have the money but I'm not sure I should spend it on this",
          emoji: "🤔",
        },
      ],
    },
    {
      id: "o5",
      question:
        "Have you ever had a trial flight or been in a small aircraft cockpit?",
      options: [
        {
          value: "confidence",
        ...
        },
        {
          value: "time",
          label:
            "Yes, and I loved it — I just can't find the time to pursue it",
          emoji: "❤️",
        },
        {
          value: "finance",
    ...
    },
    {
      ...
      subtext:
        "14 ATPL exams covering meteorology, navigation, systems, and more",
      options: [
        {
          value: "confidence",
        ...
        },
        {
          value: "time",
          label:
            "Fine with the content, but finding study time is the challenge",
          emoji: "📖",
        },
        {
          value: "info",
          label:
            "I didn't even know there were exams — I need more information",
          emoji: "❓",
        },
        {
          value: "finance",
    ...
    },
    {
      id: "o7",
      question:
        "What's your biggest fear about starting and then not finishing?",
      options: [
        {
          value: "finance",
      ...
      options: [
        {
          value: "finance",
          label:
            "A clear guide to financing pilot training — loans, schemes, options",
          emoji: "💰",
        },
        {
          value: "time",
  ...
  results: [
    ...
    },
    {
      ...
      color: "#3b82f6",
      cta: {
        label: "Explore the modular route",
    ...
    },
    {
      ...
      subtitle:
        "You're overwhelmed by complexity and don't know where to start",
      description:
  ...
  questions: [
    {
      ...
      subtext:
        "Assume you're in VMC (good visibility) and flying over flat terrain",
      options: [
        {
          value: "a",
        ...
        },
        {
          value: "b",
          label:
            "Cross-check with a third source (VSI, terrain, ATC) before deciding which to trust",
          emoji: "✅",
          score: 3,
        },
        {
        ...
        {
          value: "d",
          label: "Declare an emergency immediately",
          emoji: "🚨",
          score: 0,
        },
      ],
      explanation:
        "The correct approach is always to cross-check with a third source. No single instrument should be trusted over all others. Pilots are trained to identify instrument failures by comparing multiple sources — this is the foundation of instrument flying.",
    },
    {
      id: "pt2",
      question:
        "ATC gives you a clearance to descend to 4,000 feet. You believe you're currently at 4,200 feet. What do you do?",
      options: [
        {
          value: "a",
          label: "Start descending immediately — ATC knows where you are",
          emoji: "⬇️",
          score: 1,
        },
        {
          value: "b",
          label:
            "Readback the clearance, confirm your current altitude, then descend",
          emoji: "✅",
          score: 3,
        },
        {
          value: "c",
          label:
            "Ask ATC to confirm your current altitude before doing anything",
          emoji: "📻",
          score: 2,
        },
        {
          value: "d",
          label: "Refuse the clearance until you're certain of your altitude",
          emoji: "❌",
          score: 0,
        },
      ],
      explanation:
        "Always readback clearances — this confirms you heard correctly and gives ATC a chance to correct any error. Confirming your current altitude before descending is good practice. ATC does not always have precise altitude information for every aircraft.",
    },
    {
      id: "pt3",
      question:
        "You're on final approach to land. The runway looks shorter than expected. What's your first thought?",
      options: [
        {
          value: "a",
          label: "I must be higher than normal — I'll steepen my approach",
          emoji: "⬇️",
          score: 1,
        },
        {
          value: "b",
          label:
            "I might be too high, too fast, or on the wrong runway — go around and reassess",
          emoji: "✅",
          score: 3,
        },
        {
          value: "c",
          label: "The runway looks fine — I'll continue the approach",
          emoji: "🛬",
          score: 0,
        },
        {
          value: "d",
          label: "I'll land anyway and brake hard",
          emoji: "⚠️",
          score: 0,
        },
      ],
      explanation:
        "If anything looks wrong on approach, the correct response is always to go around. A go-around costs a few minutes; a runway overrun can be fatal. Pilots are trained to treat any unexpected visual cue as a reason to reassess, not to press on.",
    },
    {
      id: "pt4",
      question:
        "You're flying solo and feel suddenly unwell — mild dizziness and nausea. What do you do?",
      options: [
        {
          value: "a",
          label: "Continue to destination — it's probably nothing",
          emoji: "😐",
          score: 0,
        },
        {
          value: "b",
          label:
            "Divert to the nearest suitable airfield and land as soon as possible",
          emoji: "✅",
          score: 3,
        },
        {
          value: "c",
          label: "Declare a PAN PAN (urgency), inform ATC, and divert",
          emoji: "📻",
          score: 3,
        },
        {
          value: "d",
          label: "Open a window and hope it passes",
          emoji: "🪟",
          score: 0,
        },
      ],
      explanation:
        "Both B and C are correct. Pilot incapacitation is a serious risk and must be treated immediately. A PAN PAN (urgency) declaration is appropriate — it's not an emergency yet, but you need priority handling. Never continue flying when unwell.",
    },
    {
      id: "pt5",
      question:
        "You arrive at your aircraft for a pre-flight check and notice a small crack in the windscreen. What do you do?",
      options: [
        {
          value: "a",
          label: "It's small — I'll fly and report it when I land",
          emoji: "✈️",
          score: 0,
        },
        {
          value: "b",
          label: "Ground the aircraft and report it to maintenance immediately",
          emoji: "✅",
          score: 3,
        },
        {
          value: "c",
          label:
            "Take a photo, note it in the log, and fly if it doesn't worsen",
          emoji: "📸",
          score: 0,
        },
        {
          value: "d",
          label: "Ask another pilot if they think it's safe to fly",
          emoji: "🤷",
          score: 1,
        },
      ],
      explanation:
        "Any crack in a windscreen is a reason to ground the aircraft. Windscreens are structural components that maintain cabin pressurisation and protect against bird strikes. The decision to fly must never be based on how small a defect looks — it must be assessed by a qualified engineer.",
    },
    {
      id: "pt6",
      question:
        "You're flying in deteriorating weather. Visibility is dropping. You're not instrument rated. What do you do?",
      options: [
        {
          value: "a",
          label: "Fly lower to stay below the cloud base",
          emoji: "⬇️",
          score: 0,
        },
        {
          value: "b",
          label: "Turn around immediately and return to VMC conditions",
          emoji: "✅",
          score: 3,
        },
        {
          value: "c",
          label: "Continue — you know the area well",
          emoji: "➡️",
          score: 0,
        },
        {
          value: "d",
          label: "Climb above the cloud and navigate by GPS",
          emoji: "⬆️",
          score: 0,
        },
      ],
      explanation:
        "VFR into IMC (flying into cloud without an instrument rating) is one of the leading causes of fatal general aviation accidents. The only correct response is to turn around immediately. Familiarity with the area is irrelevant — without visual reference, spatial disorientation can occur within minutes.",
    },
    {
      id: "pt7",
      question:
        "You're about to take off and a passenger tells you they feel very anxious. What do you do?",
      options: [
        {
          value: "a",
          label: "Reassure them and continue — anxiety is normal",
          emoji: "😊",
          score: 1,
        },
        {
          value: "b",
          label:
            "Take a moment to explain the flight, address their specific concerns, then proceed",
          emoji: "✅",
          score: 3,
        },
        {
        ...
        {
          value: "d",
          label: "Tell them to relax and that flying is safe",
          emoji: "🙄",
          score: 0,
        },
      ],
      explanation:
        "Crew Resource Management (CRM) — the ability to communicate effectively with passengers and crew — is a core pilot skill. Dismissing a passenger's concerns is poor practice. Taking a moment to genuinely address their anxiety is both the right thing to do and the safest outcome.",
    },
    {
      id: "pt8",
      question:
        "You've been flying for 6 hours and you're tired. You have 45 minutes left to your destination. What do you do?",
      options: [
        {
          value: "a",
          label: "Push on — it's only 45 minutes",
          emoji: "➡️",
          score: 0,
        },
        {
          value: "b",
          label: "Increase your scan frequency and drink something caffeinated",
          emoji: "☕",
          score: 1,
        },
        {
          value: "c",
          label:
            "Land at the nearest suitable airfield, rest, and continue when fit to fly",
          emoji: "✅",
          score: 3,
        },
        {
          value: "d",
          label: "Ask your co-pilot to take over",
          emoji: "👤",
          score: 2,
        },
      ],
      explanation:
        "Fatigue is one of the most significant causes of aviation accidents. The regulations exist for a reason, and a pilot who feels unfit to fly must not fly — regardless of how close they are to their destination. 'Get-there-itis' (pressing on despite warning signs) is a well-documented and deadly phenomenon.",
    },
  ],
  results: [
    {
    ...
    },
    {
      ...
      subtitle:
        "Your instincts need recalibrating — but that's what training is for",
      description:
    ...
    },
    {
      ...
      subtitle:
        "Your instincts are civilian instincts — and that's the starting point for everyone",
      description:
