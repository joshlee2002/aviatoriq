...
import { Search, ShieldCheck, Globe, Stethoscope, DollarSign, RefreshCw } from "lucide-react";
...
const steps = [
  {
    ...
    sources: [
      { name: "UK CAA Official Publications", url: "https://www.caa.co.uk/our-work/publications/" },
      { name: "FAA Aeronautical Information Manual", url: "https://www.faa.gov/air_traffic/publications/atpubs/aim_html/" },
      { name: "EASA Part-FCL", url: "https://www.easa.europa.eu/en/document-library/easy-access-rules/easy-access-rules-aircrew-regulation-eu-no-11782011" },
      { name: "CASA CASR Part 61", url: "https://www.legislation.gov.au/Series/F2013L00968" },
      { name: "Transport Canada CARs", url: "https://tc.canada.ca/en/corporate-services/acts-regulations/list-regulations/canadian-aviation-regulations-sor-96-433" },
    ],
  },
  {
    icon: Globe,
    ...
    sources: [
      { name: "British Airways Media Centre", url: "https://mediacentre.britishairways.com/" },
  ...
  },
  {
    ...
    sources: [
      { name: "CAA Medical Standards (AMS)", url: "https://www.caa.co.uk/medical/" },
      { name: "EASA Part-MED", url: "https://www.easa.europa.eu/en/document-library/easy-access-rules/easy-access-rules-aircrew-regulation-eu-no-11782011" },
      { name: "FAA AME Guidance", url: "https://www.faa.gov/licenses_certificates/medical_certification/" },
    ],
  },
  {
    icon: DollarSign,
    ...
    sources: [
      { name: "Lendwise (FCA authorised, firm no. 782496)", url: "https://lendwise.com/" },
      { name: "Skyborne Airline Academy", url: "https://www.skyborne.com/uk/integrated-atpl/" },
      { name: "BALPA Pay & Conditions", url: "https://www.balpa.org/becoming-a-pilot/salary-and-benefits/" },
    ],
  },
  {
    icon: RefreshCw,
      ...
      <main className="flex-1">
        ...
        >
          <div className="container max-w-3xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              >
                <ShieldCheck className="w-5 h-5" style={{ color: "oklch(0.65 0.18 240)" }} />
              </div>
            ...
            <p className="text-base leading-relaxed" style={{ color: "oklch(0.65 0.04 240)" }}>
              AviatorIQ covers pilot training regulations, medical standards, costs, and career pathways across nine
              country markets. This is high-stakes content. Here is exactly how we research, verify, and maintain it.
            </p>
          </div>
        </div>
        ...
        <div className="py-10 md:py-14">
          <div className="container max-w-3xl space-y-6">
                ...
                >
                  <div className="flex items-start gap-3 mb-3">
                    <div
                      ...
                      style={{ background: "oklch(0.45 0.18 240 / 0.15)" }}
                    >
                      <Icon className="w-4 h-4" style={{ color: "oklch(0.65 0.18 240)" }} />
                    </div>
                  ...
                  {step.sources.length > 0 && (
                    <div>
                      <p className="text-xs font-semibold text-white mb-1">Example sources:</p>
            ...
            >
              <h2 className="text-base font-bold text-white mb-3">What We Never Do</h2>
              <ul className="space-y-2 text-sm" style={{ color: "oklch(0.65 0.04 240)" }}>
                {[
                  ...
                  <li key={i} className="flex items-start gap-2">
                    <span className="flex-shrink-0 text-xs font-bold" style={{ color: "oklch(0.65 0.18 145)" }}>✗</span>
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
