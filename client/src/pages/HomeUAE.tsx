...
const UAE_TOOLS = [
  ...
  { icon: "🧮", label: "Cost Calculator", href: "/calculator", desc: "Estimate your total training cost in AED" },
  { icon: "🩺", label: "Medical Check", href: "/tools/class-1-medical-check", desc: "Assess your GCAA Class 1 medical eligibility" },
  { icon: "✈️", label: "Cadet Eligibility Checker", href: "/cadet-eligibility", desc: "Emirates, Etihad, and Air Arabia cadet programmes" },
];

const UAE_STATS = [
  { value: "AED 350k–500k", label: "Integrated ATPL cost", icon: <DollarSign className="w-5 h-5" /> },
  ...
  { value: "Tax-free", label: "Pilot salary structure", icon: <TrendingUp className="w-5 h-5" /> },
];
    ...
    <>
        ...
        <div className="container py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <p className="text-lg md:text-xl mb-8 max-w-2xl" style={{ color: "oklch(0.70 0.04 240)" }}>
              The UAE offers some of the world's most prestigious pilot careers — Emirates, Etihad, and Air Arabia all operate cadet programmes. Get accurate GCAA training routes, real 2026 costs in AED, and your personalised roadmap.
            </p>
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link href="/uae/guides/uae-pilot-training-costs" className="inline-flex items-center justify-center gap-2 px-6 py-4 rounded-xl text-base font-semibold text-white/80 no-underline transition-all hover:text-white" style={{ background: "oklch(1 0 0 / 0.06)", border: "1px solid oklch(1 0 0 / 0.15)" }}>
                View Training Costs
              </Link>
            </div>
          </div>
      ...
      <section className="py-16" style={{ background: "oklch(0.11 0.07 245)" }}>
        <div className="container max-w-4xl">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-8 text-center">Why Train or Fly in the UAE?</h2>
      ...
      <section className="py-16" style={{ background: "oklch(0.12 0.06 240)" }}>
        <div className="container">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-2 text-center">UAE Pilot Training Tools</h2>
          <p className="text-center mb-10 text-sm" style={{ color: "oklch(0.55 0.04 240)" }}>Free tools built for GCAA candidates</p>
      ...
      <section className="py-16" style={{ background: "oklch(0.12 0.06 240)" }}>
        <div className="container">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">UAE Pilot Training Guides</h2>
              <p className="text-sm" style={{ color: "oklch(0.55 0.04 240)" }}>Researched, accurate, and specific to GCAA regulations</p>
            </div>
      ...
      <section className="py-16" style={{ background: "oklch(0.11 0.07 245)" }}>
        <div className="container text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">UAE Flight Academies</h2>
          <p className="text-base max-w-xl mx-auto mb-8" style={{ color: "oklch(0.6 0.04 240)" }}>
            Browse GCAA-approved flight academies across the UAE. Compare Emirates FTA, Etihad Aviation Training, and independent schools.
          </p>
      ...
      <section className="py-20" style={{ background: "linear-gradient(160deg, oklch(0.10 0.10 255) 0%, oklch(0.14 0.12 248) 100%)" }}>
        <div className="container text-center max-w-2xl">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to start your UAE pilot journey?</h2>
          <p className="text-lg mb-8" style={{ color: "oklch(0.65 0.04 240)" }}>
            Get your personalised GCAA training roadmap in under 5 minutes. Free, no registration required.
          </p>
