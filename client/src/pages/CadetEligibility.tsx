  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "oklch(0.10 0.08 252)" }}>
      ...
      <main className="flex-1">
        ...
        >
          <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: "url('/manus-storage/cadet-simulator_2a0c874e.jpg')", backgroundSize: "cover", backgroundPosition: "center 40%", opacity: 0.09 }} />
