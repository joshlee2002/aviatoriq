...
const PROGRAMMES: Programme[] = [
  {
    ...
    locations: ["UK"],
    description:
      "British Airways' flagship cadet programme. Fully funded training with a guaranteed First Officer role at BA on completion. Highly competitive — typically 1,000+ applicants per place.",
    keyFacts: [
  ...
  },
  {
    ...
    locations: ["UK", "EU"],
    description:
      "easyJet's cadet programme offering funded training and a guaranteed First Officer role. Highly competitive with multiple selection stages.",
    keyFacts: [
  ...
  },
  {
    ...
    locations: ["UK", "EU"],
    description:
      "Ryanair's cadet programme through partner schools (FTEJerez, Bartolini Air, MATS). Self-funded training with a pathway to a First Officer role at Ryanair.",
    keyFacts: [
  ...
  },
  {
    ...
    locations: ["EU"],
    description:
      "Wizz Air's cadet programme through partner ATOs. Self-funded training with a pathway to a First Officer role at one of Europe's fastest-growing airlines.",
    keyFacts: [
  ...
  },
  {
    ...
    locations: ["UK"],
    description:
      "TUI's Multi-Pilot Licence (MPL) programme. Fully integrated training with a guaranteed First Officer role at TUI Airways.",
    keyFacts: [
      "Funded training — no upfront cost to candidate",
...
const QUESTIONS: Question[] = [
  {
    ...
    subtext:
      "All five programmes accept applicants aged 18 and over with no upper age limit.",
    options: [
  ...
  },
  {
    ...
    subtext:
      "Some programmes are fully funded by the airline. Others require you to self-fund.",
    options: [
  ...
  },
  {
    ...
    subtext:
      "Most cadet programmes accept complete beginners. Flying hours are a bonus, not a requirement.",
    options: [
...
function checkEligibility(
  ...
  if (programme.selfFunded) {
    ...
    if (budget < programme.minBudget) {
      reasons.push(
        `This programme requires self-funding of approximately £${programme.minBudget}k+. Your stated budget may be insufficient.`
      );
    }
  }
  ...
  if (answers.location === "other") {
    reasons.push(
      "This programme is typically open to UK/EU residents only. Check the airline's current requirements."
    );
  } else if (answers.location === "eu" && !programme.locations.includes("EU")) {
    reasons.push(
      "This programme is currently UK-based and may not be open to EU applicants."
    );
  }
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-[var(--color-muted-foreground)] mb-2">
            {programme.airline} ·{" "}
            {programme.selfFunded
              ? `Self-funded (~£${programme.minBudget}k+)`
              : "Funded by airline"}
          </p>
...
export default function CadetEligibility() {
  ...
  const eligibleProgrammes = PROGRAMMES.filter(
    p => checkEligibility(p, answers).eligible
  );
      ...
      <SEO
        ...
        schema={{
          ...
          mainEntity: [
            {
              "@type": "Question",
              name: "What are the UK airline cadet programmes?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "The main UK airline cadet programmes are: BA Speedbird Academy (British Airways), easyJet Generation Pilot, Ryanair Cadet Programme, Wizz Air Pilot Academy, and TUI MPL Programme.",
              },
            },
            {
              "@type": "Question",
              name: "Are airline cadet programmes funded?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "BA Speedbird Academy, easyJet Generation Pilot, and TUI MPL are fully funded by the airline. Ryanair and Wizz Air programmes are self-funded by the candidate.",
              },
            },
            {
              "@type": "Question",
              name: "What qualifications do I need for a cadet programme?",
              acceptedAnswer: {
                "@type": "Answer",
                text: "Most cadet programmes require a minimum of 5 GCSEs (A*–C) including Maths and English. BA Speedbird Academy and TUI MPL also require 2 A-levels or equivalent.",
              },
            },
          ],
        }}
      ...
      <main className="flex-1">
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "url('/manus-storage/cadet-simulator_2a0c874e.jpg')",
          ...
          <div className="container max-w-2xl relative text-center">
            ...
            >
              Answer 5 questions to find out which UK and European airline cadet
              programmes you are eligible for — BA, easyJet, Ryanair, Wizz Air,
              and TUI.
            </p>
            <div
              className="inline-flex items-center gap-2 px-3 py-2 rounded-xl text-xs mb-2"
              style={{
            ...
            >
              <span>🌍</span>
              <span>
                Based in the USA, Australia, or Canada? Check out the{" "}
                <a
                  href="/us/cadet-eligibility"
                  style={{ textDecoration: "underline", color: "inherit" }}
                >
                  US cadet programmes checker
                </a>{" "}
                or search our{" "}
                <a
                  href="/schools"
                ...
                for airline-affiliated schools in your country.
              </span>
            </div>
              ...
              >
                <div
                  ...
                  style={{
                    width: `${progress}%`,
                    background:
                      "linear-gradient(90deg, oklch(0.72 0.18 65), oklch(0.65 0.2 50))",
                  }}
                />
              </div>
            </div>
            ...
            {!complete ? (
                ...
                <div className="space-y-2.5">
                  {QUESTIONS[currentQ].options.map(opt => (
                    <button
                      key={opt.value}
                      onClick={() =>
                        handleAnswer(QUESTIONS[currentQ].id, opt.value)
                      }
              ...
              <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                      ...
                      style={{
                        background:
                          eligibleProgrammes.length > 0
                            ? "oklch(0.72 0.18 65 / 0.15)"
                            : "oklch(0.5 0.04 240 / 0.15)",
                      }}
                    >
                      {eligibleProgrammes.length > 0 ? (
                        <CheckCircle2
                    ...
                    <div>
                      ...
                      <p
                        ...
                        style={{ color: "oklch(0.55 0.04 240)" }}
                      >
                        Based on your answers. Eligibility is indicative —
                        always check the airline's current requirements.
                      </p>
                    </div>
                  </div>
                  <button
                ...
                {ineligibleProgrammes.length > 0 && (
                  <div>
                    <h3
                      className="font-display font-bold text-white mb-3 flex items-center gap-2"
                ...
                >
                  <div className="flex gap-2">
                    ...
                    <p
                      ...
                      style={{ color: "oklch(0.6 0.04 240)" }}
                    >
                      This tool provides indicative eligibility guidance only.
                      Cadet programme requirements change frequently. Always
                      check the airline's official website for current
                      requirements before applying. Meeting the minimum criteria
                      does not guarantee selection — these programmes are highly
                      competitive.
                    </p>
                  </div>
                </div>
