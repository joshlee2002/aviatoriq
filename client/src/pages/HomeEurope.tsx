...
const EU_GUIDES = [
  {
    title: "European Pilot Training Costs 2026",
    href: "/europe/guides/pilot-training-costs",
    desc: "Integrated and modular ATPL — real 2026 costs from European flight schools.",
    tag: "Popular",
  },
  {
    title: "European Pilot Salary 2026",
    href: "/europe/guides/pilot-salary-2026",
    desc: "FO to Captain pay at Ryanair, Wizz Air, Lufthansa, BA, and Air France.",
    tag: "Salary",
  },
  {
    title: "EASA ATPL Requirements 2026",
    href: "/europe/guides/easa-atpl-requirements",
    desc: "EASA ATPL pathways, integrated vs modular, and what it really costs in EUR.",
    tag: "Essential",
  },
  {
    title: "EASA Class 1 Medical 2026",
    href: "/europe/guides/easa-medical-class-1",
    desc: "AeMC requirements, disqualifying conditions, and how to prepare across EU countries.",
    tag: "Medical",
  },
  {
    title: "EASA CPL Requirements 2026",
    href: "/europe/guides/easa-cpl-requirements",
    desc: "Everything you need to know about the EASA Commercial Pilot Licence.",
    tag: "Licence",
  },
  {
    title: "European Airline Cadet Programmes 2026",
    href: "/europe/guides/europe-cadet-programs",
    desc: "Lufthansa EFA, BA Speedbird, Wizz Air WAPA, and Air France — all compared.",
    tag: "Cadets",
  },
  {
    title: "Lufthansa European Flight Academy 2026",
    href: "/europe/guides/lufthansa-european-flight-academy",
    desc: "EFA cadet programme — €120k cost, Brain Capital ISA, DLR test, and career paths.",
    tag: "Cadets",
  },
  {
    title: "Air France-KLM Cadet Programs 2026",
    href: "/europe/guides/air-france-klm-cadet-pilot-program",
    desc: "Fully sponsored Air France and deferred-payment KLM cadet pathways.",
    tag: "Cadets",
  },
  {
    title: "European Pilot Shortage 2026",
    href: "/europe/guides/europe-pilot-shortage",
    desc: "The growing pilot shortage in Europe — opportunities and career outlook.",
    tag: "Career",
  },
  {
    title: "European Regional Airlines 2026",
    href: "/europe/guides/europe-regional-airlines-pilot-training",
    desc: "The stepping stones to major European airline careers.",
    tag: "Career",
  },
  {
    title: "EASA Flight Instructor 2026",
    href: "/europe/guides/europe-flight-instructor",
    desc: "FI rating requirements, costs, salary, and how instructing fits into hour building.",
    tag: "Career",
  },
  {
    title: "European Military Pilot to Airlines 2026",
    href: "/europe/guides/military-to-airlines",
    desc: "EASA ATPL conversion for ex-military pilots — credits, costs, and airline pathways.",
    tag: "Career",
  },
];
...
const EU_TOOLS = [
  {
    ...
    href: "/quiz",
    desc: "Get your personalised EASA training roadmap",
  },
  {
    icon: "🧮",
    label: "Cost Calculator",
    href: "/tools/calculator",
    desc: "Estimate your total ATPL training cost in EUR",
  },
  {
    icon: "🩺",
    label: "EASA Medical Check",
    href: "/tools/class-1-medical-check",
    desc: "Assess your Class 1 medical eligibility",
  },
  {
    icon: "✈️",
    label: "Cadet Eligibility Checker",
    href: "/tools/cadet-eligibility",
    desc: "Lufthansa, Ryanair, easyJet, and other European cadet programmes",
  },
];
...
const EU_COUNTRIES = [
  {
    flag: "🇩🇪",
    name: "Germany",
    note: "Lufthansa Aviation Training, DLR selection",
  },
  ...
  { flag: "🇫🇷", name: "France", note: "Air France cadet, ENAC, Aéroformation" },
  {
    flag: "🇵🇹",
    name: "Portugal",
    note: "TAP cadet, EPST, affordable training",
  },
  {
    flag: "🇬🇷",
    name: "Greece",
    note: "Olympic Air, Aegean cadet, Athens Flying Club",
  },
  {
    flag: "🇨🇿",
    name: "Czech Republic",
    note: "Czech Airlines, lower cost modular training",
  },
];
  ...
  return (
    <>
        ...
        <div className="container relative w-full py-12 md:py-20 lg:py-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              ...
              >
                Integrated or modular ATPL? Which European country? How much
                will it actually cost in EUR? Answer 5 questions and get a
                specific, data-driven roadmap — your exact EASA route, real 2026
                costs, timeline, and matched European flight schools.
              </p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">
              EASA Training Routes Explained
            </h2>
            <p
              className="text-base max-w-2xl mx-auto"
              style={{ color: "oklch(0.6 0.04 240)" }}
            >
              EASA standardises pilot training across all EU member states. The
              same licence is valid across 32 countries.
            </p>
          </div>
            ...
            {[
              {
                ...
                pros: [
                  "Fastest route to airline",
                  "Structured environment",
                  "Preferred by major cadets",
                ],
      ...
      <section className="py-16" style={{ background: "oklch(0.11 0.07 245)" }}>
        <div className="container">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-2 text-center">
            Train Anywhere in Europe
          </h2>
          <p
            className="text-center mb-10 text-sm"
            style={{ color: "oklch(0.55 0.04 240)" }}
          >
            Your EASA licence is valid across all 32 member states
          </p>
      ...
      <section className="py-16" style={{ background: "oklch(0.12 0.06 240)" }}>
        <div className="container">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-2 text-center">
            European Pilot Training Tools
          </h2>
          <p
            className="text-center mb-10 text-sm"
            style={{ color: "oklch(0.55 0.04 240)" }}
          >
            Free tools built for EASA candidates
          </p>
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">
                European Pilot Training Guides
              </h2>
              <p className="text-sm" style={{ color: "oklch(0.55 0.04 240)" }}>
                Researched, accurate, and specific to EASA regulations
              </p>
            </div>
            <Link
              href="/guides"
      ...
      >
        <div className="container text-center max-w-2xl">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to start your European pilot journey?
          </h2>
          <p className="text-lg mb-8" style={{ color: "oklch(0.65 0.04 240)" }}>
            Get your personalised EASA training roadmap in under 5 minutes.
