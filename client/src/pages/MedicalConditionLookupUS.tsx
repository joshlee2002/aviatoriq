...
const CONDITIONS: ConditionEntry[] = [
  {
    ...
    summary: "Mild, well-controlled asthma is generally acceptable. Severe asthma requires a Special Issuance.",
    ...
    caveats: "You must declare all asthma history on MedXPress. If you meet the CACI criteria, the AME can issue your medical same-day.",
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary: "ADHD medication is strictly prohibited. A history of ADHD requires extensive psychological testing.",
    ...
    caveats: "Do NOT stop taking prescribed medication without consulting your doctor. If you have an ADHD history, consult a HIMS AME before submitting your MedXPress application.",
    source: "FAA AME Guide — ADHD / ADD",
  },
  {
    name: "Color Blindness",
    keywords: ["color blind", "colour blind", "color blindness", "color deficiency", "cvd", "deuteranopia", "protanopia", "red green color"],
    verdict: "case_by_case",
    summary: "Color vision deficiency requires passing alternative tests. Failing all tests results in a night flying restriction.",
    ...
    caveats: "If you fail the OCVT/MFT, the night flying restriction becomes permanent and you cannot take the test again. Do not take the OCVT until you are fully prepared.",
    source: "FAA AME Guide — Color Vision",
  },
  {
    name: "Depression & Anxiety",
    keywords: ["depression", "depressive", "anxiety", "gad", "panic", "ssri", "sertraline", "fluoxetine", "citalopram", "escitalopram", "lexapro", "zoloft", "prozac"],
    verdict: "case_by_case",
    summary: "A history of depression/anxiety requires a Special Issuance. The FAA allows four specific SSRI medications.",
    ...
    caveats: "Other antidepressants (like Wellbutrin or SNRIs) are NOT approved. A history of suicidal ideation is extremely difficult to overcome.",
    source: "FAA AME Guide — SSRI Decision Path",
  },
  {
    name: "Vision / Eyesight",
    keywords: ["short sighted", "long sighted", "myopia", "astigmatism", "glasses", "contact lenses", "laser eye surgery", "lasik", "prk", "vision", "eyesight"],
    verdict: "likely_ok",
    summary: "Corrected vision to 20/20 is required for First Class. Glasses, contacts, and LASIK are all permitted.",
    ...
    caveats: "If you've had LASIK, bring your surgical records and the completed FAA eye evaluation form to your AME appointment.",
    source: "FAA AME Guide — Vision",
  },
  {
    name: "High Blood Pressure (Hypertension)",
    keywords: ["high blood pressure", "hypertension", "blood pressure medication", "lisinopril", "amlodipine", "losartan"],
    verdict: "likely_ok",
    summary: "Controlled hypertension is acceptable. The AME can issue your medical if you meet CACI criteria.",
    ...
    caveats: "You must declare the condition and medication on MedXPress. Bring the specific CACI Hypertension worksheet completed by your doctor.",
    source: "FAA AME Guide — Hypertension (CACI)",
  },
  {
    name: "Diabetes (Type 1 & Type 2)",
    keywords: ["diabetes", "diabetic", "type 1 diabetes", "type 2 diabetes", "insulin", "metformin", "blood sugar"],
    verdict: "case_by_case",
    summary: "Type 2 diabetes controlled by diet or oral medication may qualify. Insulin-dependent diabetes requires a Special Issuance.",
    ...
    caveats: "You must carry a blood glucose meter and fast-acting glucose on every flight. Glucose must be between 100-300 mg/dL before flight.",
    source: "FAA AME Guide — Diabetes Mellitus",
  },
  {
    name: "Epilepsy / Seizures",
    keywords: ["epilepsy", "seizure", "seizures", "epileptic", "convulsion", "fits"],
    verdict: "likely_disqualifying",
    summary: "A history of seizures is generally disqualifying. Special Issuance is possible only after a very long seizure-free period.",
    ...
    caveats: "If you have had a single febrile seizure as a child, this is evaluated much more favourably than adult-onset epilepsy. Consult a HIMS AME before applying.",
    source: "FAA AME Guide — Seizure Disorders",
  },
  {
    name: "Sleep Apnoea",
    keywords: ["sleep apnoea", "sleep apnea", "cpap", "obstructive sleep apnoea", "osa", "snoring"],
    verdict: "likely_ok",
    summary: "Treated sleep apnoea is acceptable. You must demonstrate compliance with CPAP therapy.",
    ...
    caveats: "You must bring CPAP compliance data (download from your CPAP machine) to your AME appointment. Bring your CPAP on all overnight trips.",
    source: "FAA AME Guide — Obstructive Sleep Apnea (CACI)",
  },
  {
    name: "Heart Conditions (Cardiovascular)",
    keywords: ["heart", "cardiac", "coronary", "heart attack", "myocardial infarction", "arrhythmia", "atrial fibrillation", "afib", "pacemaker", "stent", "bypass"],
    verdict: "case_by_case",
    summary: "Many cardiac conditions require a Special Issuance. Some, like controlled AFib, may qualify under CACI.",
    ...
    caveats: "Any cardiac history must be fully disclosed on MedXPress. Failure to disclose is a federal offence and will result in certificate revocation.",
    source: "FAA AME Guide — Cardiovascular Conditions",
  },
  {
    name: "Mental Health History",
    keywords: ["mental health", "psychiatric", "bipolar", "schizophrenia", "psychosis", "ptsd", "ocd", "eating disorder", "therapy", "counselling", "counseling"],
    verdict: "case_by_case",
    summary: "Most mental health history requires a Special Issuance. Severity and treatment history are key factors.",
    ...
    caveats: "Do not lie or omit mental health history on MedXPress. The FAA has access to insurance records and can detect omissions. Voluntary disclosure is always treated more favourably.",
    source: "FAA AME Guide — Psychiatric Conditions",
  },
  {
    name: "Kidney Stones",
    keywords: ["kidney stones", "renal calculi", "kidney stone", "urolithiasis"],
    verdict: "case_by_case",
    summary: "A single resolved kidney stone episode is generally acceptable after treatment. Recurrent stones require more evaluation.",
    ...
    caveats: "Bring a recent renal ultrasound or CT report to your AME appointment confirming no current stones.",
    source: "FAA AME Guide — Kidney Stones (CACI)",
  },
  {
    name: "Alcohol / Substance History",
    keywords: ["alcohol", "alcoholism", "substance abuse", "drug use", "dui", "dwi", "drunk driving", "addiction", "rehabilitation"],
    verdict: "case_by_case",
    summary: "A history of alcohol dependence or DUI requires a Special Issuance. Two or more DUIs is extremely serious.",
    ...
    caveats: "The FAA has a specific reporting requirement: you must report any DUI/DWI within 60 days of the conviction. Failure to do so is a federal offence.",
    source: "FAA AME Guide — Alcohol/Substance Dependence",
  },
  {
    name: "Cancer / Oncology History",
    keywords: ["cancer", "tumour", "tumor", "oncology", "chemotherapy", "radiation", "leukaemia", "leukemia", "lymphoma", "melanoma"],
    verdict: "case_by_case",
    summary: "Many cancer survivors can obtain a Special Issuance after treatment and a disease-free period.",
    ...
    caveats: "Bring complete oncology records including pathology reports, treatment records, and most recent follow-up evaluations.",
    source: "FAA AME Guide — Oncology",
  },
  {
    name: "Hearing Loss",
    keywords: ["hearing loss", "deaf", "deafness", "hearing aid", "tinnitus", "cochlear implant"],
    verdict: "case_by_case",
    summary: "Hearing aids are permitted. You must meet minimum speech discrimination standards.",
    ...
    caveats: "If you use a hearing aid, bring it to your AME exam. The AME will test your hearing with the aid in place.",
    source: "FAA AME Guide — Hearing",
  },
  {
    name: "Thyroid Conditions",
    keywords: ["thyroid", "hypothyroidism", "hyperthyroidism", "thyroid medication", "levothyroxine", "synthroid"],
    verdict: "likely_ok",
    summary: "Treated hypothyroidism is generally acceptable. Hyperthyroidism requires treatment and stability before certification.",
    detail: "Hypothyroidism treated with levothyroxine (Synthroid) is a CACI condition — the AME can issue your certificate directly if your TSH levels are within normal range and you are on a stable dose. Hyperthyroidism (overactive thyroid) requires treatment and a period of stability before the FAA will consider certification. Thyroid cancer history is evaluated under the oncology guidelines.",
    caveats: "Bring your most recent thyroid function test results (TSH, T4) to your AME appointment.",
    source: "FAA AME Guide — Thyroid (CACI)",
  },
  {
    name: "Migraines",
    keywords: ["migraine", "migraines", "migraine headaches", "cluster headaches", "severe headaches"],
    verdict: "case_by_case",
    summary: "Infrequent migraines without neurological symptoms may be acceptable. Frequent or complex migraines require Special Issuance.",
    ...
    caveats: "Keep a headache diary documenting frequency, duration, and symptoms. This will be required for any FAA evaluation.",
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary: "HIV-positive pilots on stable antiretroviral therapy may qualify for a Special Issuance.",
    ...
    caveats: "This is a complex evaluation. Work with a HIMS AME from the beginning to ensure your documentation meets FAA requirements.",
    source: "FAA AME Guide — HIV",
  },
  {
    name: "Autism Spectrum Disorder (ASD)",
    keywords: ["autism", "autistic", "asd", "asperger", "aspergers", "spectrum disorder"],
    verdict: "case_by_case",
    summary: "ASD is evaluated individually. High-functioning individuals may qualify, but the process is lengthy.",
    ...
    caveats: "There is no standard pathway for ASD. Consult a HIMS AME before beginning the application process to understand what documentation will be required.",
    ...
    <div className="min-h-screen flex flex-col" style={{ background: "oklch(0.14 0.04 240)", color: "oklch(0.95 0.02 240)" }}>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-6">Will it stop you flying?</h1>
          <p className="text-xl max-w-2xl mx-auto mb-10" style={{ color: "oklch(0.65 0.04 240)" }}>
            Search the database to see how the FAA assesses specific medical conditions for airline pilots.
          </p>

          {/* Search Bar */}
          <div className="max-w-2xl mx-auto relative">
            <div className="relative">
              <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-6 h-6" style={{ color: "oklch(0.5 0.04 240)" }} />
              <input
                type="text"
            ...
            {searchQuery && !selectedCondition && (
              <div className="absolute top-full left-0 right-0 mt-2 rounded-xl border overflow-hidden z-50 shadow-2xl"
                  ...
                  <div className="max-h-96 overflow-y-auto">
                    {filteredConditions.map((c, i) => (
                      ...
                      >
                        ...
                        <ChevronRight className="w-5 h-5" style={{ color: "oklch(0.5 0.04 240)" }} />
                      </button>
                    ))}
                  </div>
                ) : (
                  <div className="p-6 text-center" style={{ color: "oklch(0.65 0.04 240)" }}>
      ...
      <section className="py-12 flex-grow">
        <div className="container mx-auto px-4 max-w-3xl">
          {selectedCondition ? (
            <div className="rounded-2xl border p-8 animate-in fade-in slide-in-from-bottom-4"
              style={{ background: "oklch(0.18 0.05 240)", borderColor: "oklch(0.28 0.06 240)" }}>
              
              <div className="flex items-start justify-between mb-6">
                <h2 className="text-3xl font-bold text-white">{selectedCondition.name}</h2>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-sm font-bold uppercase tracking-wider mb-3" style={{ color: "oklch(0.5 0.04 240)" }}>
                    FAA Policy Detail
                  </h3>
                  <p className="text-base leading-relaxed" style={{ color: "oklch(0.8 0.02 240)" }}>
                    {selectedCondition.detail}
                  </p>
                </div>

                {selectedCondition.caveats && (
                  <div className="p-4 rounded-xl flex gap-3" style={{ background: "oklch(0.25 0.06 240)" }}>
                    <AlertTriangle className="w-5 h-5 shrink-0" style={{ color: "oklch(0.65 0.22 45)" }} />
                    <p className="text-sm text-white">{selectedCondition.caveats}</p>
                  </div>
                )}

                <div className="pt-6 border-t" style={{ borderColor: "oklch(0.28 0.06 240)" }}>
              ...
              <div className="mt-8 pt-8 border-t flex flex-col sm:flex-row gap-4" style={{ borderColor: "oklch(0.28 0.06 240)" }}>
                <button 
                  onClick={() => {
                    setSelectedCondition(null);
                    setSearchQuery("");
            ...
            <div className="text-center">
              <p className="text-sm font-bold uppercase tracking-wider mb-6" style={{ color: "oklch(0.5 0.04 240)" }}>
                Popular Searches
              </p>
              <div className="flex flex-wrap justify-center gap-3">
                {["ADHD", "Asthma", "Color Blindness", "Vision", "Depression"].map((term) => (
                  <button
                    key={term}
                    onClick={() => {
                      setSearchQuery(term);
                      const condition = CONDITIONS.find(c => c.name.includes(term) || c.keywords.includes(term.toLowerCase()));
      ...
      {/* Disclaimer */}
      <section className="py-12 border-t" style={{ borderColor: "oklch(0.28 0.06 240)", background: "oklch(0.12 0.04 240)" }}>
        <div className="container mx-auto px-4 max-w-3xl text-center">
          <Info className="w-6 h-6 mx-auto mb-4" style={{ color: "oklch(0.5 0.04 240)" }} />
          <p className="text-sm leading-relaxed" style={{ color: "oklch(0.5 0.04 240)" }}>
            <strong>Disclaimer:</strong> This tool provides general guidance based on public FAA AME guidelines. It is not medical advice. Only an FAA-certified Aviation Medical Examiner (AME) can make a definitive ruling on your fitness to fly. If you have a complex medical history, we strongly recommend booking a "consultation only" appointment with an AME or a HIMS AME before submitting an official MedXPress application.
          </p>
        </div>
      </section>
