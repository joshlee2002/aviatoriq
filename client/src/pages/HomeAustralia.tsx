...
const AU_GUIDES = [
  {
    title: "Pilot Training Costs Australia 2026: The Full Breakdown",
    href: "/australia/guides/australia-pilot-training-costs",
    desc: "CPL, ATPL, PPL — real 2026 costs from Australian flight schools.",
    tag: "Popular",
  },
  {
    title: "Australian Pilot Salary 2026: Qantas, Virgin & Regionals",
    href: "/australia/guides/australia-pilot-salary-2026",
    desc: "From a $65k instructor to a $400k+ Qantas A380 Captain — real 2026 pay scales.",
    tag: "Salary",
  },
  {
    title: "CASA Class 1 Medical: What You Need to Know",
    href: "/australia/guides/casa-medical-class-1",
    desc: "DAME requirements, disqualifying conditions, and how to prepare.",
    tag: "Medical",
  },
  {
    title: "CASA CPL Requirements 2026",
    href: "/australia/guides/casa-cpl-requirements",
    desc: "Everything you need to know about the CASA Commercial Pilot Licence.",
    tag: "Licence",
  },
  {
    title: "Qantas Group Pilot Academy 2026",
    href: "/australia/guides/qantas-group-pilot-academy",
    desc: "Australia's premier pilot training program — costs, curriculum, and career pathways.",
    tag: "Cadets",
  },
  {
    title: "Australian Airline Cadet Programmes 2026",
    href: "/australia/guides/australia-cadet-programs",
    desc: "Qantas Group, Virgin Australia, Rex, and regional airline cadet pathways.",
    tag: "Cadets",
  },
  {
    title: "CASA ATPL Requirements 2026",
    href: "/australia/guides/casa-atpl-requirements",
    desc: "Everything you need to know about the CASA Airline Transport Pilot Licence.",
    tag: "Licence",
  },
  {
    title: "Rex Pilot Academy 2026",
    href: "/australia/guides/rex-pilot-academy",
    desc: "Rex's cadet pathway — structure, costs, and career prospects with Australia's regional carrier.",
    tag: "Cadets",
  },
  {
    title: "Australia Pilot Shortage 2026",
    href: "/australia/guides/australia-pilot-shortage",
    desc: "The growing pilot shortage in Australia — opportunities and how to position yourself.",
    tag: "Career",
  },
  {
    title: "Australia Regional Airlines 2026",
    href: "/australia/guides/australia-regional-airlines",
    desc: "QantasLink, Rex, Alliance — the stepping stones to mainline airline careers.",
    tag: "Career",
  },
  {
    title: "Flight Instructor Australia 2026",
    href: "/australia/guides/australia-flight-instructor",
    desc: "CASA FIR requirements, costs, salary, and how instructing fits into hour building.",
    tag: "Career",
  },
];
...
const AU_TOOLS = [
  {
    ...
    href: "/quiz",
    desc: "Get your personalised CASA training roadmap",
  },
  {
    icon: "🧮",
    label: "Cost Calculator",
    href: "/tools/calculator",
    desc: "Estimate your total CPL/ATPL training cost in AUD",
  },
  {
    icon: "🩺",
    label: "CASA Medical Check",
  ...
  },
  {
    ...
    desc: "Qantas, Virgin, Rex, and regional cadet programmes",
  },
];
...
const AU_STATS = [
  ...
  {
    value: "~4,200",
    label: "Commercial pilots in Australia",
    ...
    <>
        ...
        <div className="container relative w-full py-12 md:py-20 lg:py-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              ...
              >
                CPL or ATPL? Integrated or modular? How much will it actually
                cost in AUD? Answer 5 questions and get a specific, data-driven
                roadmap — your exact CASA route, real 2026 costs, timeline, and
                matched Australian flight schools. No generic advice.
              </p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">
              CASA Training Routes Explained
            </h2>
            <p
              className="text-base max-w-2xl mx-auto"
              style={{ color: "oklch(0.6 0.04 240)" }}
            >
              Australia has two main pathways to a commercial pilot licence
              under CASA. Understanding the difference is the first decision
              you'll make.
            </p>
          </div>
      ...
      <section className="py-16" style={{ background: "oklch(0.11 0.07 245)" }}>
        <div className="container">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-2 text-center">
            Australian Pilot Training Tools
          </h2>
          <p
            className="text-center mb-10 text-sm"
            style={{ color: "oklch(0.55 0.04 240)" }}
          >
            Free tools built for CASA candidates
          </p>
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">
                Australian Pilot Training Guides
              </h2>
              <p className="text-sm" style={{ color: "oklch(0.55 0.04 240)" }}>
                Researched, accurate, and specific to CASA regulations
              </p>
            </div>
            <Link
              href="/guides"
      ...
      <section className="py-16" style={{ background: "oklch(0.11 0.07 245)" }}>
        <div className="container text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">
            Australian Flight Schools
          </h2>
          <p
            className="text-base max-w-xl mx-auto mb-8"
            style={{ color: "oklch(0.6 0.04 240)" }}
          >
            Browse CASA-approved flight schools across Australia. Compare costs,
            locations, and training routes.
          </p>
          <Link
            href="/schools"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-bold text-white no-underline"
      ...
      >
        <div className="container text-center max-w-2xl">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to start your Australian pilot journey?
          </h2>
          <p className="text-lg mb-8" style={{ color: "oklch(0.65 0.04 240)" }}>
            Get your personalised CASA training roadmap in under 5 minutes.
