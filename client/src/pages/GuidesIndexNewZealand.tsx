...
export default function GuidesIndexNewZealand() {
  useEffect(() => { document.title = "New Zealand Pilot Training Guides 2026 – AviatorPath"; }, []);
        ...
        <div className="relative overflow-hidden py-10 md:py-16" style={{ background: "linear-gradient(160deg, oklch(0.10 0.10 255) 0%, oklch(0.14 0.12 248) 100%)" }}>
          ...
          <div className="container max-w-3xl text-center relative">
            ...
            <p className="text-base md:text-lg mb-5" style={{ color: "oklch(0.65 0.04 240)" }}>
              CAA NZ licences, flight school costs, salary data, and cadet programmes — everything for aspiring New Zealand pilots. Updated for 2026.
            </p>
        ...
        <div className="px-4 pt-4 pb-0" style={{ background: "oklch(0.11 0.08 252)" }}>
          <div className="container max-w-4xl">
            <p className="text-xs" style={{ color: muted }}>
              ...
              {" › "}
              <span style={{ color: "oklch(0.7 0.04 240)" }}>New Zealand</span>
            </p>
          </div>
        </div>
        ...
        <div className="py-6 md:py-8 px-4" style={{ background: "oklch(0.11 0.08 252)" }}>
          <div className="container max-w-4xl">
            ...
            <div className="p-4 rounded-xl mb-4 flex items-start gap-3" style={{ background: "oklch(0.45 0.18 240 / 0.08)", border: "1px solid oklch(0.45 0.18 240 / 0.2)" }}>
              ...
              <p className="text-sm" style={{ color: "oklch(0.65 0.04 240)" }}><strong className="text-white/70">More New Zealand guides coming.</strong> We are actively expanding our New Zealand content. Check back soon, or take the free assessment to get a personalised roadmap now.</p>
            </div>
