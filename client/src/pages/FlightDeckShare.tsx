...
export default function FlightDeckShare() {
  ...
  if (isLoading) {
    return (
      ...
      >
        <div className="text-white/65 text-sm animate-pulse">
          Loading result...
        </div>
      </div>
    );
    ...
    return (
      ...
      >
        ...
        <p className="text-white/60 text-sm">
          This result link has expired or does not exist.
        </p>
    ...
    >
      ...
      <div className="max-w-lg mx-auto px-4 py-8 space-y-4">
        <div className="rounded-2xl border border-white/10 bg-white/5 p-7 text-center">
          <p className="text-white/65 text-xs uppercase tracking-widest mb-5">
            Their pilot profile
          </p>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
          <p className="text-white/65 text-xs uppercase tracking-widest mb-2">
            Archetype
          </p>
        ...
        <div className="rounded-2xl border border-[var(--color-gold)]/25 bg-[var(--color-gold)]/5 p-6 text-center">
          <p className="text-white/65 text-xs uppercase tracking-widest mb-3">
            Curious about your own profile?
          </p>
          <h2 className="text-xl font-display font-bold text-white mb-2">
            Find your biggest barrier
          </h2>
          <p className="text-white/55 text-sm mb-5 max-w-sm mx-auto leading-relaxed">
            Take the free 2-minute Flight Deck quiz and discover what is really
            stopping you becoming a pilot.
          </p>
          <Link href="/quiz/flight-deck">
