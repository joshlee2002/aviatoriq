            ...
            <div className="card-base p-6 md:p-8 space-y-8">
              {[
                ...
                },
                {
                  ...
                  content:
                    "The career assessment and AI-generated roadmap are tools to help you explore your options. They are based on the information you provide and general training data. We do not guarantee the accuracy of cost estimates, timelines, or school recommendations. Individual results will vary.",
                },
                {
                  heading: "4. School directory",
                  content:
                    "Flight schools listed in our directory have provided their own information. We do not endorse any particular school and are not responsible for the accuracy of school-provided content. Always conduct your own due diligence before enrolling.",
                },
                {
                  heading: "5. User conduct",
                  content:
                    "You agree not to: provide false information in the assessment, attempt to access other users' data, use the platform for any unlawful purpose, or attempt to disrupt or damage the platform.",
                },
                {
