...
const COUNTRY_DESCRIPTIONS: Record<Exclude<Country, null>, string> = {
  ...
  australia:
    "CASA licences, CPL/ATPL training, Australian flight schools, cadet programmes",
  canada:
    "Transport Canada CPL/ATPL, Canadian flight schools, NAV CANADA airspace",
  europe:
    "EASA licences, integrated ATPL, European flight academies, EU airline cadets",
  uae: "GCAA licences, Gulf airline cadet programmes, UAE flight schools",
  "south-africa":
    "SACAA licences, South African flight schools, CPL/ATPL training",
  "new-zealand": "CAA NZ licences, NZ flight schools, CPL/ATPL training",
  india:
    "DGCA licences, Indian flight schools, CPL training, airline cadet programmes",
  singapore:
    "CAAS licences, Singapore flight schools, regional airline pathways",
  other: "Global guidance — we'll tailor recommendations to your location",
};

const PRIMARY_MARKETS: Exclude<Country, null>[] = [
  "uk",
  "us",
  "australia",
  "canada",
...
const SECONDARY_MARKETS: Exclude<Country, null>[] = [
  "uae",
  "south-africa",
  "new-zealand",
  "india",
    ...
    <>
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          >
            We'll give you guidance, costs, and school recommendations specific
            to your country and regulator.
          </p>
        </div>
            ...
            {SECONDARY_MARKETS.map(code => {
              ...
              return (
                ...
                >
                  ...
                  <ChevronRight
                    className="w-3.5 h-3.5 ml-auto opacity-40 group-hover:opacity-80 group-hover:translate-x-0.5 transition-all"
                    style={{ color: "oklch(0.65 0.22 45)" }}
                  />
                </button>
              );
