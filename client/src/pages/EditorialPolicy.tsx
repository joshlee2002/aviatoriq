  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "oklch(0.10 0.08 252)" }}>
      ...
      <main className="flex-1">
        <div className="py-10 md:py-14" style={{ background: "linear-gradient(160deg, oklch(0.10 0.10 255) 0%, oklch(0.14 0.12 248) 100%)" }}>
        ...
        <div className="py-10 px-4" style={{ background: "oklch(0.11 0.08 252)" }}>
          <div className="container max-w-3xl space-y-10" style={{ color: "oklch(0.7 0.04 240)" }}>
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed mb-3">
                Our content is produced by the AviatorIQ editorial team, drawing on publicly available regulatory documentation, official airline careers pages, industry salary surveys, and direct correspondence with Approved Training Organisations (ATOs). Where specialist knowledge is required — for example, in medical or regulatory guides — we rely exclusively on primary sources from the relevant authority (CAA, EASA, FAA, CASA, Transport Canada, or GCAA).
              </p>
              <p className="text-sm leading-relaxed">
                We do not attribute content to named individuals unless their credentials can be independently verified. For more information, see our{" "}
                <Link href="/about-our-authors" className="text-blue-400 underline">About Our Authors</Link> page.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm">
                <li><strong className="text-white">Regulatory bodies:</strong> UK Civil Aviation Authority (CAA), EASA, FAA, CASA (Australia), Transport Canada (TC), and the UAE GCAA.</li>
                <li><strong className="text-white">Airline official communications:</strong> Careers portals, press releases, and official recruitment pages.</li>
                <li><strong className="text-white">Industry data:</strong> BALPA salary surveys, Boeing Commercial Market Outlook, IATA reports, and ICAO data.</li>
                <li><strong className="text-white">Flight school data:</strong> Direct correspondence with Approved Training Organisations (ATOs) to verify costs and fleet details.</li>
              </ul>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm">
                <li>All guides display a <strong className="text-white">Last Updated</strong> date at the top of the page.</li>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm">
                ...
                <li>Where we include a flight school in a guide, it is because our editorial team has assessed it as genuinely relevant and high-quality based on publicly available information.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-sm leading-relaxed">
                We take accuracy seriously. If you believe any information on AviatorIQ is incorrect, outdated, or misleading, please contact us at{" "}
                <a href="mailto:hello@aviatoriq.com" className="text-blue-400 underline">hello@aviatoriq.com</a>. We will investigate all corrections requests within 5 business days and update the guide if warranted.
              </p>
            </section>
