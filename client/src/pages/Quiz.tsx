...
function useAutoAdvance(
  ...
  return useCallback(
    (key: keyof QuizData, value: string) => {
      update(key, value);
...
const EMPTY: QuizData = {
  ...
  wantsSchoolContact: "",
  preferredContact: "",
  contactConsentSchools: true,
  contactConsentFinance: false,
  contactConsentMedical: false,
      ...
      <div className="flex items-center gap-3">
        <div
          className={`w-5 h-5 rounded-full border-2 flex-shrink-0 flex items-center justify-center transition-all ${
            selected
              ? "border-[oklch(0.55_0.18_240)] bg-[oklch(0.55_0.18_240)]"
              : "border-[oklch(1_0_0/0.3)]"
          }`}
        >
  ...
  return (
    <div className="mb-8">
      <div className="flex items-center justify-between mb-3">
        <span className="text-xs font-semibold text-[oklch(0.6_0_0)] uppercase tracking-widest">
          Step {step} of {total}
        </span>
        <span className="text-xs font-bold text-[oklch(0.55_0.18_240)]">
          {pct}% complete
        </span>
      </div>
      <div className="h-1.5 bg-[oklch(1_0_0/0.08)] rounded-full overflow-hidden">
        <div
          ...
          style={{
            width: `${pct}%`,
            background:
              "linear-gradient(90deg, oklch(0.55 0.18 240), oklch(0.65 0.18 200))",
          }}
        />
      </div>
...
function DarkInput({
  ...
  return (
    <div>
      <label className="block text-sm font-semibold text-[oklch(0.85_0_0)] mb-2">
        {label}
      </label>
      <input
        type={type}
...
function Step1({
  ...
  const nameError =
    (touchedName || showErrors) && data.fullName.trim().length < 2
      ? "Please enter your full name."
      : null;
  const emailError =
    (touchedEmail || showErrors) && !data.email.includes("@")
      ? "Please enter a valid email address."
      : null;
  const ageNum = data.age ? parseInt(data.age, 10) : null;
  const ageError =
    (touchedAge || showErrors) &&
    data.age !== "" &&
  ...
  return (
    <StepCard
      ...
      subtitle="Your roadmap will be personalised to your exact profile. We'll never share your details without your permission."
    >
      <div className="space-y-5">
        ...
        <DarkInput
          ...
          type="email"
          hint="Your personalised roadmap will be sent here."
          error={emailError}
        />
        <div className="grid grid-cols-2 gap-4">
          <DarkSelect
            ...
            options={countries}
            hint="Helps us tailor school matches."
          />
          <DarkInput
            label="Age"
            type="number"
...
function Step2({
  ...
  const handlePilotGoal = useCallback(
    (v: string) => {
      update("pilotGoal", v);
  ...
  const handleSpokenToSchool = useCallback(
    (v: string) => {
  ...
  return (
    <StepCard
      title="Your goal and where you are now"
      subtitle="Honest answers lead to better guidance. There are no wrong answers here."
    >
      <div className="space-y-8">
        <div>
          <p className="text-sm font-semibold text-[oklch(0.85_0_0)] mb-4">
            What type of pilot do you want to become?
          </p>
          <div className="space-y-2">
            {[
              "Airline pilot (commercial)",
              "Private pilot (for fun)",
              ...
              <OptionButton
                key={o}
                label={o}
                selected={data.pilotGoal === o}
                onClick={() => handlePilotGoal(o)}
              />
            ))}
          </div>
        </div>
        <div>
          <p className="text-sm font-semibold text-[oklch(0.85_0_0)] mb-2">
            What have you actually done about it so far?
          </p>
          <p className="text-xs text-[oklch(0.5_0_0)] mb-4">
            This is one of the most useful questions — be honest.
          </p>
          <div className="space-y-2">
            {[
              ...
              <OptionButton
                key={o}
                label={o}
                selected={data.spokenToSchool === o}
                onClick={() => handleSpokenToSchool(o)}
              />
            ))}
          </div>
        </div>
...
function Step3({
  ...
  const handleSeriousness = useCallback(
    (v: string) => {
  ...
  return (
    <StepCard
      ...
      subtitle="This is the most important question in the assessment. Your answer shapes everything that follows."
    >
      <div className="space-y-8">
        <div>
          <p className="text-sm font-semibold text-[oklch(0.85_0_0)] mb-2">
            If a flight school offered you a place tomorrow, what would stop you
            starting?
          </p>
          <p className="text-xs text-[oklch(0.5_0_0)] mb-4">
          ...
          <div className="space-y-2">
            {[
              ...
              <OptionButton
                key={o}
                label={o}
                selected={data.biggestConcern === o}
                onClick={() => handleConcern(o)}
              />
            ))}
          </div>
        </div>
        <div>
          <p className="text-sm font-semibold text-[oklch(0.85_0_0)] mb-4">
            How often do you think about becoming a pilot?
          </p>
          <div className="space-y-2">
            {[
              ...
              <OptionButton
                key={o}
                label={o}
                selected={data.seriousness === o}
                onClick={() => handleSeriousness(o)}
              />
            ))}
          </div>
        </div>
...
function Step4({
  ...
  const handleAbroad = useCallback(
    (v: string) => {
  ...
  return (
    <StepCard
      ...
      subtitle="Not sure of the difference between integrated and modular? We'll explain it in your roadmap."
    >
      <div className="space-y-8">
        <div>
          <p className="text-sm font-semibold text-[oklch(0.85_0_0)] mb-4">
            Which training route interests you most?
          </p>
          <div className="space-y-2">
            {[
              ...
              <OptionButton
                key={o}
                label={o}
                selected={data.preferredRoute === o}
                onClick={() => handleRoute(o)}
              />
            ))}
          </div>
        </div>
        <div>
          <p className="text-sm font-semibold text-[oklch(0.85_0_0)] mb-4">
            Are you open to training abroad?
          </p>
          <div className="space-y-2">
            {[
              "Yes — I'd consider it for the right school",
              "No — I want to train in my home country",
              ...
              <OptionButton
                key={o}
                label={o}
                selected={data.openToAbroad === o}
                onClick={() => handleAbroad(o)}
              />
            ))}
          </div>
        </div>
...
function getBudgetOptions(country: string): string[] {
  ...
  if (c.includes("australia"))
    return [
      ...
      "A$80,000–A$140,000",
      "A$140,000+",
      "I need finance — I don't have savings",
    ];
  ...
  if (c.includes("uae") || c.includes("emirates"))
    return [
      "Under AED 50,000",
      "AED 50,000–AED 120,000",
      "AED 120,000–AED 200,000",
      "AED 200,000–AED 350,000",
      "AED 350,000+",
      "I need finance — I don't have savings",
    ];
  if (c.includes("india"))
...
function Step5({
  ...
  const handleFunding = useCallback(
    (v: string) => {
      ...
      if (data.budgetRange && data.wantsFinanceInfo)
        setTimeout(() => onAdvance(), 280);
    },
  ...
  const handleBudget = useCallback(
    (v: string) => {
      ...
      if (data.fundingMethod && data.wantsFinanceInfo)
        setTimeout(() => onAdvance(), 280);
    },
    [update, onAdvance, data.fundingMethod, data.wantsFinanceInfo]
  );
  const handleFinanceInfo = useCallback(
    (v: string) => {
      update("wantsFinanceInfo", v);
      if (data.fundingMethod && data.budgetRange)
        setTimeout(() => onAdvance(), 280);
    },
  ...
  return (
    <StepCard
      ...
      subtitle="This is one of the 10 questions aspiring pilots ask most. Let's be honest about your situation."
    >
      <div className="space-y-8">
        <div>
          <p className="text-sm font-semibold text-[oklch(0.85_0_0)] mb-4">
            How do you expect to fund your training?
          </p>
          <div className="space-y-2">
            {[
              ...
              <OptionButton
                key={o}
                label={o}
                selected={data.fundingMethod === o}
                onClick={() => handleFunding(o)}
              />
            ))}
          </div>
        </div>
        <div>
          <p className="text-sm font-semibold text-[oklch(0.85_0_0)] mb-4">
            What training budget are you realistically working with?
          </p>
          <div className="space-y-2">
            {getBudgetOptions(data.country).map(o => (
              <OptionButton
                key={o}
                label={o}
                selected={data.budgetRange === o}
                onClick={() => handleBudget(o)}
              />
            ))}
          </div>
        </div>
        <div>
          <p className="text-sm font-semibold text-[oklch(0.85_0_0)] mb-4">
            Would you like information about finance options?
          </p>
          <div className="space-y-2">
            {["Yes — please include this", "No", "Maybe"].map(o => (
              <OptionButton
                key={o}
                label={o}
                selected={data.wantsFinanceInfo === o}
                onClick={() => handleFinanceInfo(o)}
              />
            ))}
          </div>
        </div>
...
function Step6({
  ...
  const handleFlying = useCallback(
    (v: string) => {
      ...
      if (data.class1Medical && data.rightToWorkStudy && data.educationLevel)
        setTimeout(() => onAdvance(), 280);
    },
    [
      update,
  ...
  const handleMedical = useCallback(
    (v: string) => {
      ...
      if (data.flyingExperience && data.rightToWorkStudy && data.educationLevel)
        setTimeout(() => onAdvance(), 280);
    },
    [
      update,
      onAdvance,
      data.flyingExperience,
      data.rightToWorkStudy,
      data.educationLevel,
    ]
  );
  const handleRightToWork = useCallback(
    (v: string) => {
      update("rightToWorkStudy", v);
      if (data.flyingExperience && data.class1Medical && data.educationLevel)
        setTimeout(() => onAdvance(), 280);
    },
    [
      update,
  ...
  const handleEducation = useCallback(
    (v: string) => {
      ...
      if (data.flyingExperience && data.class1Medical && data.rightToWorkStudy)
        setTimeout(() => onAdvance(), 280);
    },
    [
      update,
  ...
  return (
    <StepCard
      ...
      subtitle="This helps us assess your readiness and flag anything that needs attention before you spend a penny."
    >
      <div className="space-y-8">
        <div>
          <p className="text-sm font-semibold text-[oklch(0.85_0_0)] mb-4">
          ...
          <div className="space-y-2">
            {[
              ...
              <OptionButton
                key={o}
                label={o}
                selected={data.flyingExperience === o}
                onClick={() => handleFlying(o)}
              />
            ))}
          </div>
        </div>
        <div>
          <p className="text-sm font-semibold text-[oklch(0.85_0_0)] mb-2">
            How confident are you about passing a Class 1 medical?
          </p>
          <p className="text-xs text-[oklch(0.5_0_0)] mb-4">
            Required for commercial flying. Most people pass — but uncertainty
            is common.
          </p>
          <div className="space-y-2">
            {[
              ...
              <OptionButton
                key={o}
                label={o}
                selected={data.class1Medical === o}
                onClick={() => handleMedical(o)}
              />
            ))}
          </div>
        </div>
        <div>
          <p className="text-sm font-semibold text-[oklch(0.85_0_0)] mb-4">
            Do you have the right to study or work in your chosen training
            country?
          </p>
          <div className="space-y-2">
            {["Yes", "No", "Unsure"].map(o => (
              <OptionButton
                key={o}
                label={o}
                selected={data.rightToWorkStudy === o}
                onClick={() => handleRightToWork(o)}
              />
            ))}
          </div>
        </div>
          ...
          <div className="space-y-2">
            {[
              ...
              <OptionButton
                key={o}
                label={o}
                selected={data.educationLevel === o}
                onClick={() => handleEducation(o)}
              />
            ))}
          </div>
        </div>
...
function Step7({
  ...
  data: QuizData;
  update: (k: keyof QuizData, v: string | boolean) => void;
}) {
  return (
    <StepCard
      title="Almost there"
      subtitle="One final section, then your personalised roadmap is ready."
    >
      <div className="space-y-8">
        <div>
          <p className="text-sm font-semibold text-[oklch(0.85_0_0)] mb-4">
          ...
          <div className="space-y-2">
            {[
              ...
              "Someday — no fixed timeline",
              "I'm not sure yet",
            ].map(o => (
              <OptionButton
                key={o}
                label={o}
                selected={data.startTimeframe === o}
                onClick={() => update("startTimeframe", o)}
              />
            ))}
          </div>
        </div>
        ...
        <div>
          <p className="text-sm font-semibold text-[oklch(0.85_0_0)] mb-4">
            Would you like suitable flight schools to contact you?
          </p>
          <div className="space-y-2">
            {["Yes", "No"].map(o => (
              <OptionButton
                key={o}
                label={o}
                selected={data.wantsSchoolContact === o}
                onClick={() => update("wantsSchoolContact", o)}
              />
            ))}
          </div>
        </div>
            ...
            <div className="space-y-2">
              {["Email", "Phone", "WhatsApp", "Any"].map(o => (
                <OptionButton
                  key={o}
                  label={o}
                  selected={data.preferredContact === o}
                  onClick={() => update("preferredContact", o)}
                />
              ))}
            </div>
          </div>
        ...
        <div className="p-5 rounded-xl bg-[oklch(0.55_0.18_240/0.08)] border border-[oklch(0.55_0.18_240/0.2)]">
          ...
          <p className="text-sm text-[oklch(0.6_0_0)] mb-3">
            Why do you want to become a pilot, and what is the one thing that's
            really holding you back? Your answer helps us give you better
            guidance.
          </p>
          <textarea
        ...
        <div className="p-5 rounded-xl bg-[oklch(1_0_0/0.04)] border border-[oklch(1_0_0/0.08)]">
          <p className="text-sm font-semibold text-white mb-1">
            Who are you happy to be contacted by?
          </p>
          <p className="text-xs text-[oklch(0.5_0_0)] mb-4">
          ...
          <div className="space-y-3">
            {[
              {
                key: "contactConsentSchools" as const,
                label: "Flight schools",
              },
              {
                key: "contactConsentFinance" as const,
                label: "Pilot training finance providers",
              },
              {
                key: "contactConsentMedical" as const,
                label: "Aviation medical examiners",
              },
              {
                key: "contactConsentPartners" as const,
                label: "Training partners (ground schools, simulators)",
              },
            ].map(({ key, label }) => (
              <label
                key={key}
                ...
                <div
                  className={`w-5 h-5 rounded border-2 flex-shrink-0 flex items-center justify-center transition-all ${
                    data[key]
                      ...
                      : "border-[oklch(1_0_0/0.25)] group-hover:border-[oklch(0.55_0.18_240/0.6)]"
                  }`}
        ...
        <div className="p-5 rounded-xl bg-[oklch(1_0_0/0.04)] border border-[oklch(1_0_0/0.08)]">
          <p className="text-sm font-semibold text-white mb-1">
            Phone number{" "}
            <span className="font-normal text-[oklch(0.5_0_0)]">
              (optional)
            </span>
          </p>
          <p className="text-xs text-[oklch(0.5_0_0)] mb-3">
            Only used if a school or our team needs to reach you directly. Never
        ...
        <div className="space-y-4 p-5 rounded-xl bg-[oklch(1_0_0/0.04)] border border-[oklch(1_0_0/0.08)]">
          ...
          <p className="text-xs text-[oklch(0.45_0_0)] leading-relaxed">
            Your data is stored securely and never sold. You can request
...
export default function Quiz() {
  ...
  const canAdvance = () => {
    if (step === 1)
      return data.fullName.trim().length >= 2 && data.email.includes("@");
    return true;
  };
        ...
        <main className="flex-1 flex items-center justify-center py-16 px-4 relative overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse, oklch(0.55 0.18 240), transparent 70%)",
              }}
            />
          </div>
          ...
          <div className="max-w-xl w-full text-center relative z-10">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, oklch(0.55 0.18 240), oklch(0.45 0.18 260))",
                boxShadow: "0 0 40px oklch(0.55 0.18 240 / 0.4)",
              }}
            >
            ...
            <h1 className="text-4xl md:text-5xl font-display font-bold text-white mb-5 leading-tight">
              ...
              <span
                style={{
                  background:
                    "linear-gradient(135deg, oklch(0.7 0.18 240), oklch(0.8 0.15 200))",
            ...
            <p className="text-lg text-[oklch(0.65_0_0)] mb-4 leading-relaxed max-w-md mx-auto">
              5 minutes. We'll identify your biggest barrier, your strongest
              asset, and give you a personalised training roadmap — not generic
              advice.
            </p>
            <p className="text-sm text-[oklch(0.5_0_0)] mb-10 leading-relaxed">
              Most people who take this assessment say the result describes them
              better than they expected. That's the point.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 mb-10">
              {[
                ...
                <div
                  key={item.label}
                  className="p-4 rounded-xl border border-[oklch(1_0_0/0.08)] bg-[oklch(1_0_0/0.04)] text-center"
                >
                  <div className="flex justify-center mb-2 text-[oklch(0.55_0.18_240)]">
                    {item.icon}
                  </div>
            ...
            <div className="flex items-center justify-center gap-2 mt-5 text-xs text-[oklch(0.45_0_0)]">
              ...
              No registration required. Your data is handled in accordance with
              our Privacy Policy.
            </div>
          </div>
        </main>
            ...
            {step < TOTAL_STEPS ? (
              <button
                ...
                style={{
                  background:
                    "linear-gradient(135deg, oklch(0.55 0.18 240), oklch(0.45 0.2 260))",
                  boxShadow: "0 4px 20px oklch(0.55 0.18 240 / 0.3)",
                }}
              >
                Continue
