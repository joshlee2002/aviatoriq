...
const tiers = [
  {
    ...
    period: "for 3 months",
    description:
      "Join our founding cohort. Get full Featured access at no cost while we build our audience together.",
    highlight: true,
...
export default function ForSchools() {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      await mutation.mutateAsync({
        ...data,
        notes: selectedTier
          ? `Tier: ${selectedTier}. ${data.notes ?? ""}`.trim()
          : data.notes,
      });
      setSubmitted(true);
  ...
  const blueGradient =
    "linear-gradient(135deg, oklch(0.45 0.18 240), oklch(0.55 0.18 200))";
    ...
    <div style={{ background: bg, minHeight: "100vh", color: "white" }}>
      ...
      <section className="pt-20 pb-16 relative overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 60% at 50% 0%, oklch(0.45 0.18 240 / 0.12) 0%, transparent 70%)",
          }}
        />
        <div className="container relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              We're onboarding our first 10 founding flight school partners —
              free for 3 months, no contract. Every candidate has completed a
              detailed Career Assessment scored on readiness, finance, medical,
              and career clarity. You only hear from pilots who match your
              school and have explicitly asked to be contacted.
            </p>
        ...
        <div className="container">
          <div className="max-w-2xl mx-auto text-center mb-14">
            ...
            <p className="text-base" style={{ color: "oklch(0.6 0.04 240)" }}>
              ...
              pre-qualified before they ever see your school.
            </p>
          </div>
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: tier.highlight
                    ? "0 0 40px oklch(0.45 0.18 240 / 0.15)"
                    : "none",
                }}
              >
                {tier.badge && (
                  ...
                  style={
                    tier.highlight
                      ? {
                          ...
                          color: "white",
                          boxShadow: "0 0 20px oklch(0.45 0.18 240 / 0.3)",
                        }
                      : {
          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p
                ...
                style={{ color: "oklch(0.6 0.04 240)" }}
              >
                When a candidate requests an introduction to your school, you
                receive their full profile. No guesswork — you know their goal,
                budget, timeline, and biggest barrier before you pick up the
                phone.
              </p>
              ...
              >
                ...
                >
                  <div
                    ...
                    style={{ width: "84%", background: brandGradient }}
                  />
                </div>
              </div>
            </div>
                ...
                >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <Label
                      ...
                      className="text-sm text-white/70 cursor-pointer"
                    >
                      I'm interested in receiving introduction requests from
                      matched candidates
                    </Label>
                  </div>
                  <Button
      ...
      <section className="py-16" style={{ borderTop: `1px solid ${border}` }}>
        <div className="container">
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, oklch(0.14 0.09 250), oklch(0.16 0.07 240))",
