...
import { ArrowRight, Clock, Zap, Brain, Compass, Target } from "lucide-react";
...
// Each quiz gets a subtle accent colour — refined, not garish
const QUIZ_ACCENTS: Record<string, { accent: string; bg: string; border: string }> = {
  ...
  "pilot-thinking":        { accent: "oklch(0.65 0.18 200)", bg: "oklch(0.6 0.18 200 / 0.10)",  border: "oklch(0.6 0.18 200 / 0.20)"  },
  "guess-the-aircraft":    { accent: "oklch(0.70 0.15 180)", bg: "oklch(0.6 0.15 180 / 0.10)",  border: "oklch(0.6 0.15 180 / 0.20)"  },
  "training-readiness":    { accent: "oklch(0.65 0.18 145)", bg: "oklch(0.55 0.18 145 / 0.10)", border: "oklch(0.55 0.18 145 / 0.20)" },
  "pilot-medical":         { accent: "oklch(0.70 0.15 340)", bg: "oklch(0.6 0.15 340 / 0.10)",  border: "oklch(0.6 0.15 340 / 0.20)"  },
...
export default function QuizHub() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "oklch(0.10 0.08 252)" }}>
      ...
      {/* ── Quiz Grid ────────────────────────────────────────────────────── */}
      <section className="py-14 md:py-18 px-4" style={{ background: "oklch(0.11 0.08 252)" }}>
