...
const QUIZ_ACCENTS: Record<
  string,
  { accent: string; bg: string; border: string }
> = {
  "what-kind-of-pilot": {
    accent: "oklch(0.65 0.18 240)",
    bg: "oklch(0.45 0.18 240 / 0.10)",
    border: "oklch(0.45 0.18 240 / 0.20)",
  },
  "aviation-myth-buster": {
    accent: "oklch(0.72 0.18 65)",
    bg: "oklch(0.72 0.18 65 / 0.10)",
    border: "oklch(0.72 0.18 65 / 0.20)",
  },
  "think-like-a-pilot": {
    accent: "oklch(0.65 0.18 200)",
    bg: "oklch(0.6 0.18 200 / 0.10)",
    border: "oklch(0.6 0.18 200 / 0.20)",
  },
  "guess-the-aircraft": {
    accent: "oklch(0.70 0.15 180)",
    bg: "oklch(0.6 0.15 180 / 0.10)",
    border: "oklch(0.6 0.15 180 / 0.20)",
  },
  "flight-training-readiness": {
    accent: "oklch(0.65 0.18 145)",
    bg: "oklch(0.55 0.18 145 / 0.10)",
    border: "oklch(0.55 0.18 145 / 0.20)",
  },
  "pilot-medical-check": {
    accent: "oklch(0.70 0.15 340)",
    bg: "oklch(0.6 0.15 340 / 0.10)",
    border: "oklch(0.6 0.15 340 / 0.20)",
  },
  "biggest-obstacle": {
    accent: "oklch(0.70 0.18 280)",
    bg: "oklch(0.55 0.18 280 / 0.10)",
    border: "oklch(0.55 0.18 280 / 0.20)",
  },
};
...
> = {
  "Most Shared": {
    bg: "oklch(0.60 0.18 20 / 0.12)",
    text: "oklch(0.80 0.15 20)",
    border: "oklch(0.60 0.18 20 / 0.25)",
  },
  "Most Fun": {
  ...
  "Most Challenging": {
    bg: "oklch(0.60 0.15 200 / 0.12)",
    text: "oklch(0.75 0.15 200)",
    border: "oklch(0.60 0.15 200 / 0.25)",
  },
  "Anxiety Buster": {
    bg: "oklch(0.60 0.15 180 / 0.12)",
    text: "oklch(0.75 0.15 180)",
    border: "oklch(0.60 0.15 180 / 0.25)",
  },
  "Top Funnel": {
    bg: "oklch(0.45 0.18 240 / 0.12)",
    text: "oklch(0.65 0.18 240)",
...
function QuizCard({ quiz, index }: { quiz: Quiz; index: number }) {
  const accent = QUIZ_ACCENTS[quiz.slug] ?? {
    accent: "oklch(0.65 0.18 240)",
    bg: "oklch(0.45 0.18 240 / 0.10)",
    border: "oklch(0.45 0.18 240 / 0.20)",
  };
    ...
    >
      <div className="container max-w-5xl">
        ...
        <Link
          ...
          style={{
            background:
              "linear-gradient(135deg, oklch(0.16 0.12 255), oklch(0.20 0.14 248))",
            border: "1px solid oklch(0.45 0.18 240 / 0.25)",
          }}
          onMouseEnter={e => {
            (e.currentTarget as HTMLElement).style.border =
              "1px solid oklch(0.45 0.18 240 / 0.45)";
          ...
          onMouseLeave={e => {
            (e.currentTarget as HTMLElement).style.border =
              "1px solid oklch(0.45 0.18 240 / 0.25)";
            (e.currentTarget as HTMLElement).style.transform = "translateY(0)";
            (e.currentTarget as HTMLElement).style.boxShadow = "none";
          }}
        >
          ...
          <div className="relative z-10 p-8 md:p-10 grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6 items-center">
            <div>
              ...
              <p
                ...
                style={{ color: muted }}
              >
                7 questions. Discover your Flight Potential Score, your biggest
                barrier (finance, time, confidence, or medical), and your
                strongest asset. The most honest 2-minute quiz you'll take
                today.
              </p>
              <div
              ...
              >
                ...
                <span className="flex items-center gap-1.5">
                  <Zap className="w-3.5 h-3.5" /> 7 questions
                </span>
                <span className="flex items-center gap-1.5">
                  <Star
  ...
  const features = [
    {
      ...
      label: "Personality & knowledge",
      color: "oklch(0.65 0.18 240)",
    },
    {
      icon: <Compass className="w-5 h-5" />,
      label: "Serious & fun formats",
      color: "oklch(0.72 0.18 65)",
    },
    {
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: "600px",
            background:
              "radial-gradient(circle, oklch(0.45 0.18 240 / 0.10) 0%, transparent 65%)",
      ...
      >
        <div className="container max-w-5xl">
          ...
          <div
            ...
            style={{
              background: "oklch(0.45 0.18 240 / 0.05)",
              border: "1px solid oklch(0.45 0.18 240 / 0.12)",
            }}
          >
            <p className="text-sm" style={{ color: muted }}>
              <span className="font-semibold text-white">
                New quizzes added regularly.
              </span>{" "}
              All quizzes are free, require no registration, and your results
              are never stored without your consent.
            </p>
          </div>
        </div>
      </section>
          ...
          >
            <div
              ...
              style={{
                ...
                height: "400px",
                background:
                  "radial-gradient(circle, oklch(0.45 0.18 240 / 0.08) 0%, transparent 65%)",
                transform: "translate(30%, -30%)",
              }}
            />
