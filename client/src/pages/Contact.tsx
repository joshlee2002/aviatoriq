          ...
          <div className="container max-w-3xl">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-8">
              <div className="card-base p-6">
                ...
                <h3 className="font-display font-bold text-[var(--color-navy)] mb-2">
                  Take the assessment
                </h3>
                <p className="text-sm text-[var(--color-muted-foreground)] mb-4">
                  The fastest way to get personalised guidance is to take the
                  free career assessment. You will receive a tailored roadmap
                  and matched schools within minutes.
                </p>
            ...
            <div className="card-base p-6 md:p-8">
              <h2 className="text-xl font-display font-bold text-[var(--color-navy)] mb-4">
              ...
              <div className="space-y-5">
                {[
                  ...
                  {
                    q: "Will I be contacted by flight schools?",
                    a: "Only if you consent during the assessment. You control whether your details are shared with schools.",
                  },
                  {
                    q: "Is the AI roadmap accurate?",
                    a: "The roadmap is generated based on your assessment responses and current training data. It is a guide, not a guarantee. Always verify costs and timelines with your chosen school.",
                  },
                ].map(item => (
                  <div
                    key={item.q}
                  ...
                  >
                    <h4 className="font-semibold text-[var(--color-navy)] mb-2">
                      {item.q}
                    </h4>
