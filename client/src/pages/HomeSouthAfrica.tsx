...
const SA_GUIDES = [
  {
    title: "Pilot Training Costs in South Africa 2026: Full Breakdown",
    href: "/south-africa/guides/pilot-training-costs",
    desc: "SACAA CPL and ATPL training costs in ZAR — real 2026 figures from South African flight schools.",
    tag: "Essential",
  },
  {
    title: "SACAA CPL Requirements 2026: Complete Guide",
    href: "/south-africa/guides/sacpl-requirements",
    desc: "Everything you need to know about getting your South African CPL — hours, exams, and costs.",
    tag: "Licence",
  },
  {
    title: "SACAA Class 1 Medical Certificate 2026",
    href: "/south-africa/guides/sacaa-class-1-medical-certificate",
    desc: "SACAA medical requirements, approved AMEs, and how to prepare for your Class 1 in South Africa.",
    tag: "Medical",
  },
  {
    title: "South African Airline Cadet Programmes 2026",
    href: "/south-africa/guides/south-africa-cadet-programs",
    desc: "SAA, FlySafair, Airlink, and regional airline cadet pathways — eligibility and how to apply.",
    tag: "Cadets",
  },
  {
    title: "South African Pilot Salary 2026",
    href: "/south-africa/guides/pilot-salary-2026",
    desc: "How much do pilots earn in South Africa? First Officer to Captain salary breakdown in ZAR.",
    tag: "Salary",
  },
  {
    title: "South Africa Pilot Shortage 2026",
    href: "/south-africa/guides/south-africa-pilot-shortage",
    desc: "The growing pilot shortage in South Africa — opportunities, timelines, and how to position yourself.",
    tag: "Career",
  },
];
...
const SA_TOOLS = [
  {
    ...
    href: "/quiz",
    desc: "Get your personalised SACAA training roadmap",
  },
  {
    icon: "🧮",
    label: "Cost Calculator",
    href: "/calculator",
    desc: "Estimate your total CPL/ATPL training cost in ZAR",
  },
  {
    icon: "🩺",
    label: "Medical Check",
    href: "/tools/class-1-medical-check",
    desc: "Assess your SACAA Class 1 medical eligibility",
  },
  {
    icon: "✈️",
    label: "Cadet Eligibility Checker",
    href: "/cadet-eligibility",
    desc: "SAA, FlySafair, Airlink cadet programmes",
  },
];
    ...
    <>
      ...
      >
        <div className="container py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            >
              South Africa has a growing aviation industry with a significant
              pilot shortage. Get accurate SACAA training routes, real 2026
              costs in ZAR, and your personalised roadmap to the flight deck.
            </p>
            ...
            {[
              {
                ...
                desc: "South Africa's climate offers near-year-round VFR flying conditions, meaning faster hour-building and less weather-related training delays.",
              },
              {
                icon: "💰",
                title: "Affordable training costs",
                desc: "Training costs in ZAR are significantly lower than equivalent programmes in Europe or Australia, making SA an attractive option for international students.",
              },
              {
                icon: "📈",
                title: "Growing pilot shortage",
                desc: "South Africa faces a significant pilot shortage, with airlines actively recruiting. Qualified pilots have strong career prospects across Africa and beyond.",
              },
              {
                icon: "🌍",
                title: "Gateway to African aviation",
                desc: "South African licences and experience are highly valued across the African continent, opening doors to regional and international airline careers.",
              },
            ].map(item => (
              <div
                key={item.title}
      ...
      <section className="py-16" style={{ background: "oklch(0.12 0.06 240)" }}>
        <div className="container">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-2 text-center">
            South African Pilot Training Tools
          </h2>
          <p
            className="text-center mb-10 text-sm"
            style={{ color: "oklch(0.55 0.04 240)" }}
          >
            Free tools built for SACAA candidates
          </p>
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">
                South African Pilot Training Guides
              </h2>
              <p className="text-sm" style={{ color: "oklch(0.55 0.04 240)" }}>
                Researched, accurate, and specific to SACAA regulations
              </p>
            </div>
            <Link
              href="/guides"
      ...
      <section className="py-16" style={{ background: "oklch(0.11 0.07 245)" }}>
        <div className="container text-center">
          ...
          >
            Browse SACAA-approved flight schools across South Africa. Compare
      ...
      >
        <div className="container text-center max-w-2xl">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to start your South African pilot journey?
          </h2>
          <p className="text-lg mb-8" style={{ color: "oklch(0.65 0.04 240)" }}>
            Get your personalised SACAA training roadmap in under 5 minutes.
