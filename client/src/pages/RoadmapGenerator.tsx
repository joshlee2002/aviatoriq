    ...
    roadmapQuestions.forEach(q => {
      ...
      if (option?.points) {
        Object.entries(option.points).forEach(([path, pts]) => {
          scores[path as PathId] += pts as number;
        });
      }
    });
                ...
                <div className="container max-w-4xl text-center relative py-20 px-4">
                  ...
                  >
                    ...
                    <p className="text-xl text-white/60 mb-12 max-w-2xl mx-auto leading-relaxed">
                      The internet is full of generic advice. Answer 5 honest
                      questions about your age, budget, and timeline — and we'll
                      generate a highly specific, data-driven training roadmap
              ...
              <div className="w-full max-w-2xl">
                ...
                <div className="mb-10">
                  <div className="flex justify-between items-center mb-3">
                    ...
                    >
                      {Math.round(
                        ((currentStep + 1) / roadmapQuestions.length) * 100
                      )}
                      %
                    </span>
                  </div>
                  ...
                  >
                    <motion.div
                      ...
                      initial={{
                        width: `${(currentStep / roadmapQuestions.length) * 100}%`,
                      }}
                      animate={{
                        width: `${((currentStep + 1) / roadmapQuestions.length) * 100}%`,
                      }}
                ...
                <div className="space-y-3">
                  {roadmapQuestions[currentStep].options.map((option, idx) => (
                    <motion.button
                      ...
                      onClick={() =>
                        handleAnswer(
                          roadmapQuestions[currentStep].id,
                          option.value
                        )
                      }
          ...
          {result && !isCalculating && grad && (
            ...
            >
              ...
              <div
                ...
                style={{
                  background: `linear-gradient(160deg, oklch(0.10 0.10 255) 0%, oklch(0.13 0.10 252) 100%)`,
                }}
              >
                {/* Glow orb */}
                <div
                    ...
                    {[
                      {
                        ...
                        value: roadmapResults[result].cost,
                      },
                      {
                        icon: <Clock className="w-5 h-5" />,
                        label: "Timeline",
                        value: roadmapResults[result].timeline,
                      },
                      {
                        icon: <Shield className="w-5 h-5" />,
                        label: "Financial Risk",
                        value: roadmapResults[result].risk,
                      },
                    ].map((stat, i) => (
                      <div
                        key={i}
                ...
                <div className="container max-w-3xl px-4 py-16 space-y-12">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {roadmapResults[result].watchOut}
                      </p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        goes much deeper — it analyses your exact barriers,
                        scores you across 5 dimensions, matches you with
                        specific schools, and generates an AI-powered PDF
                        roadmap you can keep and share.
                      </p>
                      <p
