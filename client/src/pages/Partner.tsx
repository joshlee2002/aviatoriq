...
const tiers = [
  {
    ...
    period: "/month",
    description:
      "Get discovered by aspiring pilots searching for UK flight schools.",
    highlight: false,
    badge: null,
    features: [
  ...
  },
  {
    ...
    period: "/month",
    description:
      "Stand out in the directory and receive introduction requests from matched candidates.",
    highlight: true,
    badge: "Most Popular",
    features: [
      "Everything in Basic",
  ...
  },
  {
    ...
    period: "/month",
    description:
      "Maximum visibility and instant notification on every Flight Ready lead that matches your school.",
    highlight: false,
...
const classifications = [
  ...
  },
  {
    ...
    description:
      "Good candidate. Needs finance planning, medical booking, or further research. Likely to convert within 6–18 months.",
    score: "45–74",
  },
  {
...
const benefits = [
  ...
  },
  {
    ...
    body: "Your school appears in the AviatorPath flight school directory, matched to candidates based on country, training type, and finance availability.",
  },
];
...
export default function Partner() {
  useEffect(() => {
    document.title = "Partner With AviatorPath – Flight School Directory";
  }, []);
  ...
  return (
    ...
    >
      <SEO
        title="Partner With AviatorPath | Flight School Lead Generation"
        description="Join the AviatorPath partner programme. Receive pre-qualified, scored aspiring pilots who have actively requested an introduction to your flight school. Three tiers from £149/month."
        canonical="/partner"
      />
      <PublicNav />
      ...
      <section className="bg-[var(--color-navy)] text-white py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <h1 className="font-display text-4xl md:text-5xl font-bold mb-6 leading-tight">
            Partner With AviatorPath
          </h1>
          <p className="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto mb-8">
            Receive pre-qualified, scored aspiring pilots who have actively
            requested an introduction to your school — not cold enquiries.
          </p>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/60 text-center max-w-2xl mx-auto mb-10">
            AviatorPath is a pilot career assessment platform. Aspiring pilots
            complete a 15-question assessment covering their goal, budget,
            timeline, medical status, and funding method. The platform scores
            them across five dimensions, generates a personalised training
            roadmap, and — crucially — lets them request introductions to
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-white/60 mb-6">
                When a Flight Ready candidate requests an introduction to your
                school, you receive a structured profile with everything you
                need to have a meaningful first conversation — no cold calling,
                no guessing.
              </p>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/60 text-center mb-10 max-w-xl mx-auto">
            ...
            between aspiring pilots and the schools that want to reach them.
          </p>
      ...
      <section id="apply" className="py-20 px-4 bg-[var(--color-navy)]">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="font-display text-3xl font-bold text-white mb-3">
              Apply to join the partner programme
            </h2>
          ...
          {submitted ? (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                >
                  Back to AviatorPath <ArrowRight className="w-4 h-4" />
                </Link>
                <a
                  href="mailto:hello@aviatorpath.co.uk"
