...
export default function GuidesIndexSouthAfrica() {
  useEffect(() => { document.title = "South Africa Pilot Training Guides 2026 – AviatorPath"; }, []);
        ...
        <div className="py-6 md:py-8 px-4" style={{ background: "oklch(0.11 0.08 252)" }}>
          <div className="container max-w-4xl">
            ...
            <div className="p-4 rounded-xl mb-4 flex items-start gap-3" style={{ background: "oklch(0.45 0.18 240 / 0.08)", border: "1px solid oklch(0.45 0.18 240 / 0.2)" }}>
              ...
              <p className="text-sm" style={{ color: "oklch(0.65 0.04 240)" }}><strong className="text-white/70">More South Africa guides coming.</strong> We are actively expanding our South Africa content. Check back soon, or take the free assessment to get a personalised roadmap now.</p>
            </div>
