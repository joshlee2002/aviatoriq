  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: bg }}>
      ...
      <main className="flex-1">
        ...
        >
          <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: "url('/manus-storage/pilot-portrait_0cdc56c7.jpg')", backgroundSize: "cover", backgroundPosition: "center 30%", opacity: 0.09 }} />
