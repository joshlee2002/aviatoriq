...
const STORIES: Story[] = [
  {
    ...
    avatar: "SL",
    intro:
      "Sarah was 34 when she started her PPL. She'd been a secondary school teacher for 11 years and had always wanted to fly but convinced herself it was too late. She's now a First Officer at Loganair, flying ATR 72s into Scottish island airports.",
    q1: {
    ...
    relatedGuide: {
      title: "Modular ATPL Training: The Complete Guide",
  ...
  },
  {
    ...
    avatar: "TR",
    intro:
      "Tom applied to the Skyborne/easyJet partnership programme straight after his A-levels. He's now a First Officer at easyJet at 24 — one of the youngest in his base.",
    q1: {
  ...
  },
  {
    ...
    avatar: "JM",
    intro:
      "James applied to the BA Speedbird Academy after three years working in finance. He was 26 when he started training and is now a First Officer at British Airways on the Airbus A320.",
    q1: {
  ...
  },
  {
    ...
    avatar: "MH",
    intro:
      "Mark trained modularly while working as an IT consultant. He's now a First Officer at Ryanair on the Boeing 737, having trained for under £60,000 — roughly half the cost of an integrated programme.",
    q1: {
    ...
    advice:
      "If you're considering modular, do the Class 1 Medical first, then the ATPL theory. Those are the two things that will tell you whether this is viable for you before you spend significant money on flying. The theory is hard but it's passable — I failed two subjects on my first attempt and passed everything on the resit. Don't let early setbacks derail you.",
    relatedGuide: {
      title: "Ryanair Cadet Pilot Programme: Complete Guide",
    ...
    <div className="min-h-screen flex flex-col" style={{ background: bg }}>
      <SEO
        ...
        schema={{
          ...
          description:
            "Honest accounts from working UK pilots about their training journey",
      ...
      <main className="flex-1">
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "url('/manus-storage/pilot-portrait_0cdc56c7.jpg')",
          ...
          <div className="container max-w-4xl relative">
            ...
            >
              Training journeys from working UK pilots — what route they took,
              what it cost, how long it took, and what they wish they'd known.
            </p>
            <div
              className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-4 rounded-xl text-xs"
              style={{
            ...
            >
              ...
              <span style={{ color: "oklch(0.75 0.04 240)" }}>
                <strong style={{ color: "oklch(0.85 0.15 65)" }}>
                  About these stories:
                </strong>{" "}
                These are composite case studies based on real training routes,
                costs, and timelines sourced from UK flight schools and CAA
                data. Names are illustrative. Have a real story to share?
              </span>
              <a
                href="mailto:hello@aviatoriq.co.uk?subject=Share my pilot story"
                className="flex-shrink-0 inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg font-semibold no-underline transition-all"
                style={{
          ...
          <div className="container max-w-4xl">
              ...
              {STORIES.map(story => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-display font-bold text-white/90 group-hover:text-white transition-colors text-sm">
                      {story.name}
                    </div>
            ...
            <div className="space-y-16">
              {STORIES.map(story => (
                <article key={story.id} id={story.id} className="scroll-mt-20">
                  {/* Story header */}
                  <div
                    className="p-4 md:p-6 rounded-2xl mb-6"
                    style={{
                      background: surface,
                    ...
                    <div className="flex items-start gap-5">
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(135deg, oklch(0.45 0.18 240), oklch(0.6 0.18 200))",
                          boxShadow: "0 0 30px oklch(0.45 0.18 240 / 0.25)",
                        }}
                      >
                        {story.avatar}
                      </div>
                  ...
                  <div className="space-y-5">
                    {[story.q1, story.q2, story.q3, story.q4].map((qa, i) => (
                      ...
                      >
                        <p className="font-display font-semibold text-white mb-3 text-sm">
                          {qa.q}
                        </p>
                      ...
                      >
                        ...
                        >
                          ...
                          <span className="font-semibold text-white/80">
                            {story.relatedGuide.title}
                          </span>
                        </span>
                        <Link
                          href={story.relatedGuide.href}
            ...
            >
              ...
              <p className="text-sm mb-6" style={{ color: muted }}>
                ...
                score, matched flight schools, and a clear next step.
              </p>
              <Link
                href="/quiz"
