  ...
  return (
    <GuideLayout
      ...
      sections={[
        ...
        {
          heading: "Current FAA Regulations: The Age 65 Mandate (14 CFR Part 121)",
          content: (
            <>
              <p>The core of the current regulation is enshrined in 14 CFR § 121.383, which explicitly states that a certificate holder (the airline) is prohibited from using a pilot, and a pilot is prohibited from serving, in Part 121 operations after reaching their 65th birthday. This rule is not merely an FAA policy; it is codified in federal law under 49 U.S.C. § 44729, making any change a legislative rather than a purely administrative undertaking.</p>
              <p>It is crucial to differentiate this specific regulation from other forms of commercial flying. The age 65 limit applies exclusively to pilots engaged in scheduled airline service under Part 121. For other aviation sectors, such as corporate aviation, charter operations (Part 135), flight instruction, or ferry flights, there is generally no specific FAA age cap. Pilots in these roles are primarily governed by their medical certification requirements and individual company policies. This distinction means that a pilot reaching age 65 is not necessarily forced to cease all flying activities but rather to transition out of Part 121 airline operations.</p>
              <p>The FAA's rationale for maintaining the age 65 limit for Part 121 operations is multifaceted, balancing safety, international standards, and workforce considerations. While modern medical science and rigorous FAA medical examinations ensure pilots maintain high fitness levels, concerns persist regarding the cumulative effects of aging on cognitive function, reaction time, and overall performance in high-stress environments. Furthermore, adherence to ICAO standards ensures interoperability and safety across international borders, preventing complex scheduling issues that would arise if US domestic rules diverged significantly from global norms.</p>
            </>
          )
        },
        {
          ...
          content: (
            <>
              ...
              <ul>
                <li><strong>Safety Risks:</strong> Doubts remain about the sufficiency of current medical data to definitively support extending the age limit without compromising safety, especially concerning cognitive decline and reaction times.</li>
                <li><strong>International Compatibility:</strong> Even if the US raises its domestic age limit, ICAO rules still cap international flying at 65. This would create a complex operational environment where pilots aged 65-67 would be restricted to domestic routes, leading to scheduling inefficiencies and reduced flexibility for airlines.</li>
                <li><strong>Seniority and Career Progression:</strong> Unions express concerns that extending the retirement age could disrupt the seniority-based career progression system, potentially delaying upgrades for younger pilots and slowing down the overall hiring pipeline.</li>
                <li><strong>Limited Impact on Shortage:</strong> Critics argue that raising the retirement age offers only temporary relief and fails to address the root causes of the pilot shortage, such as high training costs and regional airline pay disparities.</li>
              </ul>
              <p>As of June 2026, these arguments have prevented any legislative change, keeping the age 65 rule firmly in place for Part 121 operations. The debate, however, is likely to resurface during future FAA reauthorization cycles, reflecting the ongoing tension between industry needs and safety considerations.</p>
            </>
          )
        },
        {
      ...
      faqSchema={[
        { question: "What is the mandatory retirement age for commercial airline pilots in the US in 2026?", answer: "As of 2026, the mandatory retirement age for commercial airline pilots operating under 14 CFR Part 121 in the US is 65 years old." },
