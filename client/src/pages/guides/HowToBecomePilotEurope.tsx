      ...
      sections={[
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                Before you begin any commercial flight training in Europe, you must obtain an <strong>EASA Class 1 Medical Certificate</strong>. This is a non-negotiable legal requirement. Do not spend €80,000 on flight training until you know you are medically fit to fly.
              </p>
              <p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>
                <strong>Integrated ATPL:</strong> A highly structured, full-time course taking you from zero experience to a frozen ATPL in 18–24 months. You remain at one flight school for the duration. It is intensive, airline-focused, and preferred by some legacy carriers. Cost: €70,000–€130,000 depending on the country.
              </p>
              <p>
                <strong>Modular ATPL:</strong> You complete your training step-by-step (PPL → ATPL Theory → Hour Building → CPL → MEIR → MCC). You can train part-time, switch schools between modules, and pay as you go. It requires more self-discipline but is significantly cheaper. Cost: €45,000–€75,000.
              </p>
              <p>
        ...
        },
        {
          ...
          content: (
            <>
                ...
                <table className="w-full text-sm text-left">
                  ...
                  <tbody className="divide-y divide-white/10 text-white/80">
                    <tr className="hover:bg-white/5 transition-colors">
                      ...
                      <td className="px-4 py-3">€55,000 – €70,000</td>
              ...
              <p>
                <strong>Western/Northern Europe:</strong> High costs of living and high hourly aircraft rates. Integrated programmes often exceed €100,000.
              </p>
              <p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>
                <strong>Lufthansa Group (European Flight Academy):</strong> Offers training with a conditional job offer for Lufthansa Group airlines. Training costs approx. €120,000, but they offer an Income Share Agreement (ISA) where you pay a small upfront fee and defer the rest until you are employed.
              </p>
              <p>
                <strong>Wizz Air Pilot Academy:</strong> One of the most accessible programmes. You pay an initial fee (approx. €14,000), and Wizz Air pre-finances the remaining training costs. You repay the airline via salary deductions over your first five years of employment.
              </p>
              <p>
