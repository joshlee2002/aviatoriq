          ...
          content: (
            <>
              ...
              <table className="w-full text-sm text-left border-collapse">
                ...
                <tbody>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80"><strong>Citizenship/Residency</strong></td><td className="px-4 py-3 text-white/80">Applicants must hold Canadian citizenship or possess the legal entitlement to live and work permanently in Canada. Permanent residents are additionally required to be eligible for, obtain, and maintain all necessary crew visa documentation for operations into the United States.</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80"><strong>Age</strong></td><td className="px-4 py-3 text-white/80">A minimum age of 18 years must be attained by the anticipated graduation date from the program.</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80"><strong>English Language Proficiency</strong></td><td className="px-4 py-3 text-white/80">Demonstrable strong proficiency in both written and spoken English is mandatory, including achieving an ICAO Language Proficiency Rating of Level 4 or higher.</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80"><strong>Medical Certification</strong></td><td className="px-4 py-3 text-white/80">Possession of a valid Transport Canada Category 1 Medical Certificate is a prerequisite. This certificate must be maintained throughout the duration of the training program.</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80"><strong>Academic Qualification</strong></td><td className="px-4 py-3 text-white/80">Candidates must hold a recognized post-secondary degree, diploma, or an equivalent academic qualification.</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80"><strong>Flight Experience</strong></td><td className="px-4 py-3 text-white/80">The program is specifically designed for individuals with little to no prior flight experience, emphasizing ab initio training.</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80"><strong>Academic Performance (Mentorship Stream)</strong></td><td className="px-4 py-3 text-white/80">For candidates entering via the broader Destination Porter Mentorship program (which the Cadet program integrates with), a minimum cumulative GPA of 3.00 (or equivalent) is typically required.</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80"><strong>Training Integrity (Mentorship Stream)</strong></td><td className="px-4 py-3 text-white/80">Successful completion of any prior flight school programs within the prescribed timeframe, with no failures on Transport Canada Flight Tests that necessitate a full retest (partial retests are generally permissible), and no failed courses during the program of study.</td></tr>
                </tbody>
              </table>
