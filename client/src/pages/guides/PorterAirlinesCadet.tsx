        ...
        },
        {
          ...
          content: (
            <>
              ...
              <ul>
                <li><strong>Foundational Skill Development (Diamond DA20):</strong> Cadets commence their journey on the Diamond DA20, a highly responsive and forgiving aircraft, mastering core flight principles, precise aircraft handling, and fundamental aerodynamic concepts. This phase instills the discipline and precision required for professional aviation.</li>
                <li><strong>Intermediate and Advanced Maneuvers (Diamond DA40 & DA42):</strong> As proficiency grows, cadets transition to the Diamond DA40 for advanced single-engine operations and then to the multi-engine Diamond DA42. This progression allows for the development of complex flying skills, including advanced navigation, instrument flight procedures, and the critical introduction to multi-engine aircraft management, essential for airline operations.</li>
              </ul>
              <h3>State-of-the-Art Simulation and Multi-Crew Coordination:</h3>
              <p>A pivotal component of the program is the integration of nearly 90 hours of advanced simulation training. Cadets utilize cutting-edge ALSIM ALX and AL4x simulators, engaging in scenario-based exercises that mirror real-world airline operational procedures. This immersive training prepares cadets for the dynamic challenges of a commercial flight deck. Complementing this, a comprehensive 45-hour <strong>Multi-Crew Coordination (MCC) program</strong> is delivered by seasoned airline pilots. This module is specifically designed to simulate Transport Canada Subpart 705 (Airline Operations) level two-crew environments, fostering effective communication, decision-making, and teamwork crucial for modern airline cockpits.</p>
              <h3>Specialized Dash 8-400 Type Training:</h3>
              <p>The program culminates with highly specialized Dash 8-400 type training conducted at CAE Toronto. This critical phase is engineered to ensure that graduates achieve absolute proficiency in operating the specific aircraft type that forms the backbone of Porter Airlines' regional fleet. Successful completion of this module facilitates a seamless and efficient transition into line operations as First Officers, fully prepared for their roles.</p>
            </>
          )
        },
        {
          heading: "3. Stringent Eligibility Requirements for Prospective Cadets (2026 Intake)",
          content: (
            <>
              ...
              <table>
                <thead>
                  <tr><th>Requirement</th><th>Details for 2026 Intake</th></tr>
                </thead>
                <tbody>
                  <tr><td><strong>Citizenship/Residency</strong></td><td>Applicants must hold Canadian citizenship or possess the legal entitlement to live and work permanently in Canada. Permanent residents are additionally required to be eligible for, obtain, and maintain all necessary crew visa documentation for operations into the United States.</td></tr>
                  <tr><td><strong>Age</strong></td><td>A minimum age of 18 years must be attained by the anticipated graduation date from the program.</td></tr>
                  <tr><td><strong>English Language Proficiency</strong></td><td>Demonstrable strong proficiency in both written and spoken English is mandatory, including achieving an ICAO Language Proficiency Rating of Level 4 or higher.</td></tr>
                  <tr><td><strong>Medical Certification</strong></td><td>Possession of a valid Transport Canada Category 1 Medical Certificate is a prerequisite. This certificate must be maintained throughout the duration of the training program.</td></tr>
                  <tr><td><strong>Academic Qualification</strong></td><td>Candidates must hold a recognized post-secondary degree, diploma, or an equivalent academic qualification.</td></tr>
                  <tr><td><strong>Flight Experience</strong></td><td>The program is specifically designed for individuals with little to no prior flight experience, emphasizing ab initio training.</td></tr>
                  <tr><td><strong>Academic Performance (Mentorship Stream)</strong></td><td>For candidates entering via the broader Destination Porter Mentorship program (which the Cadet program integrates with), a minimum cumulative GPA of 3.00 (or equivalent) is typically required.</td></tr>
                  <tr><td><strong>Training Integrity (Mentorship Stream)</strong></td><td>Successful completion of any prior flight school programs within the prescribed timeframe, with no failures on Transport Canada Flight Tests that necessitate a full retest (partial retests are generally permissible), and no failed courses during the program of study.</td></tr>
                </tbody>
              </table>
              <p>It is imperative for all applicants to consult the official CAE and Porter Airlines career portals for the most current and definitive eligibility requirements, as minor adjustments may be implemented for subsequent cohorts.</p>
            </>
          )
        },
        {
          heading: "4. Financial Investment and Strategic Funding Options (2026 Projections)",
          content: (
            <>
              <p>Embarking on a pilot training journey represents a substantial, yet profoundly rewarding, financial investment. While the precise, all-inclusive cost for the Destination Porter Cadet Program is typically disclosed directly to applicants upon formal inquiry or acceptance, we can provide highly accurate estimated costs for general pilot training in Canada for 2026. These projections are based on current industry averages and Transport Canada requirements, offering prospective cadets a realistic and comprehensive financial outlook.</p>
              <h3>Detailed Estimated Costs for Key Licenses and Ratings (CAD, 2026):</h3>
              <table>
                <thead>
                  <tr><th>License/Rating</th><th>Estimated Cost Range (CAD)</th><th>Key Inclusions & Notes</th></tr>
                </thead>
                <tbody>
                  <tr><td><strong>Private Pilot Licence (PPL)</strong></td><td>$16,000 - $22,000</td><td>Covers minimum 45 hours flight training (most students require 55-70 hours), aircraft rental, instructor fees, comprehensive ground school, Transport Canada written and flight exams, initial medical certificate (Category 3), and essential study materials/headset.</td></tr>
                  <tr><td><strong>Commercial Pilot Licence (CPL)</strong></td><td>$35,000 - $45,000</td><td>Requires a total of 200 flight hours (including at least 100 hours as pilot-in-command). Costs include additional flight hours for time-building, advanced ground school, Transport Canada written and flight exams, and a Class 1 medical certificate.</td></tr>
                  <tr><td><strong>Multi-Engine Rating</strong></td><td>$4,500 - $7,000</td><td>Typically involves 7-10 hours of dual flight instruction in a multi-engine aircraft, ground instruction, and flight test. Essential for airline careers.</td></tr>
                  <tr><td><strong>Instrument Flight Rules (IFR) Rating</strong></td><td>$9,000 - $14,000</td><td>Comprises approximately 40 hours of instrument time (a portion of which can be conducted in approved simulators), ground instruction, and the IFR flight test. Critical for all-weather operations.</td></tr>
                  <tr><td><strong>Integrated ATPL (Overall Program)</strong></td><td>$90,000 - $130,000+</td><td>This represents the comprehensive cost for an integrated program that typically includes all necessary licenses and ratings (PPL, CPL, Multi-Engine, IFR, ATPL theory). The Destination Porter program falls under this category.</td></tr>
                </tbody>
              </table>
              ...
              <ul>
                <li><strong>Consistent Flight Schedule:</strong> Aim for a minimum of 2-3 flights per week to maintain proficiency and minimize the need for costly re-training due to skill fade.</li>
                <li><strong>Leverage Simulators:</strong> Utilize approved Flight Training Devices (FTDs) for eligible hours, as simulator time is generally more cost-effective than actual flight time.</li>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>Upon the successful and timely completion of the rigorous Integrated ATPL training, including the specialized Dash 8-400 type rating, graduates are seamlessly integrated into Porter Airlines as First Officers on their expanding Dash 8-400 fleet. The program's holistic design ensures that cadets not only achieve exceptional technical proficiency but are also thoroughly prepared for the operational intricacies, safety culture, and corporate ethos of Porter Airlines.</p>
              <p>The typical career progression within this program involves several key milestones:</p>
              <ol>
                <li><strong>Program Completion:</strong> Successful and timely completion of the intensive 20-month Integrated ATPL program at Cygnet Aviation Academy and CAE Toronto.</li>
                <li><strong>Flight Hour Accumulation:</strong> While the cadet program is integrated, candidates for the broader Destination Porter Mentorship program (which the cadet program feeds into) typically aim for a minimum of 500 flight hours. The integrated nature of the cadet program ensures these hours are built efficiently.</li>
                <li><strong>Airline Assessment:</strong> Successful performance in a comprehensive interview and simulator evaluation conducted directly by Porter Airlines.</li>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <ul>
                <li><strong>Guaranteed Career Pathway:</strong> The conditional offer of employment with Porter Airlines provides an unparalleled level of career certainty and stability from the commencement of training.</li>
                <li><strong>Integrated, Airline-Centric Training:</strong> The curriculum is designed from day one with airline operations in mind, ensuring graduates are not just licensed pilots but airline-ready professionals.</li>
                <li><strong>Direct Mentorship:</strong> Cadets benefit from direct guidance and mentorship from experienced Porter Airlines pilots, offering invaluable insights and networking opportunities.</li>
                <li><strong>Modern Aircraft and Simulator Fleet:</strong> Training utilizes state-of-the-art Diamond aircraft and advanced simulators, culminating in specific Dash 8-400 type training.</li>
                <li><strong>Exceptional Instruction:</strong> Instruction is delivered by a cadre of highly experienced faculty, including former airline and military pilots, ensuring top-tier education.</li>
                <li><strong>Expedited Progression:</strong> The integrated nature of the program often allows for a more efficient and faster progression to an airline cockpit compared to traditional modular training routes.</li>
              </ul>
              <p>However, prospective cadets must also carefully weigh several critical considerations:</p>
              <ul>
                <li><strong>Intensive and Demanding Schedule:</strong> The program is full-time, highly rigorous, and requires an unwavering commitment, significant personal sacrifice, and sustained academic and practical dedication.</li>
                <li><strong>Substantial Financial Commitment:</strong> Despite the clear career benefits, the upfront financial investment is considerable. Applicants must have a robust financial plan or access to funding.</li>
