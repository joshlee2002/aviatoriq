...
export default function IntegratedVsModular() {
  return (
    <GuideLayout
      ...
      faqSchema={[
        { question: "What is the difference between integrated and modular ATPL training?", answer: "Integrated training is a single full-time programme (18–24 months, £90,000–£115,000) that takes you from zero to frozen ATPL at one academy. Modular training lets you complete each licence stage separately (2–4 years, £60,000–£80,000), allowing you to keep working between phases." },
        { question: "Is integrated or modular training better for getting an airline job?", answer: "Both routes lead to the same frozen ATPL qualification. Major UK airlines including British Airways, easyJet, Ryanair, and Jet2 accept both integrated and modular graduates. What matters most is your first-time pass rate, simulator performance, and interview preparation." },
        { question: "Can I do modular ATPL training while working full-time?", answer: "Yes. Modular training is specifically designed to allow this. You complete modules in stages — PPL, night rating, ATPL theory, hour building, CPL, MEP, instrument rating, and APS MCC — around your existing commitments. The ATPL theory phase is largely distance-learning." },
        { question: "Which is cheaper, integrated or modular ATPL in the UK?", answer: "Modular is significantly cheaper: approximately £60,000–£80,000 at a UK school vs £90,000–£115,000 for integrated. However, modular takes longer, so you must factor in living costs and the opportunity cost of an extended training timeline." },
        { question: "What is the MPL route?", answer: "The Multi-Pilot Licence (MPL) is a third training route, only available through sponsored airline cadet programmes such as the easyJet Generation Pilot programme. It is highly structured and leads directly to a First Officer role, but the licence is type-specific and restricted to the sponsoring airline until you unfreeze it." },
      ]}
      relatedGuides={[
      ...
      sections={[
        {
          ...
          content: (
            <>
              ...
              <p>
                Aspiring airline pilots in the UK have three routes to a frozen ATPL: integrated, modular, and MPL. The integrated and modular routes lead to the same standard frozen ATPL qualification. MPL routes are airline-specific and may be funded, partly funded or self-funded depending on the programme. Understanding the real differences — not the marketing version — is the most important decision you will make before spending £60,000–£115,000.
              </p>
              <p className="text-sm p-3 rounded-lg my-4 bg-blue-50 border border-blue-100 text-blue-900">
                Not sure where to start? Take our free <Link href="/quiz" className="text-blue-700 font-medium underline">Pilot Career Assessment</Link> to get a personalised training roadmap in under five minutes.
              </p>
                ...
                <table className="w-full text-sm text-left border-collapse border border-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-3 font-semibold text-gray-700 border-b">Integrated ATPL</th>
                      <th className="px-4 py-3 font-semibold text-gray-700 border-b">Modular ATPL</th>
                      <th className="px-4 py-3 font-semibold text-gray-700 border-b">MPL (Sponsored)</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100 bg-white">
                    <tr className="hover:bg-gray-50">
                      <td className="px-4 py-3 font-medium text-gray-900">2026 Cost (UK)</td>
                      <td className="px-4 py-3 text-gray-700">£90,000–£115,000</td>
                      <td className="px-4 py-3 text-gray-700">£60,000–£80,000</td>
                      <td className="px-4 py-3 text-gray-700">£0 to £100k+ (varies)</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="px-4 py-3 font-medium text-gray-900">Timeline</td>
                      <td className="px-4 py-3 text-gray-700">18–24 months</td>
                      <td className="px-4 py-3 text-gray-700">2–4 years</td>
                      <td className="px-4 py-3 text-gray-700">18–24 months</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="px-4 py-3 font-medium text-gray-900">Structure</td>
                      <td className="px-4 py-3 text-gray-700">Full-time, one school</td>
                      <td className="px-4 py-3 text-gray-700">Self-paced, multiple schools</td>
                      <td className="px-4 py-3 text-gray-700">Full-time, airline-directed</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="px-4 py-3 font-medium text-gray-900">Work alongside?</td>
                      <td className="px-4 py-3 text-gray-700">No</td>
                      <td className="px-4 py-3 text-gray-700">Yes (between phases)</td>
                      <td className="px-4 py-3 text-gray-700">No</td>
                    </tr>
                    <tr className="hover:bg-gray-50">
                      <td className="px-4 py-3 font-medium text-gray-900">Airline flexibility</td>
                      <td className="px-4 py-3 text-gray-700">Any airline</td>
                      <td className="px-4 py-3 text-gray-700">Any airline</td>
                      <td className="px-4 py-3 text-gray-700">Sponsoring airline only</td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>
                The genuine advantage of integrated training is not the qualification itself (which is identical to modular) but the structure. You are in a cohort, progressing through defined phases, with an academy managing your schedule. For students who want the fastest possible route to a frozen ATPL and have the capital secured, integrated is the right choice.
              </p>
            </>
          ),
        },
        {
          ...
          content: (
            <>
              ...
              <p>
                The main disadvantage is the timeline. Because you are managing your own schedule, dealing with UK weather delays, and balancing work commitments, modular training rarely takes less than two years and often takes three to four.
              </p>
            </>
          ),
        },
        {
          ...
          content: (
            <>
              <p>
                Historically, there was a perception that major airlines preferred integrated graduates. In 2026, this is largely a myth.
              </p>
              <p>
                Major UK airlines including British Airways, easyJet, Ryanair, Jet2, and Loganair actively recruit both integrated and modular graduates. When you sit in a simulator assessment for an airline interview, the assessors do not care which route you took — they care whether you can fly a raw-data ILS approach, manage a failure, and demonstrate strong Multi-Crew Cooperation (MCC) skills.
              </p>
              <p>
                However, integrated schools do offer dedicated placement teams and strong airline relationships. If you attend a major integrated academy, you may get your CV in front of airline recruiters faster. Modular students must be more proactive in their networking and job hunting.
              </p>
            </>
          ),
        },
