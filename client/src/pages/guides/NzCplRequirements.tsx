...
export default function NzCplRequirements() {
  return (
    <GuideLayout
      ...
      sections={[
        {
          heading: "Introduction to the New Zealand Commercial Pilot Licence (CPL)",
          content: (
            <>
        ...
        },
        {
          ...
          content: (
            <>
              <p>Before commencing CPL training, candidates must meet several fundamental eligibility requirements. These ensure that aspiring pilots possess the necessary foundational attributes for such a demanding profession. The primary criteria revolve around age, medical fitness, and English language proficiency.</p>
              <ul>
                <li><strong>Minimum Age:</strong> Applicants must be at least 18 years of age to be issued a Commercial Pilot Licence. While training can begin earlier, the licence itself will not be granted until this age requirement is met.</li>
                <li><strong>Prior Licence:</strong> A Private Pilot Licence (PPL) is a prerequisite for commencing CPL training. This ensures a foundational level of flight experience and theoretical knowledge.</li>
                <li><strong>English Language Proficiency:</strong> Demonstrating proficiency in the English language is mandatory. This is crucial for clear communication in aviation, both with air traffic control and other pilots. An IELTS score of 5.5 or higher is often required by training organizations, alongside passing a CAANZ Aviation English test.</li>
                <li><strong>Fit and Proper Person Test:</strong> All applicants must pass a 'fit and proper person' test, which assesses their character and suitability for holding an aviation licence.</li>
              </ul>
            </>
          )
        },
        {
          ...
          content: (
            <>
              <p>Aviation demands an exceptionally high standard of physical and mental health. For commercial pilots in New Zealand, a current CAA NZ Class 1 Medical Certificate is indispensable. This is a more stringent examination than the Class 2 required for a PPL and must be maintained throughout a commercial pilot's career.</p>
              <p>The Class 1 medical examination is conducted by a CAA-approved medical examiner and includes comprehensive assessments of vision, hearing, cardiovascular health, neurological function, and psychological well-being. Any pre-existing medical conditions must be declared and will be assessed for their impact on flight safety. Regular renewals are required, typically annually for pilots under 60 years of age, and more frequently thereafter.</p>
              <p>It is highly recommended that aspiring CPL holders obtain their Class 1 Medical Certificate before investing significantly in flight training, as failure to meet these standards would preclude them from commercial operations.</p>
            </>
          )
        },
        {
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>These hours are typically accumulated through a combination of dual instruction with an instructor and solo flight time, often progressing from single-engine aircraft like the Cessna 152 and 172 to potentially more complex types or simulator training.</p>
            </>
          )
        },
        {
          ...
          content: (
            <>
              ...
              <p>Prospective students should always request a detailed breakdown of costs from their chosen flight school and inquire about any potential hidden fees. Some schools may offer integrated programs that can be more cost-effective in the long run.</p>
            </>
          )
        },
        {
          ...
          content: (
            <>
              <p>A New Zealand CPL opens doors to a variety of exciting career opportunities within the aviation sector. While the ultimate goal for many is to fly for major airlines, the initial steps often involve gaining experience in other commercial operations.</p>
              <p>Common entry-level roles for CPL holders include flight instructing, scenic flight operations, agricultural aviation (e.g., crop dusting), air charter services, and aerial photography/surveying. These roles are invaluable for building flight hours, multi-engine experience, and instrument ratings, which are often prerequisites for airline positions.</p>
              <p>Major airlines operating in and from New Zealand, such as Air New Zealand, are the pinnacle for many pilots. While direct entry into these airlines with just a CPL is rare, cadet schemes and pathways exist for pilots who accumulate significant experience and further qualifications (e.g., Airline Transport Pilot Licence - ATPL, multi-engine instrument ratings). Regional airlines and third-level carriers like Barrier Air also provide excellent opportunities for career progression.</p>
              <p>The demand for pilots can fluctuate, but a well-trained and experienced CPL holder from New Zealand's reputable flight schools is generally well-regarded globally. Continuous professional development and adaptability are key to a successful and long-lasting career in aviation.</p>
            </>
          )
        },
        {
          ...
          content: (
            <>
              <p>Obtaining a Commercial Pilot Licence in New Zealand is a challenging yet incredibly rewarding endeavor. It requires a significant investment of time, effort, and financial resources, but the outcome is a highly respected profession with unparalleled views from the office. By meticulously meeting the CAA NZ requirements for age, medical fitness, theoretical knowledge, and practical flight experience, aspiring pilots can confidently navigate their path to a successful career in New Zealand's dynamic aviation industry.</p>
              <p>The journey from a dream to a professional pilot is a testament to perseverance and passion. With the right training, dedication, and adherence to the highest standards, the skies of New Zealand and beyond await.</p>
            </>
          )
        }
      ]}
      faqSchema={[
        {
          ...
          answer: "You must be at least 18 years of age to be issued a Commercial Pilot Licence by the CAA NZ."
        },
        {
          question: "What medical certificate do I need for a New Zealand CPL?",
          answer: "A current CAA NZ Class 1 Medical Certificate is required for all commercial pilot operations. It is more stringent than a Class 2 medical and requires regular renewals."
        },
        {
          question: "How many flight hours are required for a CPL in New Zealand?",
          answer: "A minimum of 200 hours total flight time is generally required, including at least 100 hours of pilot in command (solo) time and 10 hours of instrument flight time."
        },
        {
          question: "What are the main theoretical subjects for the New Zealand CPL?",
          answer: "The main theoretical subjects include Human Factors, Air Law, Meteorology, Principles of Flight, Navigation, General Aircraft Technical Knowledge, and Basic Turbine Knowledge Rating. A 70% pass mark is typically required for each Aspeq exam."
        },
        {
          question: "What is the estimated cost of CPL training in New Zealand for 2026?",
          answer: "The estimated cost for a comprehensive CPL program in New Zealand for 2026 typically ranges from NZD $80,000 to NZD $130,000, depending on the flight school and inclusions."
        },
        {
          question: "Which airlines hire CPL holders in New Zealand?",
          answer: "While direct entry into major airlines like Air New Zealand with just a CPL is uncommon, CPL holders can find opportunities with regional airlines (e.g., Barrier Air), flight instructing, and other commercial operations to build experience for future airline roles."
        }
      ]}
      relatedGuides={[
