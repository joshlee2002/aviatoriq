    ...
    <GuideLayout
      ...
      sections={[
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>The tuition tax credit is calculated as 15% of the total eligible tuition amount, corresponding to the lowest federal tax bracket . For example, if your eligible costs were $10,000, your federal tuition tax credit would be $1,500 ($10,000 x 0.15). This amount directly reduces the income tax you owe.</p>
              <h3>Key Forms: T2202 and TL11B</h3>
              <p>To claim these credits, students will receive a T2202 Certificate from their Canadian educational institution. For flying schools or clubs, a TL11B form is used to certify eligible tuition fees, provided the student is at least 16 years old and taking the course to acquire or improve occupational skills . These forms are essential for accurate tax filing.</p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>Conversely, training for a Private Pilot Licence (PPL), Recreational Pilot Permit, any 'build-up' time (hours accumulated beyond minimum requirements), and flight time exceeding the Transport Canada minimums are typically subject to GST/HST . The CRA defines a vocational school as an organization established and operated primarily to provide instruction in courses that develop or enhance students' occupational skills .</p>
              ...
              <table className="w-full text-sm text-left border-collapse">
                ...
                <tbody>
                  <tr className="border-b border-white/10">
                    ...
                    <td className="px-4 py-3 text-white/80">Provided by a vocational school; meets TC minimums </td>
                  </tr>
                  <tr className="border-b border-white/10">
                  ...
                  <tr className="border-b border-white/10">
                    ...
                    <td className="px-4 py-3 text-white/80">Generally considered recreational </td>
                  </tr>
                  <tr className="border-b border-white/10">
                  ...
                  <tr className="border-b border-white/10">
                    ...
                    <td className="px-4 py-3 text-white/80">Taxable</td>
                    <td className="px-4 py-3 text-white/80">Beyond occupational skill enhancement </td>
                  </tr>
                  <tr className="border-b border-white/10">
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>For employed pilots, certain job-related expenses that are not reimbursed by their employer may be deductible. This can include unreimbursed meal and accommodation expenses incurred while away from home for work . It is crucial to maintain meticulous records and obtain a T2200 form (Declaration of Conditions of Employment) from your employer to claim these deductions.</p>
              ...
              <p>While federal tax laws apply across Canada, provincial tax rates and specific credits can vary significantly. Pilots should be aware of the tax regulations in their province of residence, as these can impact their overall tax liability and available deductions .</p>
        ...
        },
        {
          ...
          content: (
            <>
              <p> Canada.ca - Tax tips 2026: <a href="https://www.canada.ca/en/revenue-agency/news/newsroom/tax-tips/tax-tips-2026.html">https://www.canada.ca/en/revenue-agency/news/newsroom/tax-tips/tax-tips-2026.html</a></p>
              <p> Raymond Chabot Grant Thornton - 2025-2026 Tax Planning Guide: <a href="https://www.rcgt.com/en/tax-planning-guide/">https://www.rcgt.com/en/tax-planning-guide/</a></p>
              <p> Harv's Air - Income Tax Deductions: <a href="https://www.harvsair.com/financial/income-tax-deductions">https://www.harvsair.com/financial/income-tax-deductions</a></p>
              <p> TurboTax Canada - Understanding the Tuition Tax Credit in Canada: <a href="https://turbotax.intuit.ca/tips/understanding-tuition-tax-credits-6549?srsltid=AfmBOoq2NyYgqkSqcMS5ozHm06PGKWmhQeRqwpIs6B1WfftFFd1Y4ZVQ">https://turbotax.intuit.ca/tips/understanding-tuition-tax-credits-6549?srsltid=AfmBOoq2NyYgqkSqcMS5ozHm06PGKWmhQeRqwpIs6B1WfftFFd1Y4ZVQ</a></p>
              <p> Canada.ca - GST/HST Information for the Travel and Convention Industry: <a href="https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/gst-hst-businesses/charge-collect-specific-situations/gst-hst-information-travel-convention-industry.html">https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/gst-hst-businesses/charge-collect-specific-situations/gst-hst-information-travel-convention-industry.html</a></p>
              <p> Tax Interpretations - Application of the GST/HST to Flight Training: <a href="https://taxinterpretations.com/content/669442">https://taxinterpretations.com/content/669442</a></p>
              <p> Canada.ca - TL11B Tuition and Enrolment Certificate - Flying School or Club: <a href="https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/tl11b.html">https://www.canada.ca/en/revenue-agency/services/forms-publications/forms/tl11b.html</a></p>
            </>
          )
        },
      ]}
      faqSchema={[
        { question: "Is all pilot training tax deductible in Canada?", answer: "No, only specific types of flight training, primarily those leading to a Commercial Pilot Licence (CPL), Airline Transport Pilot Licence (ATPL), or certain ratings, are eligible for tuition tax credits under specific conditions. Private Pilot Licence (PPL) training is generally not eligible on its own. " },
        { question: "What is a T2202 form and why is it important for pilot students?", answer: "The T2202, or Tuition and Enrolment Certificate, is an official tax form issued by Canadian educational institutions, including eligible flying schools, that outlines your eligible tuition fees for tax credit purposes. It's crucial for claiming tuition tax credits. " },
        ...
        { question: "Can I claim expenses like textbooks, accommodation, or transportation for pilot training?", answer: "Generally, no. The tuition tax credit primarily covers eligible tuition and applicable fees. Expenses such as transportation, parking, housing, and textbooks are typically excluded. " },
        { question: "What happens if I don't have enough income to use my tuition tax credits?", answer: "You can transfer a portion of your unused tuition tax credits to a spouse, common-law partner, or a parent/grandparent. Any remaining unused credits can be carried forward indefinitely to reduce your taxable income in future years. " },
      ]}
      relatedGuides={[
