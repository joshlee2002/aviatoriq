  ...
  return (
    <GuideLayout
      ...
      faqSchema={[
        ...
        { question: "How much does the Wizz Air Pilot Academy cost?", answer: "Training costs vary by partner school but typically range from EUR65,000 to EUR100,000. Wizz Air does not fund training  -  it is self-sponsored." },
      ...
      sections={[
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                The Wizz Air Pilot Academy is self-funded. Training costs vary depending on the partner school and programme structure, but typically range from approximately EUR65,000 to EUR100,000 for the full integrated ATPL programme including type rating.
              </p>
              <p>
              ...
              <p>
                Wizz Air First Officer salaries start at approximately EUR42,000-EUR55,000 (base), with productivity pay and allowances bringing total compensation higher. The airline's rapid expansion means genuine upgrade opportunities  -  Wizz Air has been promoting First Officers to Captain at a faster rate than many legacy carriers, with some pilots upgrading within 5-8 years of joining.
              </p>
            </>
          ),
        },
