      ...
      faqSchema={[
        {
          ...
          answer: "Yes, if you meet specific criteria. You must already possess a private pilot certificate, hold a valid second-class (or first-class for ATP) medical certificate, and attend an FAA Part 141 or Part 142 school with a VA-approved flight program. The Post-9/11 GI Bill covers up to $15,497.15 per academic year for non-degree flight programs (as of 2025). For degree-seeking students, the GI Bill can cover a higher percentage of costs if flight training is an integral part of the degree program .",
        },
        {
