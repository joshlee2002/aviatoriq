  ...
  return (
    <GuideLayout
      ...
      sections={[
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                Cardiovascular health is rigorously evaluated. Class 2 applicants must have no established medical history or clinical diagnosis of myocardial infarction, angina pectoris, coronary heart disease that has required treatment or is symptomatic/clinically significant, cardiac valve replacement, permanent cardiac pacemaker implantation, or heart replacement .
              </p>
            </>
          )
        },
        {
          ...
          content: (
            <>
              <p>
                Beyond specific system requirements, general medical fitness is assessed. This includes the absence of diabetes mellitus requiring insulin or any other hypoglycemic drug for control. Furthermore, there must be no other organic, functional, or structural disease, defect, or limitation, nor any medication or treatment, that the Federal Air Surgeon determines could make the person unable to safely perform the duties or exercise the privileges of the airman certificate .
              </p>
            </>
          )
        },
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <ol>
                <li>
                  <strong>MedXPress Application:</strong> The first step is to complete an online application through the FAA's MedXPress system. This secure portal allows applicants to enter their medical history and other required information prior to their physical examination. It is crucial to be thorough and accurate in this section, as any discrepancies can lead to delays or further scrutiny .
                </li>
                <li>
                ...
                <li>
                  <strong>The Physical Examination:</strong> The examination itself is similar to a comprehensive physical, but with specific FAA requirements. The AME will review the MedXPress application, discuss the applicant's medical history, and conduct a physical examination including vision, hearing, cardiovascular, and neurological assessments. Depending on the applicant's age and medical history, additional tests (e.g., EKG, blood work) may be required. Honesty and transparency with the AME are paramount .
                </li>
                <li>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>
                The validity period of an FAA Class 2 Medical Certificate depends on the age of the applicant and the type of pilot privileges being exercised. The certificate is valid from the date of examination :
              </p>
              <table className="w-full text-sm text-left border-collapse">
                <thead>
        ...
        },
        {
          ...
          content: (
            <>
              <ul>
                <li>
                   14 CFR Part 67 - Medical Standards and Certification. (2026). <em>eCFR</em>. Available at: <a href="https://www.ecfr.gov/current/title-14/chapter-I/subchapter-D/part-67">https://www.ecfr.gov/current/title-14/chapter-I/subchapter-D/part-67</a>
                </li>
                <li>
                   Guide for Aviation Medical Examiners. (2026). <em>Federal Aviation Administration</em>. Available at: <a href="https://www.faa.gov/ame_guide/media/ame_guide.pdf">https://www.faa.gov/ame_guide/media/ame_guide.pdf</a>
                </li>
              </ul>
            </>
          )
      ...
      faqSchema={[
        ...
        { question: "How long is a Class 2 Medical Certificate valid?", answer: "For operations requiring Class 2 privileges, the certificate is valid for 12 calendar months. For operations requiring Class 3 privileges, it is valid for 60 calendar months if the airman is under 40 years old, or 24 calendar months if 40 years old or over, from the date of examination ." },
        ...
        { question: "Can I fly with corrective lenses?", answer: "Yes, if your vision corrects to the required 20/20 distant and 20/40 near standards, you can fly with corrective lenses. However, you must wear these lenses while exercising the privileges of your airman certificate ." },
