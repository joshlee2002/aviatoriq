  ...
  return (
    <GuideLayout
          ...
          content: (
            <>
              ...
              <table className="w-full text-sm text-left border-collapse">
                ...
                <tbody>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">LAPL (Light Aircraft Pilot Licence)</td><td className="px-4 py-3 text-white/80">30 hrs</td><td className="px-4 py-3 text-white/80">LAPL</td><td className="px-4 py-3 text-white/80">VFR, max 3 pax, EASA states only</td><td className="px-4 py-3 text-white/80">EUR6,000 - EUR10,000</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">PPL (Private Pilot Licence)</td><td className="px-4 py-3 text-white/80">45 hrs</td><td className="px-4 py-3 text-white/80">Class 2</td><td className="px-4 py-3 text-white/80">VFR, no pax limit, ICAO worldwide</td><td className="px-4 py-3 text-white/80">EUR10,000 - EUR18,000</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">CPL (Commercial Pilot Licence)</td><td className="px-4 py-3 text-white/80">200 hrs</td><td className="px-4 py-3 text-white/80">Class 1</td><td className="px-4 py-3 text-white/80">Paid flying, aerial work, charter</td><td className="px-4 py-3 text-white/80">EUR50,000 - EUR100,000</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">MPL (Multi-crew Pilot Licence)</td><td className="px-4 py-3 text-white/80">240 hrs</td><td className="px-4 py-3 text-white/80">Class 1</td><td className="px-4 py-3 text-white/80">Multi-crew co-pilot only (airline-linked)</td><td className="px-4 py-3 text-white/80">Airline-funded (approx. EUR60,000 - EUR120,000 if self-funded)</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">ATPL (Airline Transport Pilot Licence)</td><td className="px-4 py-3 text-white/80">1,500 hrs*</td><td className="px-4 py-3 text-white/80">Class 1</td><td className="px-4 py-3 text-white/80">Captain on any aircraft, all operations</td><td className="px-4 py-3 text-white/80">EUR60,000 - EUR140,000</td></tr>
                </tbody>
              </table>
          ...
          content: (
            <>
              ...
              <ul>
                ...
                <li><strong>Cost:</strong> Higher upfront cost, typically ranging from EUR80,000 to EUR120,000, as it includes all phases of training from ab-initio to multi-engine instrument rating and multi-crew cooperation (MCC).</li>
              ...
              <ul>
                ...
                <li><strong>Cost:</strong> Generally lower overall cost, often ranging from EUR60,000 to EUR90,000, as students can choose different schools for different modules and manage expenses incrementally.</li>
          ...
          content: (
            <>
              ...
              <table className="w-full text-sm text-left border-collapse">
                ...
                <tbody>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">Private Pilot Licence (PPL)</td><td className="px-4 py-3 text-white/80">EUR10,000 - EUR18,000</td><td className="px-4 py-3 text-white/80">Included</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">ATPL Theory (Distance Learning/Classroom)</td><td className="px-4 py-3 text-white/80">EUR3,000 - EUR8,000</td><td className="px-4 py-3 text-white/80">Included</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">Hour Building (approx. 100-150 hours)</td><td className="px-4 py-3 text-white/80">EUR20,000 - EUR35,000</td><td className="px-4 py-3 text-white/80">Included</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">Commercial Pilot Licence (CPL)</td><td className="px-4 py-3 text-white/80">EUR15,000 - EUR25,000</td><td className="px-4 py-3 text-white/80">Included</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">Multi-Engine Piston (MEP) Rating</td><td className="px-4 py-3 text-white/80">EUR5,000 - EUR8,000</td><td className="px-4 py-3 text-white/80">Included</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">Instrument Rating (IR)</td><td className="px-4 py-3 text-white/80">EUR15,000 - EUR25,000</td><td className="px-4 py-3 text-white/80">Included</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">Multi-Crew Cooperation (MCC) Course</td><td className="px-4 py-3 text-white/80">EUR3,000 - EUR6,000</td><td className="px-4 py-3 text-white/80">Included</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">Upset Prevention & Recovery Training (UPRT)</td><td className="px-4 py-3 text-white/80">EUR2,000 - EUR4,000</td><td className="px-4 py-3 text-white/80">Included</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">EASA Class 1 Medical Examination</td><td className="px-4 py-3 text-white/80">EUR500 - EUR1,000</td><td className="px-4 py-3 text-white/80">EUR500 - EUR1,000</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">Examiner Fees & Licensing</td><td className="px-4 py-3 text-white/80">EUR1,000 - EUR2,000</td><td className="px-4 py-3 text-white/80">EUR1,000 - EUR2,000</td></tr>
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80">Study Materials & Equipment</td><td className="px-4 py-3 text-white/80">EUR1,000 - EUR3,000</td><td className="px-4 py-3 text-white/80">EUR1,000 - EUR3,000</td></tr>
                  ...
                  <tr className="border-b border-white/10"><td className="px-4 py-3 text-white/80"><strong>Total Estimated Cost</strong></td><td className="px-4 py-3 text-white/80"><strong>EUR60,000 - EUR90,000</strong></td><td className="px-4 py-3 text-white/80"><strong>EUR80,000 - EUR120,000</strong></td></tr>
                </tbody>
              </table>
      ...
      faqSchema={[
        ...
        { question: "How much does pilot training cost in Europe in 2026?", answer: "The cost of pilot training in Europe varies significantly. An Integrated ATPL program typically ranges from EUR80,000 to EUR120,000, while a Modular ATPL pathway can range from EUR60,000 to EUR90,000. These figures include tuition, but additional costs for living expenses, medicals, and licensing fees should also be factored in." },
