    ...
    <GuideLayout
      ...
      sections={[
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <ul>
                <li><strong>Recreational Pilot Licence (RPL):</strong> Allows you to fly light, single-engine aircraft solo within a limited radius from your departure aerodrome. It's an excellent starting point to gauge your interest and aptitude.</li>
                <li><strong>Private Pilot Licence (PPL):</strong> Enables you to fly single-engine aircraft with passengers, day or night, under Visual Flight Rules (VFR). This is the foundational license for all further professional training.</li>
                <li><strong>Commercial Pilot Licence (CPL):</strong> The minimum requirement to be paid for flying. It allows you to act as pilot-in-command of single-pilot aircraft in commercial operations, or as co-pilot in multi-crew aircraft.</li>
                <li><strong>Air Transport Pilot Licence (ATPL):</strong> The highest level of pilot certification, required to act as pilot-in-command of multi-crew aircraft in airline operations. Most aspiring airline pilots achieve a 'frozen ATPL' by completing the theory exams and accumulating the necessary flight hours, with the full ATPL issued after meeting specific experience requirements.</li>
              </ul>
            </>
          )
        },
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <ul>
                <li><strong>Accommodation & Living Expenses:</strong> If you relocate for training, budget $15,000 - $30,000 per year for rent, food, and transport, especially in regional areas where many flight schools are located.</li>
                <li><strong>Training Delays & Weather:</strong> Unforeseen delays due to weather or personal learning pace can extend training duration, leading to increased living costs and potentially additional flight hours. Budget a 20% buffer.</li>
                <li><strong>Chart Subscriptions & Navigation Tools:</strong> Digital flight bag subscriptions (e.g., AvPlan EFB, OzRunways) cost $150 - $350/year. Initial chart purchases can be $300 - $500.</li>
                <li><strong>Uniform & Personal Protective Equipment (PPE):</strong> Flight school uniforms, quality sunglasses, and other PPE can range from $500 - $1,000.</li>
                <li><strong>Recency & Currency Flying:</strong> After obtaining licenses, maintaining currency requires regular flying. Budget $500 - $1,500/month if you're building hours or between jobs.</li>
                <li><strong>Failed Test Attempts:</strong> Re-tests incur additional fees (e.g., CPL re-test $1,400 - $1,800) plus extra preparation flying. Always have a contingency.</li>
                <li><strong>Aviation Security Identification Card (ASIC):</strong> Required for unescorted access to secure areas of airports, typically around $200 - $300.</li>
              </ul>
            </>
          )
        },
        ...
        },
        {
          ...
          content: (
            <>
              <p>While the costs are substantial, several avenues for financial assistance exist to help aspiring pilots fund their training:</p>
              <ul>
                <li><strong>VET Student Loans (VSL):</strong> Many approved Diploma of Aviation courses (CPL) are eligible for VSL, a government loan scheme that helps eligible students pay for their tuition fees. Repayment is income-contingent. Institutions like Basair Aviation College and Air Gold Coast often offer VSL-approved programs.</li>
                <li><strong>FEE-HELP:</strong> For university-level Bachelor of Aviation degrees (e.g., UNSW, Griffith University), FEE-HELP is available to defer tuition costs. Similar to VSL, repayment is linked to your income.</li>
                <li><strong>Personal Loans & Savings:</strong> Many students rely on personal savings, family support, or secure personal loans from financial institutions.</li>
                <li><strong>Scholarships:</strong> Various aviation organisations, flight schools, and industry bodies offer scholarships. These are highly competitive but can significantly reduce the financial burden. Examples include scholarships from the Australian Women Pilots' Association, Royal Aeronautical Society, and specific flight schools.</li>
                <li><strong>Airline Cadet Programs:</strong> Major airlines like Qantas and Virgin Australia occasionally run cadet programs. While highly competitive, these programs can offer sponsored training, often with a bond, leading to direct employment. Costs and structures vary, but they represent a significant opportunity to mitigate upfront expenses.</li>
              </ul>
            </>
          )
        },
        {
          ...
          content: (
            <>
              <p>The choice of flight school is paramount, influencing not only the cost but also the quality of training, duration, and career prospects. Consider the following factors:</p>
              <ul>
                <li><strong>Accreditation:</strong> Ensure the school is CASA-approved (Part 141 or Part 142) and, if applicable, offers VSL/FEE-HELP eligible courses.</li>
                <li><strong>Location:</strong> Regional schools often have lower operating costs (and thus lower tuition) and less congested airspace, which can lead to more efficient training. However, consider living expenses if relocating.</li>
                <li><strong>Fleet & Facilities:</strong> Modern aircraft, well-maintained simulators, and comprehensive ground school facilities are indicators of a quality institution.</li>
                <li><strong>Instructor Experience:</strong> Experienced instructors are invaluable. Look for schools with a strong instructor-to-student ratio.</li>
                <li><strong>Industry Connections:</strong> Schools with established relationships with airlines and regional operators can offer better career pathways.</li>
                <li><strong>Transparency in Pricing:</strong> A reputable school will provide a clear, detailed breakdown of all costs, including potential additional fees.</li>
              </ul>
              <p>Examples of prominent flight schools and university programs in Australia include UNSW School of Aviation, Basair Aviation College, Air Gold Coast, and Griffith University Aviation.</p>
            </>
          )
        },
        {
          ...
          content: (
            <>
              <p>Becoming a pilot in Australia is a substantial financial undertaking, but for those with the passion and dedication, it is an incredibly rewarding career. By thoroughly understanding the costs involved, exploring financial aid options, and choosing the right training pathway, you can effectively plan your journey to the flight deck. The investment in your training is an investment in a dynamic and fulfilling professional life in the skies.</p>
            </>
          )
        },
      ]}
      faqSchema={[
        { question: "How much does it cost to become a commercial pilot in Australia in 2026?", answer: "The total cost to become a job-ready commercial pilot in Australia in 2026 typically ranges from AUD $100,000 to over $200,000, depending on the training pathway (modular vs. integrated), chosen ratings (Instrument, Multi-Engine), and inclusion of ATPL theory. This figure often excludes living expenses." },
        { question: "What are the main components of pilot training costs in Australia?", answer: "The main components include flight hours (aircraft rental and instructor fees), ground school tuition and materials, CASA examination fees, medical certificate costs, and essential equipment like headsets. Hidden costs such as living expenses, training delays, and re-test fees also contribute significantly." },
        { question: "Can I get a loan for pilot training in Australia?", answer: "Yes, eligible domestic students can access government-backed VET Student Loans (for Diploma of Aviation courses) or FEE-HELP (for Bachelor of Aviation degrees) to cover tuition fees. Personal loans and scholarships are also common funding options." },
        { question: "How long does it take to become a commercial pilot in Australia?", answer: "The duration varies. An integrated program from zero experience to CPL with ratings can take 1.5 to 2.5 years. A modular pathway might take longer, depending on your pace, typically 2 to 4 years to reach airline-ready qualifications." },
        { question: "What is a 'frozen ATPL' and how much does it cost?", answer: "A 'frozen ATPL' means you have completed all the theoretical exams for the Air Transport Pilot Licence and hold a Commercial Pilot Licence with Instrument Rating. You need to accumulate specific flight experience (e.g., 1,500 hours total time) to 'unfreeze' it and obtain the full ATPL. The ATPL theory component typically costs between AUD $3,700 and $9,040." },
        { question: "Are airline cadet programs a cheaper way to become a pilot in Australia?", answer: "Airline cadet programs can significantly reduce upfront costs as they often involve sponsored training, sometimes with a bond. However, they are highly competitive and have stringent entry requirements. They are an excellent option if you can secure a place." },
