      ...
      sections={[
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                The landscape of Instrument Ratings in Europe and the UK has evolved significantly, particularly following the UK's departure from the European Union Aviation Safety Agency (EASA) system. Understanding the differences between the EASA IR, the UK IR, and the En-Route Instrument Rating (EIR) is vital for pilots planning their training and career paths. The <b>EASA IR</b> is issued under EASA regulations and is primarily valid within EASA member states. For UK pilots who obtained their EASA IR prior to Brexit, it generally remains valid for flights withwith EASA privileges, provided it is maintained according to EASA requirements. However, new IRs issued by the UK Civil Aviation Authority (CAA) are UK-issued privileges; pilots should check conversion/validation requirements if they intend to fly EASA-registered aircraft.
              </p>
              <p>
                The <b>UK IR</b> is the standard Instrument Rating issued by the UK CAA and is tied to UK CAA licensing/privileges and UK-registered aircraft unless conversion or validation applies. While it shares many similarities with its EASA counterpart in terms of training content and standards, it is distinct in its regulatory oversight and geographical validity. Pilots intending to fly commercially predominantly within the UK or on UK-registered aircraft will typically need a UK CAA IR or an accepted/converted equivalent. For those aiming for broader European operations, careful consideration of mutual recognition agreements or additional validations may be necessary.
              </p>
              <p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>
                The examinations are administered by the UK CAA and must be passed within an 18-month period from the date of the first successful exam. The theoretical knowledge examination process must be completed before commencing the practical skill test. This structured approach ensures that pilots have a solid theoretical foundation before applying their knowledge in the cockpit. Each subject demands a high level of detail and understanding, reflecting the critical nature of instrument flight operations.
              </p>
              <p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>
                Beyond operational necessity, holding an IR demonstrates a pilot's advanced skill set, discipline, and commitment to aviation professionalism. It signifies a pilot's ability to manage complex aircraft systems, interpret sophisticated navigation data, and make critical decisions under demanding circumstances. These are precisely the qualities airlines seek in their flight crews. Consequently, an IR is a core requirement for most airline training routes and direct-entry positions, making it an indispensable step on the path to an airline career.
              </p>
            </>
          ),
        },
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>
                Beyond the annual check, pilots must also meet specific recency requirements to exercise their IR privileges. For instance, to act as pilot-in-command under IFR, a pilot must meet the current Part-FCL recency, revalidation and renewal requirements for their licence and operation. If currency has lapsed, check with an ATO/DTO or examiner before exercising IR privileges. This ensures that instrument flying skills remain sharp and current.
              </p>
              <p>
