        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>
                The examinations are administered by the UK CAA and must be passed within an 18-month period from the date of the first successful exam. the entire theoretical knowledge examination process must be completed before commencing the practical skill test. This structured approach ensures that pilots have a solid theoretical foundation before applying their knowledge in the cockpit. Each subject demands a high level of detail and understanding, reflecting the critical nature of instrument flight operations.
              </p>
              <p>
