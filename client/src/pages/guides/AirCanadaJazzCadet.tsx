  ...
  return (
    <GuideLayout
      ...
      sections={[
        ...
        {
          heading: "The Jazz Approach: Program Overview",
          content: (
            <>
              <p>The Jazz Approach cadet program is a proudly Canadian initiative, underpinned by a Transport Canada-approved Integrated Airline Transport Pilot License (IATPL) training program. This rigorous curriculum is designed to provide cadets with best-in-class ab initio flight training, embedded with airline-oriented instruction and delivered by experienced industry professionals. The program spans approximately 20 months, with the primary flight training conducted at Cygnet Aviation Academy LP in Kingston, Ontario, followed by a specialized two-week Jet Orientation Training at CAE Toronto.</p>
              <p>Upon successful completion of the program, cadets will have earned their Private Pilot License (PPL), Commercial Pilot License (CPL) with Instrument Rating, and Multi-Engine Rating. The program fee is all-inclusive, covering essential components such as ground school, extensive flight hours, advanced simulator training, all first-time check rides, necessary written exams, and comprehensive training materials. This integrated approach ensures that graduates are not only proficient in flight operations but are also thoroughly prepared for the demands of a modern airline environment.</p>
            </>
          )
        },
        {
          ...
          content: (
            <>
              ...
              <ul>
                <li><strong>Citizenship and Residency</strong>: Applicants must be Canadian citizens or permanent residents, possessing the unrestricted legal right to live and work in Canada. For permanent residents, the ability to obtain and maintain crew visa documentation required for operations within the USA is also a prerequisite.</li>
                <li><strong>Education</strong>: A post-secondary degree, diploma, or an equivalent qualification is mandatory, demonstrating a foundational academic capability.</li>
                <li><strong>Age</strong>: Candidates must be a minimum of 18 years old at the time of application.</li>
                <li><strong>Medical Certification</strong>: A valid Category 1 Medical Certificate, issued by Transport Canada, is essential. This ensures that applicants meet the rigorous health standards required for commercial aviation.</li>
                <li><strong>Language Proficiency</strong>: Fluency in English, both written and spoken, is critical for effective communication in an aviation environment. A minimum of ICAO (International Civil Aviation Organization) Level 4 English Language proficiency is required.</li>
              </ul>
              <p>While not a strict requirement, it is highly recommended that individuals unfamiliar with aviation operations undertake a familiarization flight in a small aircraft. This experience can provide valuable insight into the realities of flight training and help prospective cadets determine their suitability for an intensive aviation career.</p>
            </>
          )
        },
        {
        ...
        {
          heading: "Training Locations: Kingston & Toronto",
          content: (
            <>
              <p>The Jazz Approach program leverages state-of-the-art facilities and strategic locations to provide optimal training environments:</p>
              <ul>
                <li><strong>Cygnet Aviation Academy LP, Kingston, Ontario</strong>: This is the primary site for ab initio flight training. Cygnet Aviation Academy, owned by Chorus Aviation Inc. (the parent company of Jazz), specializes in airline cadet programs. The academy boasts a modern fleet of Diamond Aircraft and utilizes advanced flight simulation technology. Kingston Airport (YGK) offers an ideal training base with two runways, an Instrument Landing System (ILS), and readily accessible practice areas. Its proximity to the busy and complex airspaces of Toronto, Montreal, and Ottawa provides cadets with invaluable real-world training experiences, preparing them for diverse operational scenarios.</li>
                <li><strong>CAE Toronto, Ontario</strong>: Following the foundational flight training in Kingston, cadets proceed to CAE Toronto for a specialized two-week Jet Orientation Training. This phase is crucial for transitioning from propeller aircraft to jet operations, familiarizing cadets with the systems and procedures of modern airline aircraft.</li>
              </ul>
            </>
          )
        },
