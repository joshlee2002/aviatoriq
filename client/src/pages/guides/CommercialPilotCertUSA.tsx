...
const References = () => (
  <div className="mt-12 border-t border-gray-200 pt-8">
    ...
    <ul className="list-disc pl-5">
      <li> <Link href="https://www.ecfr.gov/current/title-14/chapter-I/subchapter-D/part-61/subpart-F" target="_blank" rel="noopener noreferrer">14 CFR Part 61 Subpart F - Commercial Pilots</Link></li>
      <li> <Link href="https://www.law.cornell.edu/cfr/text/14/61.129" target="_blank" rel="noopener noreferrer">14 CFR § 61.129 - Aeronautical experience.</Link></li>
      <li> <Link href="https://www.ecfr.gov/current/title-14/chapter-I/subchapter-H/part-141" target="_blank" rel="noopener noreferrer">14 CFR Part 141 - Pilot Schools</Link></li>
      <li> <Link href="https://www.aopa.org/training-and-safety/active-pilots/safety-and-technique/operations/commercial-pilot-certificate" target="_blank" rel="noopener noreferrer">Commercial Pilot Certificate - AOPA</Link></li>
    </ul>
  </div>
);
