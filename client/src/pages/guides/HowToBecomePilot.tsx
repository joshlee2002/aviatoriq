        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>
                <strong>Integrated ATPL (overseas school  -  e.g., Bartolini Air, Poland):</strong> EUR55,000-EUR70,000 in training fees (approximately £47,000-£60,000), plus living costs. Significantly cheaper than UK schools with equivalent quality. Total: £60,000-£80,000.
              </p>
              <p>
                ...
                <table className="w-full text-sm border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr className="bg-slate-50 dark:bg-slate-900">
                      ...
                      <td className="p-3 border border-slate-200 dark:border-slate-700">EUR45,000-EUR55,000 base</td>
