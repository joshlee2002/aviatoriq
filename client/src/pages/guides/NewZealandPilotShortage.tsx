    ...
    <GuideLayout
      ...
      sections={[
        ...
        },
        {
          ...
          content: (
            <>
              <p>The Civil Aviation Authority of New Zealand (CAA NZ) is the primary regulatory body overseeing aviation safety and licensing within the country. All pilot training and operations in New Zealand adhere to CAA NZ regulations, which are aligned with international Civil Aviation Organisation (ICAO) standards . For 2026, the CAA NZ continues to focus on modernizing pilot training and licensing processes to ensure clarity, flexibility, and alignment with global best practices .</p>
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p><em>Note: CAA NZ minimum for CPL is 200 hours. Most students complete between 220-260 hours. Budgeting for approximately 1.3 times the minimum hours is advisable .</em></p>
              <p><strong>Training Costs by School Type (2026):</strong></p>
              <ul>
                <li><strong>Aero Clubs (e.g., Canterbury, Waikato, Air Hawkes Bay):</strong> Typically range from NZD $60,000 – $80,000 for a CPL. These offer pay-as-you-fly flexibility and often have lower hourly rates, making them suitable for budget-conscious domestic students .</li>
                <li><strong>Professional Schools (e.g., IAANZ, NZ Aviation Academy, NZAAL, Mainland Air):</strong> CPL diploma programs generally cost between NZD $80,000 – $100,000. These schools offer structured programs, often with NZQA approval, and fixed timelines. Many are equipped to accept international students .</li>
                <li><strong>University Programs (e.g., Massey University School of Aviation):</strong> A Bachelor of Aviation degree combined with flight training can cost NZD $90,000 – $110,000+. This includes academic tuition and flight training, leading to a degree alongside licenses .</li>
              </ul>
              <p><strong>Living Expenses:</strong></p>
              <p>Living costs are a significant consideration. Outside of Auckland, students should budget approximately NZD $1,200 – $1,800 per month. Auckland is considerably more expensive, with estimates ranging from NZD $1,800 – $2,500 per month. Cities like Christchurch, Hamilton, and Palmerston North offer better value for flight training students .</p>
              ...
              <p><em>Exchange rate used for EUR equivalent: 1 NZD = 0.55 EUR (approximate, June 2026) .</em></p>
            </>
          )
        },
        {
          ...
          content: (
            <>
              <p>New Zealand boasts a selection of high-quality, CAA-approved flight training organizations. These schools offer diverse programs, from flexible aero club models to comprehensive university degrees. Here's an overview of some prominent institutions :</p>
          ...
          content: (
            <>
              ...
              <ul>
                ...
                <li><strong>Student Visa:</strong> A student visa is required for programs longer than three months. This visa typically allows students to work up to 20 hours per week during term time and full-time during scheduled breaks, which can help offset living costs. Applications are processed through Immigration New Zealand .</li>
                <li><strong>Financial Proof:</strong> Applicants must demonstrate sufficient funds to cover living expenses (approximately NZD $20,000 per year) in addition to course fees. While some schools accept staged tuition payments, proof of overall financial capacity is mandatory .</li>
                <li><strong>English Language Proficiency:</strong> An IELTS score of 5.5 or higher (or an equivalent recognized English language test) is generally required for the student visa. Most aviation programs, however, recommend or require an IELTS score of 6.0 or higher, as all CAA NZ examinations are conducted in English .</li>
                <li><strong>Post-Study Work Visa:</strong> As mentioned, graduates of NZQA-approved Level 7+ programs may be eligible for a 3-year Post-Study Work Visa, facilitating the transition into the New Zealand aviation workforce .</li>
              </ul>
            </>
          )
        },
              ...
              <table className="w-full text-sm text-left border-collapse">
                ...
                <tbody>
                  <tr className="border-b border-white/10">
                    ...
                    <td className="px-4 py-3 text-white/80">NZD $60,000 – $110,000 (~€33,000 – €61,000) </td>
                    <td className="px-4 py-3 text-white/80">AUD $65,000 – $120,000 </td>
                    <td className="px-4 py-3 text-white/80">€55,000 – €130,000 </td>
                  </tr>
                  <tr className="border-b border-white/10">
                    <td className="px-4 py-3 text-white/80"><strong>Living Costs</strong></td>
                    <td className="px-4 py-3 text-white/80">Lower, especially outside Auckland </td>
                    <td className="px-4 py-3 text-white/80">Higher (e.g., Sydney, Melbourne) </td>
                    <td className="px-4 py-3 text-white/80">Varies, often higher (e.g., London) </td>
                  </tr>
                  <tr className="border-b border-white/10">
                    <td className="px-4 py-3 text-white/80"><strong>Licensing</strong></td>
                    <td className="px-4 py-3 text-white/80">CAA NZ, mutual recognition with CASA (Australia) </td>
                    <td className="px-4 py-3 text-white/80">CASA, mutual recognition with CAA NZ </td>
                    <td className="px-4 py-3 text-white/80">EASA, requires full conversion for NZ/AU </td>
                  </tr>
                  <tr className="border-b border-white/10">
                    <td className="px-4 py-3 text-white/80"><strong>Terrain/Experience</strong></td>
                    <td className="px-4 py-3 text-white/80">High diversity (mountains, coast, fjords) </td>
                    <td className="px-4 py-3 text-white/80">Varied, but less diversity per area </td>
                    <td className="px-4 py-3 text-white/80">Denser controlled airspace </td>
                  </tr>
                  <tr className="border-b border-white/10">
                    <td className="px-4 py-3 text-white/80"><strong>Market Access</strong></td>
                    <td className="px-4 py-3 text-white/80">Australasia, Pacific, Asia, Middle East </td>
                    <td className="px-4 py-3 text-white/80">Australasia, Asia, Middle East </td>
                    <td className="px-4 py-3 text-white/80">Primarily European airlines </td>
                  </tr>
                </tbody>
              </table>
              <p>New Zealand stands out for its cost-effectiveness and the quality of its training environment. The mutual recognition with Australia provides a dual market advantage, allowing pilots to train at a lower cost and then access opportunities across the Tasman. The diverse terrain offers invaluable real-world flying experience, preparing pilots for a wide range of operational conditions . While Europe offers integrated ATPL programs and direct pathways to European airlines, the licensing conversion process for non-EASA licenses can be extensive.</p>
            </>
          )
        },
        {
          ...
          content: (
            <>
              <p> ICAO. <em>Pilot Shortage Projections</em>. (2026).</p>
              <p> Airmappr. <em>Best Flight Schools in New Zealand 2026</em>. (2026). <a href="https://airmappr.com/articles/flight-training/best-flight-schools-new-zealand">https://airmappr.com/articles/flight-training/best-flight-schools-new-zealand</a></p>
              <p> Civil Aviation Authority of New Zealand. <em>Flight Training</em>. (n.d.). <a href="https://www.aviation.govt.nz/licensing-and-certification/pilots/flight-training/">https://www.aviation.govt.nz/licensing-and-certification/pilots/flight-training/</a></p>
              <p> Beehive.govt.nz. <em>Accelerated aviation rules programme takes off</em>. (2026). <a href="https://www.beehive.govt.nz/release/accelerated-aviation-rules-programme-takes">https://www.beehive.govt.nz/release/accelerated-aviation-rules-programme-takes</a></p>
              <p> Epic Flight Academy. <em>Civil Aviation Authority of New Zealand</em>. (2025). <a href="https://epicflightacademy.com/aviation-authority-new-zealand/">https://epicflightacademy.com/aviation-authority-new-zealand/</a></p>
              <p> Air New Zealand. <em>Careers</em>. (n.d.).</p>
            </>
          )
        }
      ]}
