    ...
    <GuideLayout
      ...
      sections={[
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>The journey to the flight deck of a regional airliner involves a progression through various licenses and ratings. Each stage builds upon the previous one, enhancing a pilot's skills, knowledge, and operational capabilities.</p>
        ...
        },
        {
          ...
          content: (
            <>
              <p>Canada's regional airlines offer diverse opportunities for new and experienced pilots. These carriers are often the gateway to major airlines, providing the necessary flight hours and operational experience.</p>
              <h3>Jazz Aviation LP (Air Canada Express)</h3>
              <p>As the largest regional airline in Canada, Jazz Aviation operates flights under the Air Canada Express brand. It serves an extensive network of destinations across Canada and the United States. Jazz is well-known for its comprehensive pilot recruitment programs and a clear career progression pathway to Air Canada mainline.</p>
              <ul>
                <li><strong>Fleet:</strong> De Havilland Dash 8-400, CRJ Series.</li>
              ...
              <p>Operating primarily from Billy Bishop Toronto City Airport, Porter Airlines offers a unique regional service with a focus on convenience and customer experience. With a growing fleet and expanding route network, Porter presents attractive opportunities, particularly for pilots interested in turboprop operations and a distinct corporate culture.</p>
              <ul>
                <li><strong>Fleet:</strong> De Havilland Dash 8-400, Embraer E195-E2 (new jet fleet).</li>
                <li><strong>Entry Requirements (First Officer):</strong> CPL with Multi-Engine and Instrument Ratings, often 1000+ hours total time, with a preference for multi-engine turbine experience.</li>
                <li><strong>Career Progression:</strong> Opportunities for advancement within Porter's expanding operations, including transitions to their new jet fleet.</li>
              </ul>
              <h3>WestJet Encore</h3>
              <p>WestJet Encore is WestJet's regional airline, connecting smaller communities to WestJet's main network. It offers a dynamic work environment and a strong focus on safety and guest experience. Pilots joining WestJet Encore can expect a clear career trajectory within the broader WestJet group.</p>
              <ul>
                <li><strong>Fleet:</strong> De Havilland Dash 8-400.</li>
                <li><strong>Entry Requirements (First Officer):</strong> CPL with Multi-Engine and Instrument Ratings, typically 1000+ hours total time, with a strong emphasis on multi-crew experience and CRM skills.</li>
                <li><strong>Career Progression:</strong> Defined pathways to WestJet mainline operations for eligible pilots.</li>
              </ul>
              <h3>Canadian North</h3>
              <p>Canadian North provides essential passenger and cargo services to Canada's Arctic communities. This airline offers a unique and challenging flying environment, often involving operations into remote airfields and diverse weather conditions. It's an excellent option for pilots seeking specialized experience and a chance to explore Canada's northern regions.</p>
              <ul>
                <li><strong>Fleet:</strong> Boeing 737, ATR 42/72.</li>
                <li><strong>Entry Requirements (First Officer):</strong> CPL with Multi-Engine and Instrument Ratings, often 1500+ hours total time, with preference for turbine and northern operations experience.</li>
                <li><strong>Career Progression:</strong> Opportunities to gain valuable experience in challenging operational environments and advance to Captain roles on various aircraft types.</li>
              </ul>
            </>
          )
        },
        {
          ...
          content: (
            <>
              <p>The outlook for regional airline pilots in Canada remains positive, driven by several factors:</p>
              <ul>
                <li><strong>Pilot Demand:</strong> Ongoing global and domestic pilot shortages continue to create demand for qualified aviators.</li>
                <li><strong>Retirements:</strong> A significant number of experienced pilots are approaching retirement age, opening up positions across all levels.</li>
                <li><strong>Regional Connectivity:</strong> The continued need for air travel to connect smaller communities ensures the sustained importance of regional carriers.</li>
                <li><strong>Fleet Modernization:</strong> Airlines are investing in newer, more efficient aircraft, leading to new opportunities for pilots trained on modern systems.</li>
              </ul>
              <p>While the path is demanding, the rewards of a regional airline career in Canada are substantial, offering competitive salaries, comprehensive benefits, and the chance to fly in one of the world's most beautiful and challenging airspaces.</p>
            </>
          )
        },
        {
          ...
          content: (
            <>
              <p>Funding pilot training is a significant consideration. Several options are available to help aspiring pilots manage the costs:</p>
              <ul>
                <li><strong>Student Loans:</strong> Government-backed and private student loans are common financing methods.</li>
                <li><strong>Flight School Financing:</strong> Many flight schools partner with financial institutions to offer specialized loan programs.</li>
                <li><strong>Scholarships and Bursaries:</strong> Various aviation organizations and foundations offer scholarships to deserving candidates. Research options from organizations like the Air Canada Pilots Association (ACPA), the Canadian Owners and Pilots Association (COPA), and local aviation groups.</li>
                <li><strong>Cadet Programs:</strong> Some airlines, particularly major carriers, offer cadet programs that provide financial assistance and a direct path to employment upon completion of training. While less common for regional airlines directly, strong performance in flight school can lead to consideration for these programs.</li>
                <li><strong>Personal Savings/Family Support:</strong> A significant portion of training costs is often covered through personal savings or family contributions.</li>
              </ul>
              <p>It is highly recommended to create a detailed financial plan early in your training journey to ensure a smooth progression through each stage.</p>
            </>
          )
        }
      ]}
      faqSchema={[
        { question: "What is the minimum age to start pilot training in Canada?", answer: "You can begin flight training at any age, but you must be at least 14 years old to fly solo for a glider or balloon, 16 for a recreational or ultra-light permit, and 17 to obtain a Private Pilot Licence (PPL). For a Commercial Pilot Licence (CPL), the minimum age is 18." },
        { question: "How long does it take to become a regional airline pilot in Canada?", answer: "The timeline varies significantly based on whether you pursue integrated or modular training, and your personal pace. Generally, it can take anywhere from 2 to 4 years to go from no experience to being qualified for a First Officer position at a regional airline, accumulating the necessary licenses, ratings, and flight hours." },
        { question: "What are the key licenses required for regional airline pilots in Canada?", answer: "The essential licenses and ratings include the Private Pilot Licence (PPL), Commercial Pilot Licence (CPL), Multi-Engine Rating, and Instrument Rating (Group 1). While not always an entry requirement, working towards an Airline Transport Pilot Licence (ATPL) is the ultimate goal for airline pilots." },
        { question: "What is the approximate cost of pilot training in Canada?", answer: "The total cost to go from no experience to a Commercial Pilot Licence with Multi-Engine and Instrument Ratings can range from CAD $70,000 to over CAD $120,000. This includes flight instruction, ground school, exams, and associated fees." },
        { question: "Which regional airlines operate in Canada?", answer: "Major regional airlines in Canada include Jazz Aviation LP (operating as Air Canada Express), Porter Airlines, WestJet Encore, and Canadian North. There are also several smaller charter and regional operators." },
