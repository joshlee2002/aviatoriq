...
export default function BASpeedbirdAcademy() {
  return (
    <GuideLayout
      ...
      faqSchema={[
        { question: "Is the BA Speedbird Academy completely free?", answer: "The tuition costs (approx £100,000) are fully funded by British Airways. However, you are usually responsible for your own living costs (accommodation, food) during the 18-24 months of training, which can exceed £15,000. BA occasionally offers subsistence loans, but this changes per intake." },
        { question: "Do you have to pay British Airways back for the training?", answer: "No, you do not pay the money back directly from your salary. However, you will sign a training bond. If you resign from British Airways within a bonded period (typically 5 to 7 years), you will be liable to repay a pro-rata portion of the training costs." },
      ...
      sections={[
          ...
          content: (
            <>
              ...
              <p className="text-sm p-3 rounded-lg my-4 bg-blue-50 border border-blue-100 text-blue-900">
                Not sure if you qualify? Try our free <Link href="/tools/cadet-eligibility" className="text-blue-700 font-medium underline">Cadet Eligibility Checker</Link> to see which programmes you are likely to be eligible for.
              </p>
              <p>
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                The Speedbird Academy opens for applications in brief windows (often just 7–14 days per year). Below is the verified status of BA Speedbird alongside other major UK cadet programmes.
              </p>
          ...
          content: (
            <>
              ...
              <ul className="list-disc list-inside space-y-3 mt-4 mb-6">
                <li>
                  <strong>Tuition & Type Rating:</strong> British Airways pays the flight school directly for your ATPL training and your subsequent Type Rating.
                </li>
                <li>
                ...
                <li>
                  <strong>The Training Bond:</strong> To protect their investment, BA requires cadets to sign a training bond. You do not repay the money from your salary, but if you resign from BA within the bonded period (usually 5-7 years), you must repay a sliding-scale percentage of the training cost.
                </li>
              </ul>
            </>
          ),
          ...
          content: (
            <>
              ...
              <ol className="list-decimal list-inside space-y-3 mt-4 mb-6">
                <li><strong>Online Application & SJT:</strong> CV submission and a Situational Judgement Test to assess your alignment with BA's corporate values.</li>
                <li><strong>Online Aptitude Tests:</strong> A battery of tests (often Aon/Cut-e) assessing numerical reasoning, spatial awareness, and multi-tasking.</li>
                <li><strong>Video Interview:</strong> Pre-recorded video questions assessing motivation and competency.</li>
                <li><strong>Assessment Centre (Waterside):</strong> A full day at BA's headquarters involving group exercises (assessing teamwork and leadership) and a rigorous panel interview.</li>
              </ol>
            </>
          ),
        },
