  ...
  return (
    <GuideLayout
      ...
      relatedGuides={[
        ...
        { title: "Pilot Aptitude Tests: Complete Preparation Guide", href: "/guides/pilot-aptitude-test-uk", time: "8 min read" },
        { title: "How to Become an Airline Pilot", href: "/guides/how-to-become-a-pilot", time: "10 min read" },
      ]}
      sections={[
        {
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>
                <strong>Poor formatting:</strong> Inconsistent fonts, misaligned columns, and dense paragraphs make CVs hard to scan. Use a clean, single-font template. Align all dates consistently. Use bullet points for employment history, not paragraphs.
              </p>
              <p>
                <strong>Spelling and grammar errors:</strong> There is no acceptable number of errors in a pilot CV. One typo suggests carelessness. Have someone proofread your CV before every application round.
              </p>
            </>
          ),
        },
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>
                <strong>Honesty about your position:</strong> Airlines know what ab-initio graduates look like. Do not try to make 220 hours look like 500. Present your hours accurately, explain your training pathway clearly, and let your professionalism and preparation do the work.
              </p>
            </>
          ),
        },
