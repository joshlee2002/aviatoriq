      ...
      sections={[
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                The salary for a First Officer in the UK is a significant consideration for those entering the profession. Entry-level salaries for new First Officers in 2026 can vary widely by airline, contract, base, roster and allowances; many UK short-haul packages sit in broad bands from the mid-five figures upward, but applicants should verify current pay scales before making financial decisions. For long-haul operations at British Airways or Virgin Atlantic, starting packages can be higher at some long-haul operators, but figures depend on current contracts, fleet, seniority and allowances. These figures are influenced by the airline's pay scales, the aircraft type, and the number of flying hours.
              </p>
              <p>
              ...
              <p>
                While First Officer salaries are competitive, they are considerably lower than those of experienced Captains, whose total compensation can exceed six figures at major UK airlines depending on fleet, seniority, overtime, allowances and contract terms. This disparity highlights the clear career progression and financial rewards associated with achieving command. Understanding these salary expectations is crucial for aspiring pilots to plan their financial future and assess the return on investment for their extensive training.
              </p>
            </>
          ),
        },
