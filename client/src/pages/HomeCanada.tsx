...
const CA_GUIDES = [
  {
    title: "Pilot Training Costs Canada 2026: The Full Breakdown",
    href: "/canada/guides/canada-pilot-training-costs",
    desc: "CPL, ATPL, PPL — real 2026 costs from Canadian flight schools.",
    tag: "Popular",
  },
  {
    title: "Canadian Pilot Salary 2026: Air Canada, WestJet & Regionals",
    href: "/canada/guides/canada-pilot-salary-2026",
    desc: "From a $35k flight instructor to a $350k Air Canada Captain — real 2026 pay scales.",
    tag: "Salary",
  },
  {
    title: "Transport Canada Class 1 Medical: Full Guide",
    href: "/canada/guides/tc-medical-class-1",
    desc: "Aviation Medical Examiner (AME) requirements, disqualifying conditions, and how to prepare.",
    tag: "Medical",
  },
  {
    title: "Transport Canada CPL Requirements 2026",
    href: "/canada/guides/transport-canada-cpl-requirements",
    desc: "Everything you need to know about the Transport Canada Commercial Pilot Licence.",
    tag: "Licence",
  },
  {
    title: "Air Canada Jazz Cadet Program 2026",
    href: "/canada/guides/air-canada-jazz-cadet",
    desc: "The Jazz Approach program — direct pathway to Air Canada Express.",
    tag: "Cadets",
  },
  {
    title: "Canadian Airline Cadet Programmes 2026",
    href: "/canada/guides/canada-cadet-programs",
    desc: "Air Canada, WestJet, Jazz, Porter, and regional airline cadet pathways.",
    tag: "Cadets",
  },
  {
    title: "WestJet Encore First Officer 2026",
    href: "/canada/guides/westjet-encore-cadet",
    desc: "WestJet Encore pathway — requirements, application, and career progression.",
    tag: "Cadets",
  },
  {
    title: "Porter Airlines Cadet Program 2026",
    href: "/canada/guides/porter-airlines-cadet-program",
    desc: "Porter's cadet pathway on the Embraer E195-E2 — eligibility and career trajectory.",
    tag: "Cadets",
  },
  {
    title: "Transport Canada ATPL Requirements 2026",
    href: "/canada/guides/tc-atpl-requirements",
    desc: "Everything you need to know about the Transport Canada ATPL licence.",
    tag: "Licence",
  },
  {
    title: "Canada Pilot Shortage 2026",
    href: "/canada/guides/canada-pilot-shortage",
    desc: "The growing pilot shortage in Canada — opportunities and how to position yourself.",
    tag: "Career",
  },
  {
    title: "Canada Regional Airlines 2026",
    href: "/canada/guides/canada-regional-airlines",
    desc: "Jazz, Encore, PAL — the stepping stones to mainline airline careers in Canada.",
    tag: "Career",
  },
];
...
const CA_TOOLS = [
  {
    ...
    href: "/quiz",
    desc: "Get your personalised Transport Canada training roadmap",
  },
  {
    icon: "🧮",
    label: "Cost Calculator",
    href: "/tools/calculator",
    desc: "Estimate your total CPL/ATPL training cost in CAD",
  },
  {
    icon: "🩺",
    label: "Medical Readiness Check",
  ...
  },
  {
    ...
    desc: "Air Canada, WestJet, Jazz, and regional cadet programmes",
  },
];
...
const CA_STATS = [
  ...
  {
    value: "~4,000",
    label: "Commercial pilots in Canada",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              ...
              >
                ...
                cost in CAD? Answer 5 questions and get a specific, data-driven
                roadmap — your exact Transport Canada route, real 2026 costs,
                timeline, and matched Canadian flight schools.
              </p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">
              Transport Canada Training Routes
            </h2>
            <p
              className="text-base max-w-2xl mx-auto"
              style={{ color: "oklch(0.6 0.04 240)" }}
            >
              Canada has two main pathways to a commercial pilot licence.
              Understanding the difference is the first decision you'll make.
            </p>
          </div>
      ...
      <section className="py-16" style={{ background: "oklch(0.11 0.07 245)" }}>
        <div className="container">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-2 text-center">
            Canadian Pilot Training Tools
          </h2>
          <p
            className="text-center mb-10 text-sm"
            style={{ color: "oklch(0.55 0.04 240)" }}
          >
            Free tools built for Transport Canada candidates
          </p>
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">
                Canadian Pilot Training Guides
              </h2>
              <p className="text-sm" style={{ color: "oklch(0.55 0.04 240)" }}>
                Researched, accurate, and specific to Transport Canada
                regulations
              </p>
            </div>
            <Link
      ...
      >
        <div className="container text-center max-w-2xl">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to start your Canadian pilot journey?
          </h2>
          <p className="text-lg mb-8" style={{ color: "oklch(0.65 0.04 240)" }}>
            Get your personalised Transport Canada training roadmap in under 5
