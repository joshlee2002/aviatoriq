  ...
  return (
    <div
      ...
      style={{
        ...
        borderBottom: "1px solid oklch(0.45 0.18 240 / 0.3)",
      }}
    >
      <div className="flex items-center gap-2 flex-1 min-w-0">
        ...
        <button
          onClick={() => {
            setCountry(detectedCountry as any);
            if (detectedCountry !== "uk") window.location.href = detected.href;
            setDismissed(true);
          }}
      ...
      <button
        ...
        className="flex-shrink-0 p-1 rounded-full hover:bg-white/10 transition-all"
        aria-label="Dismiss"
      >
...
function HeroSection() {
  const statsQuery = trpc.platform.stats.useQuery(undefined, {
    staleTime: 60_000,
  });
      ...
      <div className="container relative w-full py-12 md:py-20 lg:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div>
            ...
            <p
              className="text-base md:text-lg mb-3 leading-relaxed animate-fade-in-up delay-100"
              style={{ color: "oklch(0.72 0.04 240)" }}
            >
              Based on your country — UK CAA, FAA, CASA, EASA or beyond. Get
              country-specific routes, real 2026 costs, and matched flight
  ...
  const versions = [
    {
      ...
      regulator: "UK CAA",
      desc: "ATPL, CAA licences, UK flight schools, airline cadet programmes",
      href: "/",
      cta: "UK version",
    },
    {
      ...
      label: "United States",
      regulator: "FAA",
      desc: "FAA licences, Part 61 vs 141, ATP, US airline cadet programmes",
      href: "/us",
      cta: "US version",
    },
    {
      ...
      label: "Australia",
      regulator: "CASA",
      desc: "CASA licences, CPL/ATPL, Australian flight schools, Qantas Academy",
      href: "/australia",
      cta: "AU version",
    },
    {
      ...
      desc: "TC CPL/ATPL, Canadian flight schools, NAV CANADA airspace",
      href: "/canada",
      cta: "CA version",
    },
    {
      ...
      label: "Europe (EASA)",
      regulator: "EASA",
      desc: "EASA ATPL, integrated academies, Lufthansa, Wizz Air, Ryanair cadets",
      href: "/europe",
      cta: "EU version",
    },
    {
      ...
      regulator: "Global",
      desc: "UAE, South Africa, New Zealand, India, Singapore and more",
      href: "/select",
      cta: "Select country",
    },
  ];
      ...
      <div className="container">
        <div className="text-center mb-10">
          ...
          <p
            ...
            style={{ color: muted }}
          >
            Costs, routes, regulators, and flight schools differ significantly
            between countries. AviatorIQ gives you the correct information for
            your location — not a generic global average.
          </p>
        </div>
  ...
  const steps = [
    {
      ...
      description:
        "Tell us about your goal, your country, your situation, and what has been stopping you. The assessment takes around 5 minutes and is completely free.",
    ...
    },
    {
      ...
      description:
        "Get your AviatorIQ Score and a clear, honest answer to the question you have been avoiding: what is actually standing between you and the cockpit?",
      color: "oklch(0.72 0.18 65)",
    },
    {
      number: "03",
      icon: <Building2 className="w-6 h-6" />,
      title: "Get a country-specific roadmap",
      description:
        "Receive a training roadmap with the correct regulator, routes, costs, and matched flight schools for your country — not a generic global template.",
          ...
          {steps.map(step => (
            ...
            >
              <div className="flex items-start gap-4 mb-5">
                ...
                <div
                  className="text-4xl font-display font-black leading-none mt-1"
  ...
  const routes = [
    {
      ...
      description:
        "The most structured path to the airlines. Integrated ATPL (18–24 months full-time) or Modular ATPL (3–5 years flexible). Costs and routes vary significantly by country.",
    ...
    },
    {
      ...
      description:
        "Fly for pleasure or as a stepping stone to a commercial licence. The most accessible entry point into aviation, available worldwide.",
    ...
    },
    {
      ...
      description:
        "Train others to fly while building hours towards an airline career. A popular route for modular trainees who need to build the required flight time.",
    ...
    },
    {
      ...
      description:
        "Sponsored training directly with an airline. Highly competitive but removes the finance burden. BA, easyJet, Ryanair, TUI, Delta, United and more.",
      ...
      <div className="container">
        <div className="text-center mb-10">
          ...
          <p
            ...
            style={{ color: muted }}
          >
            Whether you want to fly for an airline, for pleasure, or as a career
            change, AviatorIQ helps you find the right route.
          </p>
        </div>
  ...
  const resources = [
    {
      ...
      description:
        "Common technical and HR questions, group exercise strategies, and how to prepare for the competency-based interview.",
      href: "/guides/airline-pilot-interview",
    },
    {
      icon: <Users className="w-6 h-6" />,
      color: "oklch(0.45 0.18 240)",
      title: "Pilot CV & Cover Letters",
      description:
        "How to structure an aviation CV, highlight your training achievements, and write a cover letter that passes airline screening.",
    ...
    },
    {
      ...
      description:
        "What to expect from CUT-E, Symbiotics, and Pilapt tests. How to practice numerical reasoning, spatial awareness, and multitasking.",
    ...
    },
    {
      ...
      description:
        "How airlines assess your raw flying ability and CRM in a full-motion simulator before hiring.",
      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-lg max-w-2xl mx-auto" style={{ color: muted }}>
            Getting your licence is only half the battle. Passing airline
            selection is what gets you into the right-hand seat.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p
              ...
              style={{ color: muted }}
            >
              Training costs vary significantly depending on your chosen route,
              country and school. Use our cost calculator for a personalised
              estimate, or take the assessment to see what suits your budget.
            </p>
            <div className="space-y-3 mb-8">
              {costData.map(item => (
                ...
                >
                  ...
                  <div
                    className="font-bold text-xs text-right max-w-[140px]"
          ...
          >
            ...
            <Link
              href={
                isUS
                  ? "/us/guides/financing-pilot-training"
      ...
      <div className="container">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-lg" style={{ color: muted }}>
            After your assessment, AviatorIQ matches you with flight schools
            based on your country, training goal, budget and preferences — not
            random results.
          </p>
        </div>
          ...
          {[
            {
              icon: <Users className="w-6 h-6" />,
              color: "oklch(0.45 0.18 240)",
              title: "Country-filtered matches",
              desc: "Schools are filtered by your country, training goal, budget range and location preferences.",
            },
            {
            ...
            },
            {
              ...
              color: "oklch(0.72 0.18 65)",
              title: "No cold calls",
              desc: "You control who contacts you. No unsolicited calls from schools you have not chosen.",
            },
          ].map(item => (
            <div
              key={item.title}
...
function GuidesSection() {
  ...
  const guides = isUS
    ? [
        {
          title: "How to become a pilot (USA)",
          href: "/us/guides/how-to-become-a-pilot",
          time: "8 min read",
          icon: "🛫",
        },
        {
          title: "FAA Private Pilot Licence (PPL)",
          href: "/us/guides/private-pilot-licence",
          time: "6 min read",
          icon: "⚖️",
        },
        {
          title: "FAA Class 1 Medical",
          href: "/us/guides/faa-class-1-medical",
          time: "5 min read",
          icon: "🩺",
        },
        {
        ...
        {
          title: "Delta Propel Cadet Programme",
          href: "/us/guides/delta-propel-cadet-programme",
          time: "5 min read",
          icon: "📅",
        },
        {
          title: "How to finance pilot training (US)",
          href: "/us/guides/financing-pilot-training",
          time: "6 min read",
          icon: "🏦",
        },
      ]
    : [
        {
          title: "How to become a pilot (UK)",
          href: "/guides/how-to-become-a-pilot",
          time: "8 min read",
          icon: "🛫",
        },
        {
          title: "Integrated vs Modular training",
          href: "/guides/integrated-vs-modular",
          time: "6 min read",
          icon: "⚖️",
        },
        {
          title: "What is a Class 1 Medical?",
          href: "/guides/class-1-medical",
          time: "5 min read",
          icon: "🩺",
        },
        {
          title: "UK airline pilot salary 2026",
          ...
          {guides.map(guide => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="font-display font-semibold text-white/90 group-hover:text-white transition-colors text-sm truncate">
                  {guide.title}
                </div>
                <div className="text-xs mt-0.5" style={{ color: muted }}>
                  {guide.time}
      ...
      <div className="container relative text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-lg mb-8" style={{ color: "oklch(0.72 0.04 240)" }}>
            Answer 5 questions. Get your country-specific training route, real
            2026 costs, a step-by-step action plan, and matched flight schools.
            Free, no registration.
          </p>
    ...
    <div className="min-h-screen flex flex-col">
      <SEO
        ...
        schema={{
          ...
          description:
            "Country-specific pilot training guidance platform. UK, USA, Australia, Canada, Europe and beyond.",
          potentialAction: {
            "@type": "SearchAction",
