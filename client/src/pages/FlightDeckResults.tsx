...
function EmailCaptureCard({ result }: { result: FlightDeckResult }) {
    ...
    return (
      <div className="rounded-2xl border border-green-500/30 bg-green-500/10 p-6 text-center">
        ...
        <p className="text-white/60 text-sm">
          We'll send your personalised pilot roadmap and next steps shortly.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="rounded-2xl border border-white/15 bg-white/5 p-6">
      ...
      <p className="font-display font-bold text-white text-base mb-1">
        Get your pilot roadmap by email
      </p>
      <p className="text-white/55 text-sm mb-4 leading-relaxed">
        We'll send you a personalised action plan based on your score and
        biggest barrier — completely free.
      </p>
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <label className="flex items-start gap-2.5 cursor-pointer">
          ...
          <span className="text-white/40 text-xs leading-relaxed">
            I agree to receive my pilot roadmap and occasional guidance emails
            from AviatorIQ. No spam, unsubscribe anytime.
          </span>
        </label>
        <button
          type="submit"
          ...
          style={{
            background:
              "linear-gradient(135deg, var(--color-gold), oklch(0.65 0.2 50))",
          }}
        >
...
export default function FlightDeckResults() {
  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator
        .share({
          title: "What's Really Stopping You Becoming A Pilot?",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className={`rounded-2xl border p-5 ${barrierColour}`}>
            ...
            <p className="font-display font-bold text-white text-xl mb-2">
              {result.biggestBarrier}
            </p>
            <p className="text-white/65 text-sm leading-relaxed">
              {result.barrierAdvice}
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-[var(--color-gold)]/30 bg-[var(--color-gold)]/8 p-5">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-xs uppercase tracking-wider font-semibold text-[var(--color-gold)]/70">
                Strongest asset
              </p>
            </div>
            <p className="font-display font-bold text-white text-xl mb-2">
              {result.strongestAsset}
            </p>
            <p className="text-white/65 text-sm leading-relaxed">
        ...
        <div className="rounded-2xl overflow-hidden">
          <div className="bg-[var(--color-gold)] px-6 pt-6 pb-5 text-center">
            ...
            <p className="text-[var(--color-navy)]/75 text-sm mb-5 max-w-sm mx-auto leading-relaxed">
              10 minutes. Full AviatorIQ Score, AI training roadmap, 5-dimension
              breakdown, and matched flight schools — completely free.
            </p>
            <Link href="/quiz">
