...
export default function Schools() {
  ...
  const sourceSchools: StaticSchool[] =
    dbSchools.length > 0
      ...
      <main className="flex-1">
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "url('/manus-storage/training-aircraft_52514b39.jpg')",
          ...
          <div className="container max-w-3xl text-center relative">
            ...
            >
              Browse 54+ accredited flight schools and training providers
              worldwide — UK, USA, Europe, Australia, and beyond. Filter by
              country, training type, and finance options.
            </p>
            <Link
              href="/quiz"
          ...
          <div className="container max-w-5xl">
            ...
            {schoolsQuery.isLoading ? (
              ...
              >
                ...
                <p className="text-sm mb-4" style={{ color: muted }}>
                  We are still expanding our school network. Take the assessment
                  and we will notify you when suitable schools are added.
                </p>
                <Link
                  href="/quiz"
                ...
                {schools.map(school => (
                  ...
                  >
                      ...
                      <img
                        ...
                        onError={e => {
                          (e.target as HTMLImageElement).src =
                            "/manus-storage/school-campus_0aa4197f.jpg";
                        }}
                      />
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(to top, oklch(0.14 0.08 250) 0%, transparent 55%)",
                        }}
                      />
                    </div>
                    <div className="p-4 md:p-6">
                      ...
                      <div className="flex flex-wrap gap-1.5 mb-4">
                        ...
                        {school.modularAtpl && (
                          <span
                            ...
                            style={{
                              ...
                              border: "1px solid oklch(0.6 0.18 200 / 0.25)",
                            }}
                          >
                            Modular ATPL
                          </span>
                        ...
                        {school.accommodationAvailable === "yes" && (
                          <span
                            className="text-xs px-2.5 py-1 rounded-full font-medium"
                            style={{
                              background: "oklch(0.6 0.15 180 / 0.15)",
                              color: "oklch(0.75 0.15 180)",
                              border: "1px solid oklch(0.6 0.15 180 / 0.25)",
                            }}
                          >
                            Accommodation
                          </span>
                      ...
                      {/* Testimonials */}
                      {(school as StaticSchool).testimonials &&
                        (school as StaticSchool).testimonials!.length > 0 && (
                      ...
                      {school.priceRange && (
                        ...
                        >
                          ...
                          <span>
                            from{" "}
                            {convertPriceString(
                              school.priceRange.split("–")[0].trim(),
                              formatPrice
                            )}
                          </span>
                          <span
            ...
            >
              ...
              <p
                ...
                style={{ color: "oklch(0.65 0.04 240)" }}
              >
                Take the free assessment and get matched to schools that fit
                your budget, country and training goal.
              </p>
              <Link
                href="/quiz"
                className="inline-flex items-center gap-2 px-7 py-3 rounded-xl text-sm font-bold text-white no-underline"
