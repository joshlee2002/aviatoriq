...
const tiers = [
  {
    ...
    price: "$179",
    period: "/month",
    description: "Get discovered by aspiring US pilots searching for FAA-approved flight schools.",
    highlight: false,
    badge: null,
    features: [
  ...
  },
  {
    ...
    price: "$399",
    period: "/month",
    description: "Stand out in the directory and receive introduction requests from matched US candidates.",
    highlight: true,
    badge: "Most Popular",
    features: [
      "Everything in Basic",
  ...
  },
  {
    ...
    price: "$799",
    period: "/month",
    description: "Maximum visibility and instant notification on every Flight Ready US lead that matches your school.",
    highlight: false,
    ...
    <div className="rounded-2xl border border-white/10 shadow-lg p-6 max-w-sm mx-auto" style={{ background: "oklch(0.14 0.08 252)" }}>
      ...
      <div className="mt-4 pt-4 border-t border-[var(--color-border)]">
        <p className="text-xs text-[var(--color-muted-foreground)] italic">
          This candidate has requested an introduction to 2 US Part 141 flight schools.
        </p>
      </div>
    </div>
  );
...
const classifications = [
  ...
  },
  {
    ...
    description: "Good candidate. Needs finance planning, FAA medical booking, or further research. Likely to convert within 6–18 months.",
    score: "45–74",
  },
  {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "oklch(0.10 0.08 252)" }}>
      ...
      <section className="bg-[var(--color-navy)] text-white py-20 px-4 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: "url('/manus-storage/flight-school-runway_2b67dbee.jpg')", backgroundSize: "cover", backgroundPosition: "center 60%", opacity: 0.1 }} />
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto mb-8">
            Receive pre-qualified, scored aspiring US pilots who have actively requested an introduction to your school — not cold enquiries. Part 141, Part 61, and university R-ATP candidates.
          </p>
      ...
      <section className="py-16 px-4" style={{ background: "oklch(0.12 0.09 252)" }}>
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/60 text-center max-w-2xl mx-auto mb-10">
            AviatorIQ is a pilot career assessment platform built for the US market. Aspiring pilots complete a 15-question assessment covering their goal, budget, timeline, FAA medical status, and funding method. The platform scores them across five dimensions, generates a personalised FAA training roadmap, and — crucially — lets them request introductions to matched US flight schools.
          </p>
      ...
      <section className="py-16 px-4" style={{ background: "oklch(0.12 0.09 252)" }}>
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-display text-3xl font-bold text-white mb-4">What a US lead looks like</h2>
              <p className="text-white/60 mb-6">
                When a Flight Ready US candidate requests an introduction to your school, you receive a structured profile with everything you need to have a meaningful first conversation — no cold calling, no guessing.
              </p>
      ...
      <section className="py-16 px-4" style={{ background: "oklch(0.10 0.08 252)" }}>
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/60 text-center mb-10 max-w-xl mx-auto">
            We are not a directory. We are a qualification engine that sits between aspiring US pilots and the schools that want to reach them.
          </p>
      ...
      <section id="pricing" className="py-20 px-4" style={{ background: "oklch(0.12 0.09 252)" }}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl font-bold text-white mb-3">US Partner pricing</h2>
            <p className="text-[var(--color-muted-foreground)] max-w-xl mx-auto">
              All plans are billed monthly with no long-term contract. Cancel at any time. Prices in USD.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {tiers.map((tier) => (
          ...
          <p className="text-center text-xs text-white/40 mt-6">
            ...
            <a href="mailto:hello@aviatoriq.co.uk" className="text-[var(--color-primary)] hover:underline">Email us</a>{" "}
      ...
      <section id="apply" className="py-20 px-4 bg-[var(--color-navy)]">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="font-display text-3xl font-bold text-white mb-3">Apply to join the US partner programme</h2>
          ...
          {submitted ? (
            <div className="rounded-2xl p-10 text-center border border-white/10" style={{ background: "oklch(0.14 0.08 252)" }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link href="/us" className="inline-flex items-center gap-2 text-[var(--color-primary)] font-semibold hover:underline">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="rounded-2xl p-8 space-y-5 border border-white/10" style={{ background: "oklch(0.14 0.08 252)" }}>
              <div className="grid md:grid-cols-2 gap-5">
                <div>
                  ...
                  <Input id="schoolName" {...register("schoolName")} placeholder="e.g. ATP Flight School" />
                  {errors.schoolName && <p className="text-red-500 text-xs mt-1">{errors.schoolName.message}</p>}
                </div>
                <div>
                  <Label htmlFor="country" className="text-white/80 font-semibold mb-1.5 block">State / Country</Label>
                  <Input id="country" {...register("country")} placeholder="e.g. Florida, USA" />
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <Label htmlFor="financeAvailable" className="text-sm text-white/70 cursor-pointer">
                    We offer training finance or payment plans (Sallie Mae, in-house, etc.)
                  </Label>
                </div>
                <div className="flex items-center gap-3">
                  <Checkbox
              ...
              >
                {joinWaitlist.isPending ? "Submitting..." : "Submit US Partner Application"}
              </Button>
