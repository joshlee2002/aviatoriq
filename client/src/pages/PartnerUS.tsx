...
const tiers = [
  {
    ...
    period: "/month",
    description:
      "Get discovered by aspiring US pilots searching for FAA-approved flight schools.",
    highlight: false,
    badge: null,
    features: [
  ...
  },
  {
    ...
    period: "/month",
    description:
      "Stand out in the directory and receive introduction requests from matched US candidates.",
    highlight: true,
    badge: "Most Popular",
    features: [
      "Everything in Basic",
    ...
    notIncluded: ["Real-time lead notifications"],
  ...
  },
  {
    ...
    period: "/month",
    description:
      "Maximum visibility and instant notification on every Flight Ready US lead that matches your school.",
    highlight: false,
...
// ─── Example lead profile card (US) ──────────────────────────────────────────
function ExampleLeadCard() {
  return (
    <div
      className="rounded-2xl border border-white/10 shadow-lg p-6 max-w-sm mx-auto"
      style={{ background: "oklch(0.14 0.08 252)" }}
    >
      ...
      <div className="space-y-2 text-sm">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-semibold">Airline Pilot (ATP)</span>
        </div>
        <div className="flex justify-between">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-semibold">$80,000–$110,000</span>
        </div>
        <div className="flex justify-between">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-semibold">Sallie Mae loan</span>
        </div>
        <div className="flex justify-between">
          <span className="text-[var(--color-muted-foreground)]">Medical</span>
          <span className="font-semibold">FAA First Class planned</span>
        </div>
        <div className="flex justify-between">
          <span className="text-[var(--color-muted-foreground)]">
            Preferred route
          </span>
          <span className="font-semibold">Part 141 accelerated</span>
        </div>
        <div className="flex justify-between">
          <span className="text-[var(--color-muted-foreground)]">
            Contact method
      ...
      <div className="mt-4 pt-4 border-t border-[var(--color-border)]">
        <p className="text-xs text-[var(--color-muted-foreground)] italic">
          This candidate has requested an introduction to 2 US Part 141 flight
          schools.
        </p>
      </div>
    </div>
...
const classifications = [
  {
    ...
    description:
      "Strong candidate. Clear goal, realistic budget, timeline within 12 months. Ready to speak with schools immediately.",
    score: "75–100",
  },
  {
    ...
    description:
      "Good candidate. Needs finance planning, FAA medical booking, or further research. Likely to convert within 6–18 months.",
    score: "45–74",
  },
  {
    ...
    description:
      "Early-stage researcher. Interested but not yet committed. Valuable for nurturing and brand awareness.",
    score: "0–44",
  },
];
...
const dataPoints = [
  ...
  "Pilot goal (airline, corporate, PPL, CFI)",
  "Preferred training route (Part 141 / Part 61 / University R-ATP)",
  "Budget range and funding method (Sallie Mae, GI Bill, cash, etc.)",
  "Start timeframe (ASAP / 12 months / 1–3 years)",
  "FAA Medical status (First / Second / Third Class)",
  "Flying experience (hours logged)",
...
const benefits = [
  {
    ...
    title: "Pre-qualified US leads only",
  ...
  },
  {
    ...
    body: "Every candidate has consented to be contacted by flight schools. No cold outreach, no compliance headaches.",
  },
  {
  ...
  },
  {
    ...
    body: "As a partner, you gain access to aggregated data: average budgets, most common goals, state distribution, and funding method trends across all US assessments.",
  },
  {
...
export default function PartnerUS() {
  ...
  const onSubmit = (data: FormData) => {
    const notesWithTier = selectedTier
      ? `[US Partner] Interested tier: ${selectedTier}${data.notes ? `\n\n${data.notes}` : ""}`
      : `[US Partner]${data.notes ? ` ${data.notes}` : ""}`;
    ...
    >
      ...
      <section className="bg-[var(--color-navy)] text-white py-20 px-4 relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('/manus-storage/flight-school-runway_2b67dbee.jpg')",
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto mb-8">
            ...
            requested an introduction to your school — not cold enquiries. Part
            141, Part 61, and university R-ATP candidates.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="#pricing"
              className="inline-flex items-center gap-2 bg-[var(--color-primary)] hover:bg-orange-600 text-white font-bold px-8 py-4 rounded-xl transition-colors"
            >
              View Pricing <ArrowRight className="w-4 h-4" />
            </a>
            <a
              href="#apply"
              className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-bold px-8 py-4 rounded-xl transition-colors border border-white/20"
            >
              Apply Now
            </a>
          </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/60 text-center max-w-2xl mx-auto mb-10">
            ...
            personalised FAA training roadmap, and — crucially — lets them
            request introductions to matched US flight schools.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {classifications.map(c => (
              <div
                key={c.label}
                className={`rounded-2xl border p-6 ${c.color}`}
                style={{ background: "oklch(0.13 0.09 252)" }}
              >
                <div className="flex items-center gap-2 mb-3">
                  <span
                    className={`inline-flex items-center gap-1 text-xs font-bold px-2.5 py-1 rounded-full ${c.badge}`}
                  >
                    {c.icon} {c.label}
                  </span>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-display text-3xl font-bold text-white mb-4">
                What a US lead looks like
              </h2>
              <p className="text-white/60 mb-6">
                When a Flight Ready US candidate requests an introduction to
                your school, you receive a structured profile with everything
                you need to have a meaningful first conversation — no cold
                calling, no guessing.
              </p>
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/60 text-center mb-10 max-w-xl mx-auto">
            ...
            between aspiring US pilots and the schools that want to reach them.
          </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[var(--color-muted-foreground)] max-w-xl mx-auto">
              All plans are billed monthly with no long-term contract. Cancel at
              any time. Prices in USD.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {tiers.map(tier => (
              ...
              >
                ...
                <ul className="space-y-2.5 mb-6 flex-1">
                  ...
                  {tier.notIncluded.map(f => (
                    <li
                      key={f}
                      className="flex items-start gap-2 text-sm text-white/30 line-through"
                    >
                      <span className="w-4 h-4 mt-0.5 shrink-0 text-center text-xs leading-4">
                        ✕
                      </span>
                      {f}
                    </li>
      ...
      <section id="apply" className="py-20 px-4 bg-[var(--color-navy)]">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="font-display text-3xl font-bold text-white mb-3">
              Apply to join the US partner programme
            </h2>
            <p className="text-blue-100">
              Complete the form below and we will be in touch with onboarding
              details and next steps — usually within 2 business days.
            </p>
            {selectedTier && (
          ...
          {submitted ? (
            ...
            <form
              ...
              className="rounded-2xl p-8 space-y-5 border border-white/10"
              style={{ background: "oklch(0.14 0.08 252)" }}
            >
              <div className="grid md:grid-cols-2 gap-5">
                <div>
                  <Label
                    htmlFor="schoolName"
                    className="text-white/80 font-semibold mb-1.5 block"
                  >
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="e.g. Part 141 accelerated, Part 61, CFI, instrument rating, multi-engine..."
                  rows={3}
                />
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label
                    htmlFor="financeAvailable"
                    className="text-sm text-white/70 cursor-pointer"
                  >
                    We offer training finance or payment plans (Sallie Mae,
                    in-house, etc.)
                  </Label>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  />
                  <Label
                    htmlFor="interestedInLeads"
                    className="text-sm text-white/70 cursor-pointer"
                  >
                    We are interested in receiving pre-qualified lead
                    introductions
                  </Label>
                </div>
              </div>
                ...
                >
                  ...
                  {selectedTier && (
                    <span className="ml-2 text-xs font-normal text-white/40">
                      (Tier: {selectedTier} pre-selected)
                    </span>
                  )}
                </Label>
                <Textarea
                  id="notes"
                  {...register("notes")}
                  placeholder="e.g. airline partnerships, cadet programme affiliations, GI Bill approved, specific intake dates..."
                  rows={3}
                />
              </div>
