...
const CONDITIONS: ConditionEntry[] = [
  {
    ...
    summary:
      "Mild, well-controlled asthma is generally acceptable. Severe or poorly controlled asthma may not be.",
    detail:
    ...
    caveats:
      "You must disclose all asthma history and current medication at your medical. Do not attempt to conceal it — this is a serious offence.",
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "ADHD is not automatically disqualifying, but ADHD medication (stimulants) is not permitted while flying.",
    detail:
    ...
    caveats:
      "If you are currently taking stimulant medication for ADHD, you will need to discuss cessation with your psychiatrist well in advance of applying. Do not stop medication without medical advice.",
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "Colour vision deficiency does not automatically disqualify you, but you must pass specific colour vision tests.",
    detail:
    ...
    caveats:
      "The CAD test is the definitive test for pilots. Book it early — there can be a waiting list. The result determines what, if any, operational limitations apply.",
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "Type 2 diabetes controlled by diet or metformin may be acceptable. Insulin-treated diabetes has strict requirements.",
    detail:
    ...
    caveats:
      "Diabetic complications (retinopathy, neuropathy, nephropathy) may be separately disqualifying. All medications must be declared.",
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "A history of depression is not automatically disqualifying. Certain antidepressants are now permitted in some circumstances.",
    detail:
    ...
    caveats:
      "Honesty is essential. Concealing a mental health history is a serious offence and can result in licence revocation. The CAA's approach to mental health has become significantly more supportive in recent years.",
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "Mild anxiety that is well-managed may be acceptable. Severe or disabling anxiety disorders are more likely to be disqualifying.",
    detail:
    ...
    caveats:
      "Do not attempt to hide anxiety history. The CAA is more likely to work with you if you are transparent from the outset.",
  ...
  },
  {
    ...
    summary:
      "Epilepsy is generally disqualifying for a Class 1 Medical. A single unprovoked seizure may also be disqualifying.",
    detail:
    ...
    caveats:
      "Childhood febrile convulsions are treated differently from adult seizures and may not be disqualifying. Always disclose and seek individual assessment.",
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "Mild hearing loss may be acceptable with a hearing aid. Severe hearing loss is more likely to be disqualifying.",
    detail:
    ...
    caveats:
      "Hearing aids are permitted in the cockpit. The key test is whether you can hear ATC communications reliably.",
  ...
  },
  {
    ...
    verdict: "likely_ok",
    summary:
      "Corrected vision requirements are achievable for most people. Glasses and contact lenses are permitted.",
    detail:
    ...
    caveats:
      "If you have had laser eye surgery, you must declare it and provide surgical records. The CAA has specific guidance on post-refractive surgery assessment.",
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "Cardiac conditions are assessed individually. Some are acceptable with treatment; others are disqualifying.",
    detail:
    ...
    caveats:
      "Cardiac conditions require individual assessment. Do not assume disqualification without consulting an AME — many pilots with treated cardiac conditions hold Class 1 Medicals.",
  ...
  },
  {
    ...
    verdict: "likely_ok",
    summary:
      "Controlled hypertension is generally acceptable. Most blood pressure medications are permitted.",
    detail:
    ...
    caveats:
      "You must declare all blood pressure medication. The CAA will want to see that your blood pressure is stable and well-controlled.",
    source: "CAA AMS Policy — Cardiology",
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "Mental health history is assessed individually. Many conditions are manageable; some are disqualifying.",
    detail:
      "Mental health is assessed on a case-by-case basis. The CAA has moved significantly towards a more supportive approach in recent years, recognising that untreated mental health conditions are a greater safety risk than treated ones. Conditions such as bipolar disorder, schizophrenia, and psychosis are generally disqualifying. PTSD, OCD, and personality disorders are assessed individually. A history of self-harm or suicidal ideation requires careful assessment. The key factors are: current stability, insight, treatment compliance, and functional capacity. A psychiatric assessment is typically required for any significant mental health history.",
    caveats:
      "Honesty is the most important thing. The CAA's Aeromedical Section is experienced in working with pilots with mental health histories. Concealment is far more dangerous to your career than disclosure.",
    source: "CAA AMS Policy — Psychiatry",
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "Mild kidney conditions may be acceptable. Significant kidney disease or dialysis is likely disqualifying.",
    detail:
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "Type 1 diabetes is no longer automatically disqualifying under EASA rules, but strict conditions apply.",
    detail:
    ...
    caveats:
      "Start the process early. The CAA assessment for insulin-treated diabetes can take 6–12 months. You will need a specialist diabetologist's support.",
    source: "CAA AMS Policy — Endocrinology; EASA Part-MED",
  },
  {
    name: "Sleep Apnoea",
    ...
    verdict: "case_by_case",
    summary:
      "Treated sleep apnoea (CPAP) may be acceptable. Untreated moderate-to-severe sleep apnoea is disqualifying.",
    detail:
    ...
    caveats:
      "If you suspect you have sleep apnoea, get a diagnosis and start treatment before your medical. Treated OSA is much more likely to be acceptable than untreated.",
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "Back conditions are assessed individually. Many are acceptable; severe or disabling conditions may not be.",
    detail:
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "A history of alcohol or substance misuse requires individual assessment. Active dependency is disqualifying.",
    detail:
    ...
    caveats:
      "Random drug and alcohol testing is a condition of holding a pilot licence in the UK. Any positive test result will result in licence suspension.",
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "Cancer history is assessed individually. Many cancers in remission are acceptable; active treatment is not.",
    detail:
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "Mild head injuries that have fully resolved may be acceptable. Significant brain injuries require detailed assessment.",
    detail:
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "HIV is not automatically disqualifying. Well-controlled HIV on antiretroviral therapy may be acceptable.",
    detail:
  ...
  },
  {
    ...
    verdict: "case_by_case",
    summary:
      "A single resolved episode of kidney stones may be acceptable. Recurrent stones require assessment.",
    detail:
      ...
      <div className="flex items-start gap-3 mb-3">
        ...
        <div className="flex-1">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-1">
            <h3 className="font-display font-bold text-[var(--color-navy)] text-lg">
              {entry.name}
            </h3>
            <span
              className={`inline-flex items-center gap-1 text-xs font-bold px-2.5 py-1 rounded-full border ${cfg.bg} ${cfg.border} ${cfg.text} w-fit`}
            >
              {cfg.icon} {cfg.label}
            </span>
          </div>
...
export default function MedicalConditionLookup() {
  ...
  const faqSchema = [
    {
      question: "Can I become a pilot with asthma?",
      answer:
        "Mild, well-controlled asthma is generally acceptable for a Class 1 Medical. Severe or poorly controlled asthma requires individual assessment by the CAA.",
    },
    {
      question: "Can I become a pilot with ADHD?",
      answer:
        "ADHD is not automatically disqualifying, but standard ADHD medications (stimulants) are not permitted while flying. Each case is assessed individually by the CAA.",
    },
    {
      question: "Can I become a pilot with colour blindness?",
      answer:
        "Colour vision deficiency does not automatically disqualify you. You must pass the CAD test at City University London. A limitation may be placed on your licence depending on the result.",
    },
    {
      question: "Can I become a pilot with depression?",
      answer:
        "A history of depression is not automatically disqualifying. Certain SSRIs are now permitted under EASA rules. Each case is assessed individually.",
    },
    {
      question: "Can I become a pilot with diabetes?",
      answer:
        "Type 2 diabetes controlled by diet or metformin may be acceptable. Insulin-treated diabetes (Type 1 or 2) may be acceptable under strict EASA conditions with multi-crew limitations.",
    },
    {
      question: "Can I become a pilot with epilepsy?",
      answer:
        "Epilepsy is generally disqualifying for a Class 1 Medical. A single unprovoked seizure may be considered after a seizure-free period. Each case requires individual assessment.",
    },
  ];
      ...
      <main className="flex-1">
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "url('/manus-storage/aviation-medical_1b85dcaa.jpg')",
          ...
          <div className="container max-w-3xl relative text-center">
            ...
            >
              Search any medical condition to get a plain-English answer about
              pilot medical eligibility. Covers 20+ conditions including the
              most-searched topics.
            </p>
            {/* Scope banner */}
            <div
              className="max-w-xl mx-auto mb-6 p-3 rounded-xl text-left"
              style={{
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <p
                  ...
                  style={{ color: "oklch(0.65 0.04 240)" }}
                >
                  <strong style={{ color: "oklch(0.85 0.04 240)" }}>
                    Based on UK CAA / EASA standards.
                  </strong>{" "}
                  If you are training in the USA (FAA), Australia (CASA), Canada
                  (Transport Canada), or another country, your national
                  authority may have different rules. The principles are broadly
                  similar — but always verify with your local aviation
                  authority.
                </p>
              </div>
            </div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow: "0 0 12px oklch(0.72 0.18 65 / 0.3)",
                  }}
                >
                  Search
                </button>
          ...
          <div className="container max-w-3xl">
            {submitted && results.length === 0 && (
              ...
              >
                ...
                <p
                  ...
                  style={{ color: "oklch(0.65 0.04 240)" }}
                >
                  We don't have specific information for "
                  <strong className="text-white">{submitted}</strong>" yet. This
                  tool covers the most common conditions — for less common
                  conditions, consult an Aeromedical Examiner (AME) directly.
                </p>
                <a
                  ...
                  style={{ color: "oklch(0.72 0.18 65)" }}
                >
                  Find a CAA Aeromedical Examiner{" "}
            ...
            >
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  >
                    This tool provides general guidance only and is not medical
                    or legal advice. Aviation medicine is complex and every case
                    is assessed individually by the CAA. The information here is
                    based on published CAA and EASA policy but may not reflect
                    the most recent changes.{" "}
                    <strong className="text-white">
                      Always consult a CAA-approved Aeromedical Examiner (AME)
                      for a definitive assessment of your specific situation.
                    </strong>{" "}
                    Do not make training or career decisions based solely on
                    this tool.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <p
                ...
                style={{ color: "oklch(0.65 0.04 240)" }}
              >
                Take the free Class 1 Medical Readiness Check — 5 questions,
                instant result, no registration required.
              </p>
