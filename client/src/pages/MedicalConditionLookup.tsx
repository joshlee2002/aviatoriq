  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "oklch(0.10 0.08 252)" }}>
      ...
      <main className="flex-1">
        ...
        >
          <div className="absolute inset-0 pointer-events-none" style={{ backgroundImage: "url('/manus-storage/aviation-medical_1b85dcaa.jpg')", backgroundSize: "cover", backgroundPosition: "center 30%", opacity: 0.09 }} />
