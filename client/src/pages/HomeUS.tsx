        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div>
            ...
            <p className="text-base md:text-lg mb-6 leading-relaxed" style={{ color: "oklch(0.72 0.04 240)" }}>
              Part 141 or Part 61? ATP or CPL? How much will it actually cost? Answer 5 questions and get a specific, data-driven roadmap — your exact FAA route, real 2026 costs, timeline, and matched US flight schools. No generic advice.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-5 mt-8">
              {["Free · No registration", "Real 2026 FAA costs", "Matched US flight schools"].map((item) => (
            ...
            >
              <div className="flex items-center justify-between mb-5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-semibold uppercase tracking-widest" style={{ color: "oklch(0.55 0.04 240)" }}>Sample US Roadmap</span>
                </div>
              ...
              <div className="rounded-xl p-4 mb-4" style={{ background: "oklch(0.45 0.18 240 / 0.1)", border: "1px solid oklch(0.45 0.18 240 / 0.2)" }}>
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-9 h-9 rounded-full flex items-center justify-center text-sm font-bold" style={{ background: ctaGradient }}>AJ</div>
                  <div>
                    <div className="text-sm font-semibold text-white">Alex, 26 — Dallas, TX</div>
                    <div className="text-xs" style={{ color: "oklch(0.6 0.04 240)" }}>Goal: Airline Pilot (ATP)</div>
                  </div>
                  <div className="ml-auto text-right">
                    <div className="text-lg font-display font-black" style={{ background: ctaGradient, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>79</div>
              ...
              <div>
                <div className="text-[10px] font-semibold uppercase tracking-widest mb-2" style={{ color: "oklch(0.4 0.04 240)" }}>Matched US Flight Schools</div>
                <div className="space-y-1.5">
                  {[
                    { name: "ATP Flight School", match: "97%", location: "Dallas, TX" },
                    { name: "Embry-Riddle (Daytona)", match: "93%", location: "Daytona Beach, FL" },
                    { name: "L3Harris (Sanford, FL)", match: "88%", location: "Sanford, FL" },
                  ].map(school => (
                    <div
                      key={school.name}
  ...
  const steps = [
    {
      ...
      description: "Tell us your goal, your situation, and what's been stopping you. The assessment takes around 5 minutes and is completely free — no registration, no spam.",
    ...
    },
    {
      ...
      description: "Get your AviatorIQ Score and a clear, honest answer: what is actually standing between you and an FAA certificate? Finance, time, medical, or something else?",
    ...
    },
    {
      ...
      description: "Receive a training roadmap that addresses your specific barrier, recommends the right FAA route (Part 141 vs 61, ATP vs CPL), and matches you with real US flight schools.",
          ...
          {steps.map((step) => (
            ...
            >
              <div className="flex items-start gap-4 mb-5">
                ...
                <span className="text-5xl font-display font-black leading-none select-none" style={{ color: "oklch(1 0 0 / 0.06)" }}>{step.number}</span>
              </div>
      ...
      <div className="container">
        ...
        <div className="mt-8 p-6 rounded-2xl text-center" style={{ background: "oklch(0.45 0.18 240 / 0.06)", border: "1px solid oklch(0.45 0.18 240 / 0.15)" }}>
          <p className="text-sm" style={{ color: "oklch(0.65 0.04 240)" }}>
            <span className="font-semibold text-white">Are you a CFI or ATP?</span>{" "}
    ...
    <section className="section" style={{ background: "oklch(0.11 0.08 252)" }}>
      <div className="container">
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-base md:text-lg max-w-2xl mx-auto" style={{ color: muted }}>
            Each assessment gives you one thing: certainty. Not information — certainty. Pick the question you most need answered right now.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {tools.map((tool) => (
            ...
            >
              ...
              <span className="inline-flex items-center gap-1.5 text-sm font-semibold" style={{ color: tool.color }}>
  ...
  const routes = [
    {
      ...
      description: "The most common goal. Part 141 accelerated programmes (1,500 hrs ATP minimum) or Part 61 flexible route. Typical cost: $80k–$120k over 2–4 years.",
    ...
    },
    {
      ...
      description: "Fly for pleasure or personal travel. A PPL typically takes 6–18 months and costs $8,000–$15,000 depending on location and aircraft type.",
    ...
    },
    {
      ...
      description: "Fly high-net-worth clients on business jets or charter aircraft. Requires CPL, instrument rating, and eventually type ratings. Strong demand in 2026.",
    ...
    },
    {
      ...
      description: "Teach others to fly while building your own hours toward ATP minimums. The most common path from CPL to airline hiring. CFI/CFII/MEI ratings available.",
    ...
    <section className="section" style={{ background: "oklch(0.11 0.08 252)" }}>
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-lg max-w-2xl mx-auto" style={{ color: muted }}>
            Whether you want to fly for a major airline, for pleasure, or as a career change, AviatorIQ helps you find the right FAA route.
          </p>
        </div>
  ...
  const resources = [
    {
      ...
      description: "How to structure an aviation resume for US airline applications, highlight your flight hours, and write a cover letter that passes HR screening.",
    ...
    },
    {
      ...
      description: "Common technical and HR questions for US regionals and majors, CRM scenarios, and how to prepare for the TMAAT-style competency interview.",
    ...
    },
    {
      ...
      description: "What to expect from ADAPT, PILAPT, and airline-specific cognitive tests. How to practice numerical reasoning, spatial awareness, and multitasking.",
    ...
    },
    {
      ...
      description: "Delta Propel, United Aviate, American Cadet Academy, and more. How to qualify, apply, and what the pathway to a major airline actually looks like.",
    ...
    <section className="section" style={{ background: "oklch(0.13 0.09 250)" }}>
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-lg max-w-2xl mx-auto" style={{ color: muted }}>
            Getting your ATP certificate is only half the battle. Landing a regional or major airline job is what gets you into the right-hand seat.
          </p>
        </div>
...
function CostSection() {
  const costData = [
    { route: "Part 141 ATP Programme", range: "$80,000 – $120,000", duration: "2–3 years", flag: "🇺🇸", color: "oklch(0.45 0.18 240)" },
    { route: "Part 61 Flexible Route", range: "$60,000 – $100,000", duration: "3–5 years", flag: "🇺🇸", color: "oklch(0.6 0.18 200)" },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg mb-7 leading-relaxed" style={{ color: muted }}>
              Training costs vary significantly by route, school, and location. Use our US cost calculator for a personalised estimate, or take the assessment to see what suits your budget.
            </p>
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/us/calculator" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold text-white no-underline" style={{ background: brandGradient }}>
                <Calculator className="w-4 h-4" />
                US Cost Calculator
              </Link>
              <Link href="/us/guides/how-to-fund-pilot-training-usa" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-white/70 no-underline transition-all hover:text-white" style={{ background: "oklch(1 0 0 / 0.06)", border: `1px solid ${border}` }}>
                Finance Guide
              </Link>
            </div>
          </div>
          ...
          <div className="rounded-2xl p-8" style={{ background: "oklch(0.16 0.10 248)", border: "1px solid oklch(1 0 0 / 0.12)" }}>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <div className="text-sm" style={{ color: muted }}>For qualifying US candidates</div>
              </div>
            </div>
            <p className="mb-6 leading-relaxed text-sm" style={{ color: muted }}>
              Many US flight schools offer finance plans, and there are government-backed options for veterans and qualifying students.
            </p>
            <ul className="space-y-3 mb-6">
              {["GI Bill® flight training benefits", "FAA-approved school payment plans", "Airline cadet sponsorships (Delta, United)", "Federal student loans (Part 141 schools)"].map((item) => (
            ...
            <Link href="/us/guides/how-to-fund-pilot-training-usa" className="inline-flex items-center gap-1.5 text-sm font-semibold no-underline transition-all" style={{ color: "oklch(0.72 0.18 65)" }}>
      ...
      <div className="container">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-lg" style={{ color: muted }}>
            After your assessment, AviatorIQ matches you with US flight schools based on your state, training goal, budget and FAA route — not random results.
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-10">
          {[
            { icon: <Users className="w-6 h-6" />, color: "oklch(0.45 0.18 240)", title: "Qualified matches only", desc: "Schools are filtered by your FAA training goal, budget range, and location preferences." },
        ...
        <div className="text-center flex flex-wrap gap-4 justify-center">
          <Link href="/us/schools" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold text-white/70 no-underline transition-all hover:text-white" style={{ background: "oklch(1 0 0 / 0.06)", border: `1px solid ${border}` }}>
...
function GuidesSection() {
  const guides = [
    ...
    { title: "US airline pilot salary guide", href: "/us/guides/airline-pilot-salary-usa", time: "7 min read", icon: "💰" },
    ...
    <section className="section" style={{ background: "oklch(0.11 0.08 252)" }}>
      <div className="container">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-10 gap-4">
          ...
          <Link href="/us/guides" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold text-white/70 no-underline transition-all hover:text-white whitespace-nowrap" style={{ background: "oklch(1 0 0 / 0.06)", border: `1px solid ${border}` }}>
            All US guides →
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {guides.map((guide) => (
            ...
            >
              ...
              <div>
                <div className="font-semibold text-white text-sm mb-1 group-hover:text-white/90">{guide.title}</div>
      ...
      <div className="container relative text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-lg mb-8" style={{ color: "oklch(0.72 0.04 240)" }}>
            Answer 5 questions. Get your specific FAA training route, real 2026 costs, a step-by-step action plan, and matched US flight schools. Free, no registration.
          </p>
    ...
    <div className="min-h-screen flex flex-col">
      <SEO
        ...
        schema={{
          ...
          "description": "The decision platform for people thinking about becoming a pilot in the United States.",
        }}
      />
      <PublicNav />
