...
const teamRoles = [
  {
    ...
    sources: ["UK CAA Official Publications", "EASA Part-FCL Regulations", "FAA Aeronautical Information Manual", "CASA CASR Part 61", "Transport Canada CARs", "GCAA UAE Regulations"],
  },
  {
    icon: Globe,
    ...
    sources: ["Airline official careers pages", "National aviation authority websites", "Flight school prospectuses", "Industry salary surveys"],
  },
  {
    icon: Stethoscope,
    ...
    sources: ["CAA Medical Standards (AMS)", "EASA Part-MED", "FAA AME Guidance", "CASA Medical Standards", "GCAA Medical Requirements"],
  },
  {
    icon: ShieldCheck,
    ...
    sources: ["BALPA Pay & Conditions Survey", "Boeing Commercial Market Outlook", "IATA Workforce Reports", "ICAO Global Aviation Training"],
  },
];
      ...
      <main className="flex-1">
        <div className="py-10 md:py-14" style={{ background: "linear-gradient(160deg, oklch(0.10 0.10 255) 0%, oklch(0.14 0.12 248) 100%)" }}>
          <div className="container max-w-4xl">
            ...
            <p className="text-base max-w-2xl" style={{ color: "oklch(0.65 0.04 240)" }}>
              AviatorIQ guides are produced by a dedicated editorial team that researches, verifies, and maintains content across 9 country markets. Every factual claim is traceable to a named primary source.
            </p>
          </div>
        </div>
          ...
          <div className="container max-w-4xl">
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-5">
                      ...
                      >
                        <Icon className="w-6 h-6" style={{ color: "oklch(0.65 0.18 240)" }} />
                      </div>
            ...
            >
              ...
              <p className="text-sm leading-relaxed" style={{ color: "oklch(0.6 0.04 240)" }}>
                ...
                <Link href="/editorial-policy" className="text-blue-400 underline">
                  Editorial Policy
                </Link>
                .
              </p>
              <p className="text-sm leading-relaxed mt-3" style={{ color: "oklch(0.6 0.04 240)" }}>
                If you believe any information is incorrect or outdated, please contact us at{" "}
                <a href="mailto:hello@aviatoriq.com" className="text-blue-400 underline">
                  hello@aviatoriq.com
                </a>
                .
              </p>
