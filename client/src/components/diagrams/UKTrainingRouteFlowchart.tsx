    ...
    <div className="w-full overflow-x-auto my-6">
      <div className="min-w-[640px]">
        ...
        >
          ...
          {/* Decision diamond */}
          <polygon
            points="400,130 500,165 400,200 300,165"
            fill="#1e293b"
            stroke="#3b82f6"
            strokeWidth="1.5"
          />
          ...
          <text
            ...
            fontFamily="system-ui, sans-serif"
          >
            Separate modules, flexible timing
          </text>
          ...
          <text
            ...
            fontFamily="system-ui, sans-serif"
          >
            Unfreezes at 1,500 hrs total time + ATPL skill test
          </text>
          ...
          <text
            ...
            fontFamily="system-ui, sans-serif"
          >
            Costs and timelines are indicative. Verify current requirements with
            the CAA.
          </text>
      ...
      <p className="text-xs text-white/40 text-center mt-2">
        Source:{" "}
        <a
          href="https://www.caa.co.uk/pilots-and-air-staff/pilot-licences/aeroplanes/atpl/"
          target="_blank"
