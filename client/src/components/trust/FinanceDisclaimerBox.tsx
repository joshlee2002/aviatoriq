...
export const FinanceDisclaimerBox: React.FC<FinanceDisclaimerBoxProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        <AlertTriangle className="w-4 h-4" style={{ color: "oklch(0.72 0.18 65)" }} />
      </div>
      <div>
        <p className="text-xs font-semibold text-white mb-1">Not financial advice</p>
        <p className="text-xs leading-relaxed" style={{ color: "oklch(0.65 0.04 240)" }}>
          This guide is for general information only and does not constitute financial advice. Loan rates, APRs,
          eligibility criteria, and product availability change regularly. All costs, fees, and repayment figures
          shown are indicative only — your actual costs will depend on your personal circumstances, the lender's
          assessment, and the current terms offered. Always compare multiple providers, read the full terms and
          conditions, and consider seeking independent financial advice from an FCA-authorised adviser before taking
          on debt to fund pilot training.
        </p>
        {additionalNote && (
