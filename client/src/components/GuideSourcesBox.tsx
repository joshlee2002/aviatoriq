...
const REGULATOR_URLS: Record<string, string> = {
  ...
  "UK CAA Class 1 medical guidance":
  ...
  "EASA Easy Access Rules for Aircrew":
    "https://www.easa.europa.eu/en/document-library/easy-access-rules/online-publications/easy-access-rules-aircrew-regulation-eu-no",
  ...
  "CASA medical certificates":
    "https://www.casa.gov.au/licences-and-certificates/aviation-medicals/learn-about-medical-certificates/classes-1-3-medical-certificates",
  ...
  "Transport Canada medical certificates":
    "https://tc.canada.ca/en/aviation/medical-fitness-aviation/apply-manage-aviation-medical-certificate/medical-certificate-categories",
  "Transport Canada Standard 421":
  ...
  "CAA New Zealand pilot licensing":
    "https://www.aviation.govt.nz/licensing-and-certification/pilots/pilot-licensing/",
  "CAA New Zealand medical certification":
  ...
  "SACAA aviation medicine":
    "https://www.caa.co.za/industry-information/aviation-medicine/",
  ...
  "Emirates Flight Training Academy":
    "https://www.emiratesflighttrainingacademy.com/en/admissions/",
  BALPA: "https://www.balpa.org",
  "BALPA Pay & Conditions Survey": "https://www.balpa.org/Pay-Conditions",
  "BALPA financing your training":
    "https://www.balpa.org/becoming-a-pilot/financing-your-training/",
 ...
 *   />
 */
export default function GuideSourcesBox({
  sources,
  lastReviewed,
}: GuideSourcesBoxProps) {
  return (
    <div
    ...
    >
      ...
      <p className="text-xs mt-4" style={{ color: "oklch(0.42 0.04 240)" }}>
        All factual claims in this guide are drawn from the primary sources
        listed above. For the most current information, always verify directly
        with the relevant regulatory authority. This guide does not constitute
        official aviation, medical, legal, or financial advice.
      </p>
    </div>
  );
}
