...
const ukAnnouncements = [
  {
    text: "New guide: BA Speedbird Academy 2026 requirements",
    href: "/guides/ba-speedbird-academy",
  },
  {
    text: "New tool: Medical Condition Lookup — check any condition against Class 1 standards",
    href: "/tools/medical-condition-lookup",
  },
  {
    text: "New guide: Can you become a pilot with ADHD? 2026 CAA rules explained",
    href: "/guides/adhd-pilot-uk",
  },
  {
    text: "New tool: Cadet Eligibility Checker — find which airline programmes you qualify for",
    href: "/tools/cadet-eligibility",
  },
  {
    text: "New guide: Integrated vs Modular ATPL — which is actually cheaper in 2026?",
...
const usAnnouncements = [
  {
    text: "New guide: Delta Propel Program — how to get selected in 2026",
    href: "/us/guides/delta-propel-program",
  },
  {
    text: "New tool: FAA Medical Condition Lookup — check your eligibility",
    href: "/us/medical-lookup",
  },
  {
    text: "New guide: United Aviate Academy — requirements, timeline & pay",
    href: "/us/guides/united-aviate-program",
  },
  {
    text: "New tool: US Cadet Eligibility Checker — find your airline programme",
    href: "/us/cadet-eligibility",
  },
  {
    text: "New guide: ATP Flight School — full 2026 review and costs",
...
function AnnouncementBar({ isUS }: { isUS: boolean }) {
  ...
  return (
    <div
      ...
      style={{
        background: "oklch(0.55 0.20 65)",
        color: "oklch(0.10 0.05 50)",
      }}
    >
      <span
...
const ukToolLinks = [
  {
    label: "Pilot Roadmap Generator",
    href: "/roadmap",
    desc: "Get your personalised training roadmap",
    icon: "🗺️",
  },
  {
    label: "Cost Calculator",
    href: "/calculator",
    desc: "Estimate your total training cost",
    icon: "🧮",
  },
  {
    label: "Integrated vs Modular",
    href: "/tools/integrated-vs-modular",
    desc: "Find the right training route",
    icon: "⚖️",
  },
  {
    label: "Medical Readiness Check",
    href: "/tools/class-1-medical-check",
    desc: "Assess your pilot medical eligibility (CAA/EASA)",
    icon: "🩺",
  },
  {
    label: "Medical Condition Lookup",
    href: "/tools/medical-condition-lookup",
    desc: "Check any condition against pilot medical standards",
    icon: "🔍",
  },
  {
    label: "UK & EU Cadet Eligibility",
    href: "/tools/cadet-eligibility",
    desc: "BA, easyJet, Ryanair, Wizz Air, TUI programmes",
    icon: "✈️",
  },
];
...
const usToolLinks = [
  {
    label: "US Pilot Roadmap",
    href: "/us/roadmap",
    desc: "Part 141, Part 61, cadet, or university — find your FAA path",
    icon: "🗺️",
  },
  {
    label: "US Cost Calculator",
    href: "/us/calculator",
    desc: "Part 61 vs 141 costs, checkrides, and FAA exams",
    icon: "🧮",
  },
  {
    label: "FAA Medical Condition Lookup",
    href: "/us/medical-lookup",
    desc: "Check conditions against FAA First Class standards",
    icon: "🔍",
  },
  {
    label: "US Cadet Eligibility Checker",
    href: "/us/cadet-eligibility",
    desc: "United Aviate, Delta Propel, American, Southwest",
    icon: "✈️",
  },
];
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        ...
        >
          <p
            className="text-xs px-3 py-2 font-medium uppercase tracking-wider"
            style={{
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        ...
        >
          <p
            className="text-[10px] px-3 py-2 font-semibold uppercase tracking-widest"
            style={{
...
export default function PublicNav() {
  ...
  const navStyle: React.CSSProperties = {
    background: scrolled
      ? "oklch(0.10 0.08 250 / 0.92)"
      : "oklch(0.10 0.08 250 / 0.75)",
        ...
        <nav style={navStyle}>
          <div className="container">
            <div className="flex items-center justify-between h-16">
              ...
              <Link
                href={homeHref}
                className="flex items-center gap-2.5 font-display font-bold text-xl text-white no-underline group"
              >
                <div
                  ...
                  {toolsOpen && (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {isUS
                            ? "→ Switch to Global / UK platform"
                            : "→ Switch to US platform"}
                        </Link>
                      </div>
                    </div>
                  )}
              ...
              <div className="hidden md:flex items-center gap-2">
                ...
                {user?.role === "admin" && (
                  <Link
                    ...
                    onMouseEnter={e => {
                      (e.currentTarget as HTMLElement).style.background =
                        "oklch(0.72 0.18 65 / 0.20)";
                    }}
                    onMouseLeave={e => {
                      (e.currentTarget as HTMLElement).style.background =
                        "oklch(0.72 0.18 65 / 0.10)";
                    }}
                  >
