...
function drawScoreBar(
  ...
  doc
    .fontSize(9)
    .fillColor(NAVY)
    .text(`${value}/100`, x + width - 40, y, { width: 40, align: "right" });
  ...
  if (fillWidth > 0) {
    doc
      .roundedRect(x, y + 14, fillWidth, barHeight, 4)
      .fill(scoreColour(value));
  }
}
...
function sectionHeader(
  ...
  doc
    ...
    .fillColor(WHITE)
    .font("Helvetica-Bold")
    .text(title, 60, y + 8, { width: pageWidth - 120 });
  return y + 38;
}
...
export async function generatePilotBlueprint(
  ...
  return new Promise((resolve, reject) => {
    const doc = new PDFDocument({
      size: "A4",
      margin: 50,
      info: { Title: "AviatorIQ Pilot Blueprint", Author: "AviatorIQ" },
    });
    const chunks: Buffer[] = [];
    ...
    doc
      ...
      .fillColor(PRIMARY)
      .font("Helvetica-Bold")
      .text("AviatorIQ", 50, 40);
    doc
      .fontSize(11)
      .fillColor("#93C5FD")
      .font("Helvetica")
      .text("Pilot Career Intelligence Platform", 50, 68);
    ...
    doc
      ...
      .fillColor(WHITE)
      .font("Helvetica-Bold")
      .text("Pilot Blueprint Report", 50, 100);
    doc
      .fontSize(11)
      .fillColor("#CBD5E1")
      .font("Helvetica")
      .text(`Prepared for: ${lead.fullName}`, 50, 124);
    doc
      .fontSize(9)
      .fillColor("#94A3B8")
      .text(
    ...
    doc
      ...
      .fillColor(WHITE)
      .font("Helvetica-Bold")
      .text(`${score}`, badgeX + 18, 72, { width: 54, align: "center" });
    doc
      .fontSize(9)
      .fillColor(WHITE)
      .font("Helvetica")
      .text("AviatorIQ Score", badgeX + 5, 113, { width: 80, align: "center" });
    ...
    doc
      ...
      .fillColor(WHITE)
      .font("Helvetica-Bold")
      .text(catLabel, badgeX - 10, 144, { width: 100, align: "center" });
    ...
    for (const key of dimKeys) {
      const val =
        dimensions?.[key] ?? Math.round(score * (0.8 + Math.random() * 0.4));
    ...
    const routeDesc: Record<string, string> = {
      "Integrated ATPL":
        "An Integrated ATPL programme takes you from zero to frozen ATPL in 18–24 months at a single approved training organisation. It is the fastest route to the flight deck but requires the largest upfront investment (typically £80,000–£120,000). Airline partnerships and cadet sponsorship schemes are most commonly offered through integrated providers.",
      "Modular ATPL":
        "A Modular ATPL allows you to complete each licence stage (PPL → Night Rating → IR → CPL → MCC) independently, spreading costs over time. Total cost typically ranges from £45,000–£80,000. This route offers greater flexibility but requires strong self-management and takes 2–4 years.",
    ...
    const desc =
      routeDesc[route] ??
      "Your recommended training route has been selected based on your budget, timeline, and career goal. Speak to matched schools for a detailed programme breakdown.";
    doc
      .fontSize(9)
      .fillColor(DARK_GREY)
      .font("Helvetica")
      .text(desc, 50, y, { width: contentWidth });
    ...
    const costEstimate =
      costMap[lead.budgetRange ?? ""] ??
      "£45,000–£100,000 (varies by route and country)";
    ...
    doc
      ...
      .fillColor(MID_GREY)
      .font("Helvetica")
      .text("Estimated Total Cost", 60, y + 8);
    doc
      .fontSize(14)
      .fillColor(NAVY)
      .font("Helvetica-Bold")
      .text(costEstimate, 60, y + 22, { width: contentWidth / 2 - 20 });

    doc
      .rect(50 + contentWidth / 2 + 10, y, contentWidth / 2 - 10, 60)
      .fill(LIGHT_GREY);
    doc
      .fontSize(9)
      .fillColor(MID_GREY)
      .font("Helvetica")
      .text("Estimated Timeline", 60 + contentWidth / 2 + 10, y + 8);
    doc
      .fontSize(14)
      .fillColor(NAVY)
      .font("Helvetica-Bold")
      .text(timelineEstimate, 60 + contentWidth / 2 + 10, y + 22);
    ...
    doc
      ...
      .fillColor(DARK_GREY)
      .font("Helvetica")
      .text(barrierText, 50, y, { width: contentWidth });
    ...
    for (let i = 0; i < actions.length; i++) {
      ...
      doc
        ...
        .fillColor(WHITE)
        .font("Helvetica-Bold")
        .text(`${i + 1}`, 58, y + 2, { width: 8, align: "center" });
      doc
        .fontSize(9)
        .fillColor(DARK_GREY)
        .font("Helvetica")
        .text(actions[i]!, 76, y, { width: contentWidth - 30 });
    ...
    doc
      ...
      .fillColor(WHITE)
      .font("Helvetica-Bold")
      .text("Ready to speak with a flight school?", 60, y + 12, {
    ...
    doc
      ...
      .fillColor(PRIMARY)
      .font("Helvetica-Bold")
      .text(`Visit: aviatoriq.manus.space/results/${lead.id}`, 60, y + 58, {
        width: contentWidth - 20,
      });
    y += 96;
