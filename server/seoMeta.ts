...
export const routeMetaMap: Record<string, RouteMeta> = {
  ...
  "/": {
    title:
      "AviatorIQ — UK Pilot Training Platform | Career Readiness Assessment",
    description:
      "AviatorIQ helps aspiring pilots in the UK find the right training route, compare flight schools, and generate a personalised pilot roadmap. Free...",
    canonical: `${BASE}/`,
  },
  "/quiz": {
    title: "Career Readiness Assessment | AviatorIQ",
    description:
      "Take the AviatorIQ Career Readiness Assessment. Answer 12 questions and get a personalised pilot training score, matched flight schools, and your free...",
    canonical: `${BASE}/quiz`,
  },
  "/roadmap": {
  ...
  "/quizzes": {
    ...
    description:
      "Test your aviation knowledge and career readiness with AviatorIQ's free quizzes. Licence recommender, cadet eligibility checker, and more.",
  ...
  "/partner": {
    ...
    description:
      "Join the AviatorIQ partner programme. Receive pre-qualified, scored aspiring pilots who have actively requested an introduction to your flight school...",
    canonical: `${BASE}/partner`,
  },
  "/for-schools": {
    title: "For Flight Schools | AviatorIQ",
    description:
      "List your flight school on AviatorIQ and get discovered by thousands of aspiring pilots every month. Verified directory listing, lead matching, and...",
  ...
  "/about": {
    ...
    description:
      "AviatorIQ was built to give aspiring pilots honest, expert guidance on the path to the cockpit. Learn about our mission, team, and how we work.",
    canonical: `${BASE}/about`,
  },
  "/contact": {
    title: "Contact AviatorIQ | Get in Touch",
    description:
      "Get in touch with the AviatorIQ team. We're happy to answer questions about pilot training, our platform, or partnership opportunities.",
    canonical: `${BASE}/contact`,
  },
  "/privacy": {
    title: "Privacy Policy | AviatorIQ",
    description:
      "AviatorIQ Privacy Policy. How we collect, use, and protect your personal data.",
  ...
  "/us": {
    ...
    description:
      "AviatorIQ helps aspiring pilots in the USA find the right FAA training route, compare flight schools, and generate a personalised pilot roadmap.",
    canonical: `${BASE}/us`,
  },
  "/us/guides": {
  ...
  "/us/partner": {
    ...
    description:
      "Partner with AviatorIQ to receive qualified US pilot training leads. Connect with aspiring pilots who have been pre-screened by our quiz and roadmap tools.",
    canonical: `${BASE}/us/partner`,
  },
  "/404": {
    title: "Page Not Found | AviatorIQ",
    description:
      "The page you are looking for does not exist. Return to AviatorIQ to find your pilot training route, compare flight schools, and generate your...",
    canonical: `${BASE}/404`,
  },
...
export function getMetaForPath(path: string): RouteMeta {
  ...
  return {
    ...
    description:
      "AviatorIQ helps aspiring pilots find the right training route, compare flight schools, and generate a personalised pilot roadmap.",
    canonical: `${BASE}${path}`,
  };
}
